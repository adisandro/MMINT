 ...
 * @generated
 */
public class BinaryModelRelSourceModelEndpointLabelExpressionLabelParser
		implements IParser {
	/**
	 * @generated
	 */
	public BinaryModelRelSourceModelEndpointLabelExpressionLabelParser() {
	}
	...
	private IStatus updateValues(EObject target, String newString) {
		((ModelRel) target).getModelEndpoints().get(0).setName(newString);
	...
	private String evaluatePrintExpression(EObject self) {
		return MultiModelRegistry.getEndpointLabel(((ModelRel) self)
	...
	private String evaluateEditExpression(EObject self) {
		return MultiModelRegistry.editElementLabel(((ModelRel) self)
				.getModelEndpoints().get(0));
	}
