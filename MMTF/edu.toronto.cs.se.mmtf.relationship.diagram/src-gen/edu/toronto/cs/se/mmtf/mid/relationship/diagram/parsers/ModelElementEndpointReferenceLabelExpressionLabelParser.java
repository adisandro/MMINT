 ...
 * @generated
 */
public class ModelElementEndpointReferenceLabelExpressionLabelParser implements
		IParser {
	/**
	 * @generated
	 */
	public ModelElementEndpointReferenceLabelExpressionLabelParser() {
	}
	...
	private IStatus updateValues(EObject target, String newString) {
		((ExtendibleElementEndpointReference) target).getObject().setName(
				newString);
	...
	private String evaluatePrintExpression(EObject self) {
		return MultiModelRegistry
				.getEndpointReferenceLabel((ExtendibleElementEndpointReference) self);
	}
	...
	private String evaluateEditExpression(EObject self) {
		return MultiModelRegistry
				.editElementReferenceLabel((ExtendibleElementReference) self);
	}
