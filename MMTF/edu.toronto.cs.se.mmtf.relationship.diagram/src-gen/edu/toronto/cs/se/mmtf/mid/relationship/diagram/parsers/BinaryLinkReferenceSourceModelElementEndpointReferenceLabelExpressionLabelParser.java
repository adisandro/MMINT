 ...
 * @generated
 */
public class BinaryLinkReferenceSourceModelElementEndpointReferenceLabelExpressionLabelParser
		implements IParser {
	/**
	 * @generated
	 */
	public BinaryLinkReferenceSourceModelElementEndpointReferenceLabelExpressionLabelParser() {
	}
	...
	private IStatus updateValues(EObject target, String newString) {
		((LinkReference) target).getModelElemEndpointRefs().get(0).getObject()
				.setName(newString);
