 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.istar_mavo.Actor#getIntentionalElements <em>Intentional Elements</em>}</li>
 *   <li>{@link edu.toronto.cs.se.modelepedia.istar_mavo.Actor#getContributions <em>Contributions</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Actor extends DependencyEndpoint {
	 ...
	 * @see edu.toronto.cs.se.modelepedia.istar_mavo.IStar_MAVOPackage#getActor_IntentionalElements()
	 ...
	 * @see edu.toronto.cs.se.modelepedia.istar_mavo.IStar_MAVOPackage#getActor_Contributions()
	 * @model containment="true"
	 * @generated
	 */
