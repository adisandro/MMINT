...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.mavo.classdiagram.Dependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ClassdiagramPackage.Literals.DEPENDENCY__DEPENDEE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ClassdiagramPackage.Literals.DEPENDENCY__DEPENDER,
				 true,
				 false,
				 true,
				 null,
