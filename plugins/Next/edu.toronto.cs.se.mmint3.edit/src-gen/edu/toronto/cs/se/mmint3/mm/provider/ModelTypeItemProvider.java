...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmint3.mm.ModelType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelTypeItemProvider extends ModelItemProvider {
	/**
	...
	protected void addTPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ModelType_t_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ModelType_t_feature",
								"_UI_ModelType_type"),
						MMPackage.Literals.MODEL_TYPE__T, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MMPackage.Literals.MODEL_TYPE__T);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(MMPackage.Literals.MODEL_TYPE__T, MMFactory.eINSTANCE.createMMType()));
	}
