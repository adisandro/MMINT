...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmint3.mm.MMType} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class MMTypeItemProvider extends MMElementItemProvider {
  ...
  /**
   * This adds a property descriptor for the Dynamic feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   *
   * @generated
   */
  protected void addDynamicPropertyDescriptor(Object object) {
    this.itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                                                             getResourceLocator(), getString(
                                                                                             "_UI_MMType_dynamic_feature"),
                                                             getString("_UI_PropertyDescriptor_description",
                                                                       "_UI_MMType_dynamic_feature", "_UI_MMType_type"),
                                                             MMPackage.Literals.MM_TYPE__DYNAMIC, true, false, false,
                                                             ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
  }

  /**
   * This adds a property descriptor for the Supertype feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   *
   * @generated
   */
  ...
  /**
   * This returns MMType.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   *
   * @generated
   */
  @Override
