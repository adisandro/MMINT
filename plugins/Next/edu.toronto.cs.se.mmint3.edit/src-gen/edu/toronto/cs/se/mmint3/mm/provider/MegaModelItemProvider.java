...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmint3.mm.MegaModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MegaModelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addModelsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_MegaModel_models_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_MegaModel_models_feature",
								"_UI_MegaModel_type"),
						MMPackage.Literals.MEGA_MODEL__MODELS, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MMPackage.Literals.MEGA_MODEL__MODELS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(MMPackage.Literals.MEGA_MODEL__MODELS, MMFactory.eINSTANCE.createModelType()));

		newChildDescriptors.add(
				createChildParameter(MMPackage.Literals.MEGA_MODEL__MODELS, MMFactory.eINSTANCE.createModelInstance()));
	}
