...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmint3.mm.Editor} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class EditorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addModelPropertyDescriptor(Object object) {
    this.itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                                                             getResourceLocator(), getString(
                                                                                             "_UI_Editor_model_feature"),
                                                             getString("_UI_PropertyDescriptor_description",
                                                                       "_UI_Editor_model_feature", "_UI_Editor_type"),
                                                             MMPackage.Literals.EDITOR__MODEL, true, false, true, null,
                                                             null, null));
  }

  /**
   * This returns Editor.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   *
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    return getString("_UI_Editor_type");
  }
