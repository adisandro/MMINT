...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmint3.mm.ModelInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelInstanceItemProvider extends ModelItemProvider {
	...
	protected void addIPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ModelInstance_i_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ModelInstance_i_feature",
								"_UI_ModelInstance_type"),
						MMPackage.Literals.MODEL_INSTANCE__I, true, false, true, null, null, null));
	}
	...
	protected void addRootPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ModelInstance_root_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ModelInstance_root_feature",
								"_UI_ModelInstance_type"),
						MMPackage.Literals.MODEL_INSTANCE__ROOT, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MMPackage.Literals.MODEL_INSTANCE__I);
		}
	...
	/**
	 * This returns ModelInstance.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(MMPackage.Literals.MODEL_INSTANCE__I, MMFactory.eINSTANCE.createMMInstance()));
	}
