...
/**
 * This is the action bar contributor for the MM model editor. <!-- begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class MMActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
  /**
   ...
   * @generated
   */
  protected IAction showPropertiesViewAction = new Action(MMEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
    @Override
    public void run() {
      try {
   ...
   * @generated
   */
  protected IAction refreshViewerAction = new Action(MMEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
    @Override
    public boolean isEnabled() {
      return MMActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
    }

    @Override
    public void run() {
      if (MMActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
        Viewer viewer = ((IViewerProvider) MMActionBarContributor.this.activeEditorPart).getViewer();
        if (viewer != null) {
          viewer.refresh();
        }
      }
  ...
  public void contributeToToolBar(IToolBarManager toolBarManager) {
    ...
    toolBarManager.add(new Separator("mm-settings"));
    toolBarManager.add(new Separator("mm-additions"));
  }
  ...
  public void contributeToMenu(IMenuManager menuManager) {
    ...
    IMenuManager submenuManager = new MenuManager(MMEditorPlugin.INSTANCE.getString("_UI_MMEditor_menu"),
                                                  "edu.toronto.cs.se.mmint3.mmMenuID");
    ...
    //
    this.createChildMenuManager = new MenuManager(MMEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    submenuManager.insertBefore("additions", this.createChildMenuManager);

    // Prepare for CreateSibling item addition or removal.
    //
    this.createSiblingMenuManager = new MenuManager(MMEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
  ...
  public void menuAboutToShow(IMenuManager menuManager) {
    ...
    submenuManager = new MenuManager(MMEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    populateManager(submenuManager, this.createChildActions, null);
    menuManager.insertBefore("edit", submenuManager);

    submenuManager = new MenuManager(MMEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
