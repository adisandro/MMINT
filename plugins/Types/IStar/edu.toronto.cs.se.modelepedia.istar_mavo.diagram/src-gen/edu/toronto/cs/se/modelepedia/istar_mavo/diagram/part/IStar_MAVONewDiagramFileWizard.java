...
public class IStar_MAVONewDiagramFileWizard extends Wizard {
	...
	*/
	public IStar_MAVONewDiagramFileWizard(URI domainModelURI, EObject diagramRoot,
		...
		myFileCreationPage.setFileName(edu.toronto.cs.se.modelepedia.istar_mavo.diagram.part.IStar_MAVODiagramEditorUtil
	...
	*/
	public boolean performFinish() {
		...
		edu.toronto.cs.se.modelepedia.istar_mavo.diagram.part.IStar_MAVODiagramEditorUtil.setCharset(diagramFile);
			...
			protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
				...
				if (diagramVID != edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.IStarEditPart.VISUAL_ID) {
					return CommandResult.newErrorCommandResult(
							edu.toronto.cs.se.modelepedia.istar_mavo.diagram.part.Messages.IStar_MAVONewDiagramFileWizard_IncorrectRootError);
				}
		...
		try {
			...
			diagramResource.save(
					edu.toronto.cs.se.modelepedia.istar_mavo.diagram.part.IStar_MAVODiagramEditorUtil.getSaveOptions());
	...
	*/
	private static class DiagramRootElementSelectionPage
			extends edu.toronto.cs.se.modelepedia.istar_mavo.diagram.part.ModelElementSelectionPage {
		...
		*/
		protected boolean validatePage() {
			if (getModelElement() == null) {
				setErrorMessage(
						edu.toronto.cs.se.modelepedia.istar_mavo.diagram.part.Messages.IStar_MAVONewDiagramFileWizard_RootSelectionPageNoSelectionMessage);
				return false;
			}
