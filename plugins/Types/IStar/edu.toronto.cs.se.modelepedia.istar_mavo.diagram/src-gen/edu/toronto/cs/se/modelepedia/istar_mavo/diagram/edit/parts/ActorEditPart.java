...
public class ActorEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.ActorActorIntentionsCompartmentEditPart) {
			...
			pane.add(((edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.ActorActorIntentionsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.ActorActorIntentionsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getActorIntentionsCompartmentFigure();
			pane.remove(((edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.ActorActorIntentionsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public class ActorFigure extends Ellipse {
		...
		private void createContents() {
			...
			fFigureMAVOActorLabelFigure.setMaximumSize(new Dimension(
