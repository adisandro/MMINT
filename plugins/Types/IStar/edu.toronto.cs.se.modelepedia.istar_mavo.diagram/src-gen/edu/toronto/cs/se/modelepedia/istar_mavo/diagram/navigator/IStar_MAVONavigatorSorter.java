 ...
 * @generated
 */
public class IStar_MAVONavigatorSorter extends ViewerSorter {
	...
	*/
	public int category(Object element) {
		if (element instanceof edu.toronto.cs.se.modelepedia.istar_mavo.diagram.navigator.IStar_MAVONavigatorItem) {
			edu.toronto.cs.se.modelepedia.istar_mavo.diagram.navigator.IStar_MAVONavigatorItem item = (edu.toronto.cs.se.modelepedia.istar_mavo.diagram.navigator.IStar_MAVONavigatorItem) element;
