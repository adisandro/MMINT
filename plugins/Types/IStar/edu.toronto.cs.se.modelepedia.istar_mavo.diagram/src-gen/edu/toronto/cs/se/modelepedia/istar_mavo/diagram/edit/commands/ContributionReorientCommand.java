...
public class ContributionReorientCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof edu.toronto.cs.se.modelepedia.istar_mavo.Contribution) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.policies.IStar_MAVOBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistContribution_4003(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		edu.toronto.cs.se.modelepedia.istar_mavo.Intention container = (edu.toronto.cs.se.modelepedia.istar_mavo.Intention) getLink()
				.eContainer();
		return edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.policies.IStar_MAVOBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistContribution_4003(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected edu.toronto.cs.se.modelepedia.istar_mavo.Contribution getLink() {
		return (edu.toronto.cs.se.modelepedia.istar_mavo.Contribution) getElementToEdit();
	}
