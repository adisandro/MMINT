...
public class ContributionCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.policies.IStar_MAVOBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateContribution_4003(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		edu.toronto.cs.se.modelepedia.istar_mavo.Contribution newElement = edu.toronto.cs.se.modelepedia.istar_mavo.IStar_MAVOFactory.eINSTANCE
				.createContribution();
	...
	protected void doConfigure(
			edu.toronto.cs.se.modelepedia.istar_mavo.Contribution newElement,
