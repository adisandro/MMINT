...
public class IStarEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "IStar_MAVO"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.policies.IStarItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.policies.IStarCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.commands.IStar_MAVOCreateShortcutDecorationsCommand(
