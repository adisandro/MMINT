 ...
 * @generated
 */
public class IStar_MAVODomainNavigatorContentProvider implements ICommonContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof edu.toronto.cs.se.modelepedia.istar_mavo.diagram.navigator.IStar_MAVODomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((edu.toronto.cs.se.modelepedia.istar_mavo.diagram.navigator.IStar_MAVODomainNavigatorItem) parentElement)
							.getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
