...
public class MeansEndReorientCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof edu.toronto.cs.se.modelepedia.istar_mavo.MeansEnd) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.policies.IStar_MAVOBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistMeansEnd_4001(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		edu.toronto.cs.se.modelepedia.istar_mavo.Intention container = (edu.toronto.cs.se.modelepedia.istar_mavo.Intention) getLink()
				.eContainer();
		return edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.policies.IStar_MAVOBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistMeansEnd_4001(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected edu.toronto.cs.se.modelepedia.istar_mavo.MeansEnd getLink() {
		return (edu.toronto.cs.se.modelepedia.istar_mavo.MeansEnd) getElementToEdit();
	}
