...
public class DiagramEditorContextMenuProvider extends DiagramContextMenuProvider {
	...
	* @generated
	*/
	private edu.toronto.cs.se.modelepedia.istar_mavo.diagram.part.DeleteElementAction deleteAction;
	...
	*/
	public DiagramEditorContextMenuProvider(IWorkbenchPart part, EditPartViewer viewer) {
		super(part, viewer);
		this.part = part;
		deleteAction = new edu.toronto.cs.se.modelepedia.istar_mavo.diagram.part.DeleteElementAction(part);
		deleteAction.init();
	}
