...
public class MeansEndCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public MeansEndCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.policies.IStar_MAVOBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateMeansEnd_4001(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		edu.toronto.cs.se.modelepedia.istar_mavo.MeansEnd newElement = edu.toronto.cs.se.modelepedia.istar_mavo.IStar_MAVOFactory.eINSTANCE
				.createMeansEnd();
	...
	* @generated
	*/
	protected void doConfigure(edu.toronto.cs.se.modelepedia.istar_mavo.MeansEnd newElement, IProgressMonitor monitor,
