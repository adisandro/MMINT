 ...
 * @generated
 */
public class IStarDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public IStarDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof IStarDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((IStarDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new IStarDomainNavigatorItem((EObject) objects[i],
