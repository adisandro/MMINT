 ...
 * @generated
 */
public class IStarElementChooserDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.IStarElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "istar".equals(fileExtension); //$NON-NLS-1$
	}
