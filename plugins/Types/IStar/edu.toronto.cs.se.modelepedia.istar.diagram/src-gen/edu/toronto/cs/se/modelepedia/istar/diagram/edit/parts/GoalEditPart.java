...
import edu.toronto.cs.se.modelepedia.istar.diagram.edit.policies.GoalItemSemanticEditPolicy;
...
public class GoalEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof edu.toronto.cs.se.modelepedia.istar.diagram.edit.parts.GoalEditPart) {
			types.add(IStarElementTypes.MeansEnd_4001);
		}
