...
import edu.toronto.cs.se.modelepedia.istar.diagram.edit.policies.IStarTextSelectionEditPolicy;
...
public class ResourceName2EditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new IStarEditPart.NodeLabelDragPolicy());
	}
			...
			parser = IStarParserProvider
					.getParser(
							...
							IStarVisualIDRegistry
									.getType(edu.toronto.cs.se.modelepedia.istar.diagram.edit.parts.ResourceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
