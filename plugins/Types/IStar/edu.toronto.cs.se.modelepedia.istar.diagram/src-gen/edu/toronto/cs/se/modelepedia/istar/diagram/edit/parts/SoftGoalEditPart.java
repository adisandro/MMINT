...
import edu.toronto.cs.se.modelepedia.istar.diagram.edit.policies.SoftGoalItemSemanticEditPolicy;
...
public class SoftGoalEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SoftGoalNameEditPart) {
			((SoftGoalNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof edu.toronto.cs.se.modelepedia.istar.diagram.edit.parts.SoftGoalEditPart) {
			types.add(IStarElementTypes.MeansEnd_4001);
		}
