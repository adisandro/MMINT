...
import edu.toronto.cs.se.modelepedia.istar.diagram.edit.policies.Resource2ItemSemanticEditPolicy;
...
public class Resource2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ResourceName2EditPart) {
			((ResourceName2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof edu.toronto.cs.se.modelepedia.istar.diagram.edit.parts.Resource2EditPart) {
			types.add(IStarElementTypes.MeansEnd_4001);
		}
