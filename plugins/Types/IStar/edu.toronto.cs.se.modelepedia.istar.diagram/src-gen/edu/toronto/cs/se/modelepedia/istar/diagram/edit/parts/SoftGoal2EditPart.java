...
import edu.toronto.cs.se.modelepedia.istar.diagram.edit.policies.SoftGoal2ItemSemanticEditPolicy;
...
public class SoftGoal2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SoftGoalName2EditPart) {
			((SoftGoalName2EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureSoftGoalLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof edu.toronto.cs.se.modelepedia.istar.diagram.edit.parts.SoftGoal2EditPart) {
			types.add(IStarElementTypes.MeansEnd_4001);
		}
