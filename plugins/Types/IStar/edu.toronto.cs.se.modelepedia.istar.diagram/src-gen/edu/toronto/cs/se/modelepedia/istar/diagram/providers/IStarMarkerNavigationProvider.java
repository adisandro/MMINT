...
import edu.toronto.cs.se.modelepedia.istar.diagram.part.IStarDiagramEditorUtil;

/**
 * @generated
 */
public class IStarMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = IStarDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			IStarDiagramEditorUtil.selectElementsInDiagram(editor,
