...
public class IStarMAVOToSMTLIB extends EcoreMAVOToSMTLIB {
	...
	public void readInputProperties(Properties inputProperties) throws MMINTException {
		...
		analysisDirection = MIDOperatorIOUtils.getOptionalEnumProperty(inputProperties, PROPERTY_IN_ANALYSISDIRECTION, PROPERTY_IN_ANALYSISDIRECTION_DEFAULT, AnalysisDirection.class);
	}
