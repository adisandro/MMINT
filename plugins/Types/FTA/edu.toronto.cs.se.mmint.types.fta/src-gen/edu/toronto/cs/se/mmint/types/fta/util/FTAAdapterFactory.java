 ...
 *******************************************************************************/
package edu.toronto.cs.se.mmint.types.fta.util;
...
public class FTAAdapterFactory extends AdapterFactoryImpl {
  ...
  public FTAAdapterFactory() {
    if (FTAAdapterFactory.modelPackage == null) {
      FTAAdapterFactory.modelPackage = FTAPackage.eINSTANCE;
    }
  }
  ...
  public boolean isFactoryForType(Object object) {
    if (object == FTAAdapterFactory.modelPackage) {
      return true;
    }
    if (object instanceof EObject) {
      return ((EObject) object).eClass().getEPackage() == FTAAdapterFactory.modelPackage;
    }
    return false;
  }
   ...
   * @generated
   */
  protected FTASwitch<Adapter> modelSwitch = new FTASwitch<>() {
    @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link edu.toronto.cs.se.mmint.types.fta.FaultTree <em>Fault Tree</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link edu.toronto.cs.se.mmint.types.fta.Event <em>Event</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link edu.toronto.cs.se.mmint.types.fta.Gate <em>Gate</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
