...
public class FTASwitch<T> extends Switch<T> {
   ...
   */
  public FTASwitch() {
    if (FTASwitch.modelPackage == null) {
      FTASwitch.modelPackage = FTAPackage.eINSTANCE;
    }
  }
  ...
  protected boolean isSwitchFor(EPackage ePackage) {
    return ePackage == FTASwitch.modelPackage;
  }
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
    case FTAPackage.FAULT_TREE: {
      var faultTree = (FaultTree) theEObject;
      var result = caseFaultTree(faultTree);
      if (result == null) {
    ...
    case FTAPackage.EVENT: {
      var event = (Event) theEObject;
      var result = caseEvent(event);
      if (result == null) {
        result = defaultCase(theEObject);
      }
      return result;
    ...
    case FTAPackage.GATE: {
      var gate = (Gate) theEObject;
      var result = caseGate(gate);
      if (result == null) {
        result = defaultCase(theEObject);
      }
      return result;
