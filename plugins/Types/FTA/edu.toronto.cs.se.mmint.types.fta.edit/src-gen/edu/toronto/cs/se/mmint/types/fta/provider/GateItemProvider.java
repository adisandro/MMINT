...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmint.types.fta.Gate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GateItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addSubEventsPropertyDescriptor(Object object) {
    this.itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                                                             getResourceLocator(), getString(
                                                                                             "_UI_Gate_subEvents_feature"),
                                                             getString("_UI_PropertyDescriptor_description",
                                                                       "_UI_Gate_subEvents_feature", "_UI_Gate_type"),
                                                             FTAPackage.Literals.GATE__SUB_EVENTS, true, false, true,
                                                             null, null, null));
  }
  ...
  protected void addLogicPropertyDescriptor(Object object) {
    this.itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                                                             getResourceLocator(), getString("_UI_Gate_logic_feature"),
                                                             getString("_UI_PropertyDescriptor_description",
  ...
  public String getText(Object object) {
    var labelValue = ((Gate) object).getLogic();
    var label = labelValue == null ? null : labelValue.toString();
    return label == null || label.length() == 0 ? getString("_UI_Gate_type") : getString("_UI_Gate_type") + " " + label;
  }
