...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmint.types.fta.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
    if (this.itemPropertyDescriptors == null) {
      ...
      addSuperGatePropertyDescriptor(object);
    }
  ...
  protected void addProbabilityPropertyDescriptor(Object object) {
    this.itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                                                             getResourceLocator(), getString(
                                                                                             "_UI_Event_probability_feature"),
                                                             getString("_UI_PropertyDescriptor_description",
                                                                       "_UI_Event_probability_feature",
                                                                       "_UI_Event_type"),
                                                             FTAPackage.Literals.EVENT__PROBABILITY, true, false, false,
  ...
  protected void addNamePropertyDescriptor(Object object) {
    this.itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                                                             ...
                                                             getString("_UI_PropertyDescriptor_description",
                                                                       "_UI_Event_name_feature", "_UI_Event_type"),
                                                             FTAPackage.Literals.EVENT__NAME, true, false, false,
                                                             ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  protected void addGatePropertyDescriptor(Object object) {
    this.itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                                                             getResourceLocator(), getString("_UI_Event_gate_feature"),
                                                             getString("_UI_PropertyDescriptor_description",
                                                                       "_UI_Event_gate_feature", "_UI_Event_type"),
                                                             FTAPackage.Literals.EVENT__GATE, true, false, true, null,
                                                             null, null));
  }

  /**
   * This adds a property descriptor for the Super Gate feature.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected void addSuperGatePropertyDescriptor(Object object) {
    this.itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                                                             getResourceLocator(), getString(
                                                                                             "_UI_Event_superGate_feature"),
                                                             getString("_UI_PropertyDescriptor_description",
                                                                       "_UI_Event_superGate_feature", "_UI_Event_type"),
                                                             FTAPackage.Literals.EVENT__SUPER_GATE, true, false, true,
                                                             null, null, null));
  }
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (this.childrenFeatures == null) {
      ...
      this.childrenFeatures.add(FTAPackage.Literals.EVENT__GATE);
    }
  ...
  public String getText(Object object) {
    var label = ((Event) object).getName();
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(FTAPackage.Literals.EVENT__GATE, FTAFactory.eINSTANCE.createGate()));
  }
