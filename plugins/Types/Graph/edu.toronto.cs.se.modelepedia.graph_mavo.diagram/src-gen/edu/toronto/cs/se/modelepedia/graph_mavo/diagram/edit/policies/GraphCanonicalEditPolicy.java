...
public class GraphCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVONodeDescriptor> childDescriptors = edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVODiagramUpdater
				.getGraph_1000SemanticChildren(viewObject);
		for (edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVONodeDescriptor d : childDescriptors) {
	...
	*/
	protected void refreshSemantic() {
		...
		for (Iterator<edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVONodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVONodeDescriptor next = descriptorsIterator
					.next();
	...
	*/
	private Collection<IAdaptable> refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator.hasNext();) {
			...
			for (Iterator<edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVOLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVOLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
