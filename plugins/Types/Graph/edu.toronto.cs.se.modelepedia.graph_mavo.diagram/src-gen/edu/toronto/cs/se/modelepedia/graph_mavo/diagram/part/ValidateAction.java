...
public class ValidateAction extends Action {
	...
	*/
	public ValidateAction(IWorkbenchPage page) {
		setText(edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	*/
	public static void runValidation(View view) {
		try {
			if (edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVODiagramEditorUtil
	...
	*/
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		edu.toronto.cs.se.modelepedia.graph_mavo.diagram.providers.Graph_MAVOValidationProvider
	...
	*/
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			edu.toronto.cs.se.modelepedia.graph_mavo.diagram.providers.Graph_MAVOMarkerNavigationProvider
	...
	*/
	private static void createMarkers(IFile target, IStatus validationStatus, DiagramEditPart diagramEditPart) {
		...
		edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVODiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVODiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(),
				collectTargetElements(rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVODiagramEditorUtil
	...
	*/
	private static void addMarker(EditPartViewer viewer, IFile target, String elementId, String location,
		...
		edu.toronto.cs.se.modelepedia.graph_mavo.diagram.providers.Graph_MAVOMarkerNavigationProvider.addMarker(target,
