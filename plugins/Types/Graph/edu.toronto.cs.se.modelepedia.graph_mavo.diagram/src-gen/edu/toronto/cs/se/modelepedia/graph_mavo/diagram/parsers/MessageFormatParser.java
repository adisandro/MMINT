 ...
 */
package edu.toronto.cs.se.modelepedia.graph_mavo.diagram.parsers;
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Messages.MessageFormatParser_InvalidInputError,
