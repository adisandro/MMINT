 ...
 * @generated
 */
public class Graph_MAVODomainNavigatorContentProvider implements ICommonContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof edu.toronto.cs.se.modelepedia.graph_mavo.diagram.navigator.Graph_MAVODomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((edu.toronto.cs.se.modelepedia.graph_mavo.diagram.navigator.Graph_MAVODomainNavigatorItem) parentElement)
							.getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
