 ...
 * @generated
 */
public class Graph_MAVODomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public Graph_MAVODomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof edu.toronto.cs.se.modelepedia.graph_mavo.diagram.navigator.Graph_MAVODomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((edu.toronto.cs.se.modelepedia.graph_mavo.diagram.navigator.Graph_MAVODomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new edu.toronto.cs.se.modelepedia.graph_mavo.diagram.navigator.Graph_MAVODomainNavigatorItem(
