 ...
 * @generated
 */
public class EdgeNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new edu.toronto.cs.se.modelepedia.graph_mavo.diagram.edit.policies.Graph_MAVOTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = edu.toronto.cs.se.modelepedia.graph_mavo.diagram.providers.Graph_MAVOParserProvider.getParser(
	...
	*/
	protected IFigure createFigurePrim() {
		return new EdgeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EdgeLabelFigure extends WrappingLabel {
