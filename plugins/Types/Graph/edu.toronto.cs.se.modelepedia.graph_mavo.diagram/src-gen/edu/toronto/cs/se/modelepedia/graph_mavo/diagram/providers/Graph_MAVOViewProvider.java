...
public class Graph_MAVOViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return edu.toronto.cs.se.modelepedia.graph_mavo.diagram.edit.parts.NodeEditPart.VISUAL_ID == visualID;
	}
	...
	*/
	public Edge createEdge_4001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		edge.setType(edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVOVisualIDRegistry
