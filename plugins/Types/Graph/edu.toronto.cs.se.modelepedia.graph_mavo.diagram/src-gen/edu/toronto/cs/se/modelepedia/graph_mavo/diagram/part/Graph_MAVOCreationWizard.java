	...
	*/
	public void addPages() {
		...
		diagramModelFilePage.setTitle(
				edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Messages.Graph_MAVOCreationWizard_DiagramModelFilePageTitle);
		diagramModelFilePage.setDescription(
				edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Messages.Graph_MAVOCreationWizard_DiagramModelFilePageDescription);
		...
		domainModelFilePage = new edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVOCreationWizardPage(
			...
			public void setVisible(boolean visible) {
				if (visible) {
					...
					fileName = fileName.substring(0, fileName.length() - ".graphdiag_mavo".length()); //$NON-NLS-1$
					setFileName(edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVODiagramEditorUtil
							.getUniqueFileName(getContainerFullPath(), fileName, "graph_mavo")); //$NON-NLS-1$
				}
				super.setVisible(visible);
			}
		};
		domainModelFilePage.setTitle(
				edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Messages.Graph_MAVOCreationWizard_DomainModelFilePageTitle);
		domainModelFilePage.setDescription(
				edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Messages.Graph_MAVOCreationWizard_DomainModelFilePageDescription);
