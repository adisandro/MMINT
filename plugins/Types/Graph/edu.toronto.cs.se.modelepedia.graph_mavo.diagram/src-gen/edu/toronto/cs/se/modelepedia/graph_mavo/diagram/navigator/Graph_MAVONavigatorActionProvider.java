 ...
 * @generated
 */
public class Graph_MAVONavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		*/
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		*/
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof edu.toronto.cs.se.modelepedia.graph_mavo.diagram.navigator.Graph_MAVONavigatorItem) {
					selectedElement = ((edu.toronto.cs.se.modelepedia.graph_mavo.diagram.navigator.Graph_MAVONavigatorItem) selectedElement)
							.getView();
