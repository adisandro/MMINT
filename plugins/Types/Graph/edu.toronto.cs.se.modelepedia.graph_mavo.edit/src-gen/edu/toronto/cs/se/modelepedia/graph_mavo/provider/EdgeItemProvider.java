...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.graph_mavo.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Graph_MAVOPackage.Literals.EDGE__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Graph_MAVOPackage.Literals.EDGE__TARGET,
				 true,
				 false,
				 true,
				 null,
