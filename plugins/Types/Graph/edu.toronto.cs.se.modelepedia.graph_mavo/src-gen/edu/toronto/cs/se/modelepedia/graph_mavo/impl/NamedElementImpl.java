 ...
 * </p>
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.graph_mavo.impl.NamedElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedElementImpl extends MAVOElementImpl implements NamedElement {
	...
	protected EClass eStaticClass() {
		return Graph_MAVOPackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Graph_MAVOPackage.NAMED_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Graph_MAVOPackage.NAMED_ELEMENT__NAME:
				return getName();
		}
