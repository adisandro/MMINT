...
public class StrategyItemProvider extends DecomposableCoreElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SafetyCasePackage.Literals.STRATEGY__SUPPORTED_BY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SafetyCasePackage.Literals.STRATEGY__SUPPORTED_BY,
				 SafetyCaseFactory.eINSTANCE.createStrategySupportedBy()));
	}
