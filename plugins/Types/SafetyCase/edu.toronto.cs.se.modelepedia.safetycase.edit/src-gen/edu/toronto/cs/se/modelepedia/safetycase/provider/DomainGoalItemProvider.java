    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_DomainGoal_domain_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_DomainGoal_domain_feature", "_UI_DomainGoal_type"),
         GSNPackage.Literals.DOMAIN_GOAL__DOMAIN,
         true,
         false,
         false,
