		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StrategySupportedBy_conclusion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StrategySupportedBy_conclusion_feature", "_UI_StrategySupportedBy_type"),
				 SafetyCasePackage.Literals.STRATEGY_SUPPORTED_BY__CONCLUSION,
				 true,
				 false,
				 true,
				 null,
