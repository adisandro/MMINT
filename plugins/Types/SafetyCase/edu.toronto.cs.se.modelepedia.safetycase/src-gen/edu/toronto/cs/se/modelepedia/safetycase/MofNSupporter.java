 ...
 * </ul>
 *
 * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getMofNSupporter()
 * @model
 * @generated
 */
public interface MofNSupporter extends SupportConnector {
   ...
   * @see #setTarget(long)
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getMofNSupporter_Target()
