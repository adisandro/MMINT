 ...
 * </ul>
 *
 * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getASILfulElement()
 * @model abstract="true"
 * @generated
 */
public interface ASILfulElement extends EObject {
   ...
   * @see #setAsil(ASIL)
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getASILfulElement_Asil()
