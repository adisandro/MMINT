 ...
 * </ul>
 *
 * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getSupportedBy()
 * @model
 * @generated
 */
public interface SupportedBy extends EObject {
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getSupportedBy_Source()
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getSupportedBy_Target()
