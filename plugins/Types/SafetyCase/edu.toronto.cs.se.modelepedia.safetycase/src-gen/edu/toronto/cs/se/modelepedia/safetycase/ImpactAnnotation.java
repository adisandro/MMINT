 ...
 * </ul>
 *
 * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getImpactAnnotation()
 * @model
 * @generated
 */
public interface ImpactAnnotation extends EObject {
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getImpactAnnotation_Type()
   * @model required="true"
   * @generated
   */
  ImpactType getType();
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getImpactAnnotation_Source()
   * @model
   * @generated
   */
  String getSource();
