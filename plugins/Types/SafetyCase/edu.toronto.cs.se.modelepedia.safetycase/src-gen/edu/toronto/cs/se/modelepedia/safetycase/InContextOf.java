 ...
 * </ul>
 *
 * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getInContextOf()
 * @model
 * @generated
 */
public interface InContextOf extends EObject {
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getInContextOf_Context()
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getInContextOf_ContextOf()
