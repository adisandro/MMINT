 ...
 * </ul>
 *
 * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getArgumentElement()
 * @model abstract="true"
 * @generated
 */
public interface ArgumentElement extends EObject {
   ...
   * @see #setId(String)
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getArgumentElement_Id()
   * @model required="true"
   * @generated
   */
  String getId();
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getArgumentElement_Description()
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getArgumentElement_ContentValidity()
   * @model
   * @generated
   */
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getArgumentElement_Status()
