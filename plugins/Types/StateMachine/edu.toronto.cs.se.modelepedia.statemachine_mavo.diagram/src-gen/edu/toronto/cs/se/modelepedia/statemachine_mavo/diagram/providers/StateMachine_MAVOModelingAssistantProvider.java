 ...
 * @generated
 */
public class StateMachine_MAVOModelingAssistantProvider extends
	...
	protected EObject selectElement(EObject[] elements) {
		...
		ElementListSelectionDialog dialog = new ElementListSelectionDialog(
				shell, labelProvider);
		dialog.setMessage(edu.toronto.cs.se.modelepedia.statemachine_mavo.diagram.part.Messages.StateMachine_MAVOModelingAssistantProviderMessage);
