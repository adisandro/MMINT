...
public class StateMachineEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "StateMachine_MAVO"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new edu.toronto.cs.se.modelepedia.statemachine_mavo.diagram.edit.policies.StateMachineItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new edu.toronto.cs.se.modelepedia.statemachine_mavo.diagram.edit.policies.StateMachineCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new edu.toronto.cs.se.modelepedia.statemachine_mavo.diagram.edit.commands.StateMachine_MAVOCreateShortcutDecorationsCommand(
