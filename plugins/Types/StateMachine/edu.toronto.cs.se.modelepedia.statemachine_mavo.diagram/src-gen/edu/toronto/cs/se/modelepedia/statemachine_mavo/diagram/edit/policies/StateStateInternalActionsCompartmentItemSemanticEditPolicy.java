 ...
 * @generated
 */
public class StateStateInternalActionsCompartmentItemSemanticEditPolicy
		extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (edu.toronto.cs.se.modelepedia.statemachine_mavo.diagram.providers.StateMachine_MAVOElementTypes.StateAction_3001 == req
				.getElementType()) {
			return getGEFWrapper(new edu.toronto.cs.se.modelepedia.statemachine_mavo.diagram.edit.commands.StateActionCreateCommand(
					req));
		}
