 ...
 * @generated
 */
public class InitialState2ItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public InitialState2ItemSemanticEditPolicy() {
		super(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (edu.toronto.cs.se.modelepedia.statemachine_mavo.diagram.providers.StateMachine_MAVOElementTypes.Transition_4001 == req
				.getElementType()) {
			return getGEFWrapper(new edu.toronto.cs.se.modelepedia.statemachine_mavo.diagram.edit.commands.TransitionCreateCommand(
	...
	protected Command getReorientRelationshipCommand(
		...
		case edu.toronto.cs.se.modelepedia.statemachine_mavo.diagram.edit.parts.TransitionEditPart.VISUAL_ID:
			return getGEFWrapper(new edu.toronto.cs.se.modelepedia.statemachine_mavo.diagram.edit.commands.TransitionReorientCommand(
					req));
		}
