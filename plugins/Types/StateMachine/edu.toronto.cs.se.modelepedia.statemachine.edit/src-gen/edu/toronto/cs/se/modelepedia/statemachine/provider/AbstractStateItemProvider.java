...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.statemachine.AbstractState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StateMachinePackage.Literals.ABSTRACT_STATE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StateMachinePackage.Literals.ABSTRACT_STATE__TRANSITIONS_AS_SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StateMachinePackage.Literals.ABSTRACT_STATE__TRANSITIONS_AS_TARGET,
				 true,
				 false,
				 true,
				 null,
