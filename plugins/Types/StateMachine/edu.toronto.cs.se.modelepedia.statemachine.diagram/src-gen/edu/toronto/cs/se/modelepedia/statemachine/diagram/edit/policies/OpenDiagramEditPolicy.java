...
import edu.toronto.cs.se.modelepedia.statemachine.diagram.part.StateMachineDiagramEditor;
import edu.toronto.cs.se.modelepedia.statemachine.diagram.part.StateMachineDiagramEditorPlugin;
import edu.toronto.cs.se.modelepedia.statemachine.diagram.part.StateMachineDiagramEditorUtil;
							...
							for (Iterator it = diagramFacet.eResource()
								...
								if (nextResource.isLoaded()
										&& !getEditingDomain().isReadOnly(
												nextResource)) {
									nextResource
											.save(StateMachineDiagramEditorUtil
													.getSaveOptions());
								}
							}
