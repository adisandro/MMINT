...
import edu.toronto.cs.se.modelepedia.statemachine.diagram.edit.policies.StateMachineTextSelectionEditPolicy;
	...
	static {
		registerSnapBackPosition(
				StateMachineVisualIDRegistry
						.getType(edu.toronto.cs.se.modelepedia.statemachine.diagram.edit.parts.TransitionTriggerActionEditPart.VISUAL_ID),
				new Point(0, 40));
	}
