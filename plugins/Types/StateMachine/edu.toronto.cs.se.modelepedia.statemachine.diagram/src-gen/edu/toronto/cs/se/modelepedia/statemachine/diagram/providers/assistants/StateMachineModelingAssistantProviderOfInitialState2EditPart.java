 ...
 * @generated
 */
public class StateMachineModelingAssistantProviderOfInitialState2EditPart
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((InitialState2EditPart) sourceEditPart);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetRelTypesOnSource(InitialState2EditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(InitialState2EditPart) sourceEditPart, targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			InitialState2EditPart source, IGraphicalEditPart targetEditPart) {
	...
	public List<IElementType> getTypesForTarget(IAdaptable source,
		...
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((InitialState2EditPart) sourceEditPart,
				relationshipType);
	}
	 ...
	 * @generated
	 */
	public List<IElementType> doGetTypesForTarget(InitialState2EditPart source,
			IElementType relationshipType) {
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((InitialState2EditPart) targetEditPart);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetRelTypesOnTarget(InitialState2EditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(StateMachineElementTypes.Transition_4001);
		return types;
	}
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((InitialState2EditPart) targetEditPart,
				relationshipType);
	}
	 ...
	 * @generated
	 */
	public List<IElementType> doGetTypesForSource(InitialState2EditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == StateMachineElementTypes.Transition_4001) {
			types.add(StateMachineElementTypes.InitialState_2001);
