 ...
 * @generated
 */
public class StateMachineModelingAssistantProviderOfState2EditPart extends
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnSourceAndTarget((State2EditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			State2EditPart source, IGraphicalEditPart targetEditPart) {
	...
	public List<IElementType> getTypesForTarget(IAdaptable source,
		...
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((State2EditPart) sourceEditPart,
				relationshipType);
	}
	 ...
	 * @generated
	 */
	public List<IElementType> doGetTypesForTarget(State2EditPart source,
			IElementType relationshipType) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((State2EditPart) targetEditPart,
				relationshipType);
	}
	 ...
	 * @generated
	 */
	public List<IElementType> doGetTypesForSource(State2EditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == StateMachineElementTypes.Transition_4001) {
			types.add(StateMachineElementTypes.InitialState_2001);
