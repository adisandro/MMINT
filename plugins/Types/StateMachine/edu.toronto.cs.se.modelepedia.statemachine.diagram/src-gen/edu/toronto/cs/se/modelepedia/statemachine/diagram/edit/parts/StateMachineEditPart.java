...
import edu.toronto.cs.se.modelepedia.statemachine.diagram.edit.commands.StateMachineCreateShortcutDecorationsCommand;
import edu.toronto.cs.se.modelepedia.statemachine.diagram.edit.policies.StateMachineCanonicalEditPolicy;
import edu.toronto.cs.se.modelepedia.statemachine.diagram.edit.policies.StateMachineItemSemanticEditPolicy;
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new StateMachineCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
