 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.statemachine_mavo.impl.AbstractStateImpl#getParentState <em>Parent State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractStateImpl extends NamedElementImpl implements AbstractState {
	...
	public State getParentState() {
		if (eContainerFeatureID() != StateMachine_MAVOPackage.ABSTRACT_STATE__PARENT_STATE) return null;
	...
	public NotificationChain basicSetParentState(State newParentState, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParentState, StateMachine_MAVOPackage.ABSTRACT_STATE__PARENT_STATE, msgs);
		return msgs;
	}
	...
	public void setParentState(State newParentState) {
		if (newParentState != eInternalContainer() || (eContainerFeatureID() != StateMachine_MAVOPackage.ABSTRACT_STATE__PARENT_STATE && newParentState != null)) {
			...
			if (newParentState != null)
				msgs = ((InternalEObject)newParentState).eInverseAdd(this, StateMachine_MAVOPackage.STATE__NESTED_STATES, State.class, msgs);
			msgs = basicSetParentState(newParentState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateMachine_MAVOPackage.ABSTRACT_STATE__PARENT_STATE, newParentState, newParentState));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StateMachine_MAVOPackage.ABSTRACT_STATE__PARENT_STATE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StateMachine_MAVOPackage.ABSTRACT_STATE__PARENT_STATE:
				return eInternalContainer().eInverseRemove(this, StateMachine_MAVOPackage.STATE__NESTED_STATES, State.class, msgs);
		}
