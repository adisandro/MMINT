...
public class StateMachineImpl extends MAVOModelImpl implements StateMachine {
	...
	protected EClass eStaticClass() {
		return StateMachine_MAVOPackage.Literals.STATE_MACHINE;
	}
	...
	public EList<AbstractState> getStates() {
		if (states == null) {
			states = new EObjectContainmentEList<AbstractState>(AbstractState.class, this, StateMachine_MAVOPackage.STATE_MACHINE__STATES);
		}
		return states;
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, StateMachine_MAVOPackage.STATE_MACHINE__TRANSITIONS);
		}
		return transitions;
	}
