 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.statemachine_mavo.State#getNestedStates <em>Nested States</em>}</li>
 * </ul>
 * </p>
 *
...
public interface State extends AbstractState {
	 ...
	 * It is bidirectional and its opposite is '{@link edu.toronto.cs.se.modelepedia.statemachine_mavo.AbstractState#getParentState <em>Parent State</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see edu.toronto.cs.se.modelepedia.statemachine_mavo.StateMachine_MAVOPackage#getState_NestedStates()
