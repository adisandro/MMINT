 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.statemachine_mavo.impl.NamedElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamedElementImpl extends MAVOElementImpl implements NamedElement {
	...
	protected EClass eStaticClass() {
		return StateMachine_MAVOPackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateMachine_MAVOPackage.NAMED_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StateMachine_MAVOPackage.NAMED_ELEMENT__NAME:
				return getName();
		}
