...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Firing Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public abstract class FiringElementImpl extends MAVOElementImpl implements FiringElement {
	/**
	...
	protected EClass eStaticClass() {
		return StateMachine_MAVOPackage.Literals.FIRING_ELEMENT;
	}
	...
	public void setTrigger(String newTrigger) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateMachine_MAVOPackage.FIRING_ELEMENT__TRIGGER, oldTrigger, trigger));
	}
	...
	public void setAction(String newAction) {
		...
		action = newAction;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateMachine_MAVOPackage.FIRING_ELEMENT__ACTION, oldAction, action));
	}
