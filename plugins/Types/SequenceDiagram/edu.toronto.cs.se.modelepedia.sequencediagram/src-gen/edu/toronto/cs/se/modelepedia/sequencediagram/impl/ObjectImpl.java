 ...
 * @generated
 */
public class ObjectImpl extends NamedElementImpl implements edu.toronto.cs.se.modelepedia.sequencediagram.Object {
    /**
    ...
    public void setLifeline(Lifeline newLifeline) {
        if (newLifeline != lifeline) {
            ...
            if (lifeline != null)
                msgs = ((InternalEObject)lifeline).eInverseRemove(this, SequenceDiagramPackage.LIFELINE__OBJECT, Lifeline.class, msgs);
            if (newLifeline != null)
                msgs = ((InternalEObject)newLifeline).eInverseAdd(this, SequenceDiagramPackage.LIFELINE__OBJECT, Lifeline.class, msgs);
