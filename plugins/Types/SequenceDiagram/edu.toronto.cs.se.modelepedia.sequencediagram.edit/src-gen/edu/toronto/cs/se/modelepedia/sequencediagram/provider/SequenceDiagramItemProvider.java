...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.sequencediagram.SequenceDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (SequenceDiagramPackage.Literals.SEQUENCE_DIAGRAM__OBJECTS,
                 SequenceDiagramFactory.eINSTANCE.createObject()));

        newChildDescriptors.add
            (createChildParameter
                (SequenceDiagramPackage.Literals.SEQUENCE_DIAGRAM__MESSAGES,
                 SequenceDiagramFactory.eINSTANCE.createSynchronousMessage()));

        newChildDescriptors.add
            (createChildParameter
                (SequenceDiagramPackage.Literals.SEQUENCE_DIAGRAM__MESSAGES,
                 SequenceDiagramFactory.eINSTANCE.createAsynchronousMessage()));

        newChildDescriptors.add
            (createChildParameter
                (SequenceDiagramPackage.Literals.SEQUENCE_DIAGRAM__MESSAGES,
                 SequenceDiagramFactory.eINSTANCE.createReturnMessage()));
    }
