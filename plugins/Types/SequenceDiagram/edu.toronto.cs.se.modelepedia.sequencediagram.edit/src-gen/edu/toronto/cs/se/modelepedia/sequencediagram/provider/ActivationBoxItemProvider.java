...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.sequencediagram.ActivationBox} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivationBoxItemProvider 
	 ...
	 * @generated
	 */
	public ActivationBoxItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActivationBox_condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActivationBox_condition_feature", "_UI_ActivationBox_type"),
				 SequenceDiagramPackage.Literals.ACTIVATION_BOX__CONDITION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SequenceDiagramPackage.Literals.ACTIVATION_BOX__ACTIVATION_BOXES);
		}
	...
	/**
	 * This returns ActivationBox.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ActivationBox"));
	}
	...
	public String getText(Object object) {
		String label = ((ActivationBox)object).getCondition();
		return label == null || label.length() == 0 ?
			getString("_UI_ActivationBox_type") :
			getString("_UI_ActivationBox_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ActivationBox.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SequenceDiagramPackage.Literals.ACTIVATION_BOX__ACTIVATION_BOXES,
				 SequenceDiagramFactory.eINSTANCE.createActivationBox()));
	}
