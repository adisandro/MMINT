...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.Column} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RelationalDatabase_MAVOPackage.Literals.COLUMN__TABLE_AS_PRIMARY_KEY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RelationalDatabase_MAVOPackage.Literals.COLUMN__FOREIGN_KEYS_AS_COLUMN,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RelationalDatabase_MAVOPackage.Literals.COLUMN__FOREIGN_KEYS_AS_FOREIGN_COLUMN,
				 true,
				 false,
				 true,
				 null,
