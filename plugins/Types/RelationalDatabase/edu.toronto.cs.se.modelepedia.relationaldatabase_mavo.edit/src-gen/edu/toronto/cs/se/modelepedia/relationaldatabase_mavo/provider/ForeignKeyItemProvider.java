...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.ForeignKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForeignKeyItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RelationalDatabase_MAVOPackage.Literals.FOREIGN_KEY__TABLE_COLUMN);
			childrenFeatures.add(RelationalDatabase_MAVOPackage.Literals.FOREIGN_KEY__FOREIGN_COLUMN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RelationalDatabase_MAVOPackage.Literals.FOREIGN_KEY__TABLE_COLUMN,
				 RelationalDatabase_MAVOFactory.eINSTANCE.createTableColumnReference()));

		newChildDescriptors.add
			(createChildParameter
				(RelationalDatabase_MAVOPackage.Literals.FOREIGN_KEY__FOREIGN_COLUMN,
				 RelationalDatabase_MAVOFactory.eINSTANCE.createForeignColumnReference()));
	}
