...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RelationalDatabase_MAVOPackage.Literals.TABLE__PRIMARY_KEY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RelationalDatabase_MAVOPackage.Literals.TABLE__COLUMNS);
			childrenFeatures.add(RelationalDatabase_MAVOPackage.Literals.TABLE__FOREIGN_KEYS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RelationalDatabase_MAVOPackage.Literals.TABLE__COLUMNS,
				 RelationalDatabase_MAVOFactory.eINSTANCE.createColumn()));

		newChildDescriptors.add
			(createChildParameter
				(RelationalDatabase_MAVOPackage.Literals.TABLE__FOREIGN_KEYS,
				 RelationalDatabase_MAVOFactory.eINSTANCE.createForeignKey()));
	}
