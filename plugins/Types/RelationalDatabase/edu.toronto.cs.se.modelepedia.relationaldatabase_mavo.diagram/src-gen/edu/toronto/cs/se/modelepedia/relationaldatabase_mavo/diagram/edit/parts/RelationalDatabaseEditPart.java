...
public class RelationalDatabaseEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "RelationalDatabase_MAVO"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.diagram.edit.policies.RelationalDatabaseItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.diagram.edit.policies.RelationalDatabaseCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.diagram.edit.commands.RelationalDatabase_MAVOCreateShortcutDecorationsCommand(
