 ...
 * @generated
 */
public class ForeignColumnReferenceCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ForeignColumnReferenceCreateCommand(
	...
	public boolean canExecute() {
		...
		if (target != null
				&& false == target instanceof edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.Column) {
			return false;
		}
		if (getSource() == null) {
		...
		return edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.diagram.edit.policies.RelationalDatabase_MAVOBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateForeignColumnReference_4002(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.ForeignColumnReference newElement = edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.RelationalDatabase_MAVOFactory.eINSTANCE
				.createForeignColumnReference();
		getContainer().getForeignColumn().add(newElement);
	...
	protected void doConfigure(
			edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.ForeignColumnReference newElement,
	 ...
	 * @generated
	 */
	private static edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.ForeignKey deduceContainer(
