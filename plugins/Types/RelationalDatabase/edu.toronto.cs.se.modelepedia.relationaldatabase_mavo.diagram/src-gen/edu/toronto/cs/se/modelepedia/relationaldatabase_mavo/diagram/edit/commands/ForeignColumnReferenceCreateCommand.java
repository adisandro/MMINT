...
public class ForeignColumnReferenceCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ForeignColumnReferenceCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.diagram.edit.policies.RelationalDatabase_MAVOBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateForeignColumnReference_4002(getContainer(), getSource(), getTarget());
	}
	...
	* @generated
	*/
	protected void doConfigure(edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.ForeignColumnReference newElement,
