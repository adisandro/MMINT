 ...
 * @generated
 */
public class RelationalDatabaseElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public RelationalDatabaseElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.RelationalDatabaseElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "relationaldatabase".equals(fileExtension); //$NON-NLS-1$
	}
