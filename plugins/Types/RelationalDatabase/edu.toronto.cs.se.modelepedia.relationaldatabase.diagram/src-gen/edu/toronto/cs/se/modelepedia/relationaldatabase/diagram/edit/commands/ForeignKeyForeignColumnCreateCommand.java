 ...
 * @generated
 */
public class ForeignKeyForeignColumnCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ForeignKeyForeignColumnCreateCommand(
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Column) {
			return false;
		}
		if (getSource() == null) {
		...
		return RelationalDatabaseBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateForeignKeyForeignColumn_4002(
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setForeignColumn(getTarget());
		}
