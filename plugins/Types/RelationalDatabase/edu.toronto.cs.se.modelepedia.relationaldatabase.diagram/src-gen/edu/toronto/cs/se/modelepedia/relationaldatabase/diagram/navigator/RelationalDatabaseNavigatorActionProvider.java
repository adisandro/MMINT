 ...
 * @generated
 */
public class RelationalDatabaseNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof RelationalDatabaseNavigatorItem) {
					selectedElement = ((RelationalDatabaseNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, RelationalDatabaseDiagramEditor.ID);
