 ...
 * @generated
 */
public class RelationalDatabaseDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public RelationalDatabaseDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof RelationalDatabaseDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((RelationalDatabaseDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new RelationalDatabaseDomainNavigatorItem(
