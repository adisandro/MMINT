 ...
 * @generated
 */
public class ForeignKeyTableColumnReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ForeignKeyTableColumnReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return RelationalDatabaseBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistForeignKeyTableColumn_4001(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setTableColumn(null);
		getNewSource().setTableColumn(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setTableColumn(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
