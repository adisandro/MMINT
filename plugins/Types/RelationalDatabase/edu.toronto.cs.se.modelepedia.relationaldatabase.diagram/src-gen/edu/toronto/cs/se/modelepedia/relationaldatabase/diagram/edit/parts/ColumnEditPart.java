...
import edu.toronto.cs.se.modelepedia.relationaldatabase.diagram.edit.policies.ColumnItemSemanticEditPolicy;
...
public class ColumnEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ColumnNameEditPart) {
			((ColumnNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnTarget() {
		...
		types.add(RelationalDatabaseElementTypes.ForeignKeyTableColumn_4001);
		types.add(RelationalDatabaseElementTypes.ForeignKeyForeignColumn_4002);
		return types;
	}
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == RelationalDatabaseElementTypes.ForeignKeyTableColumn_4001) {
			types.add(RelationalDatabaseElementTypes.ForeignKey_3002);
		} else if (relationshipType == RelationalDatabaseElementTypes.ForeignKeyForeignColumn_4002) {
			types.add(RelationalDatabaseElementTypes.ForeignKey_3002);
		}
		return types;
	}
