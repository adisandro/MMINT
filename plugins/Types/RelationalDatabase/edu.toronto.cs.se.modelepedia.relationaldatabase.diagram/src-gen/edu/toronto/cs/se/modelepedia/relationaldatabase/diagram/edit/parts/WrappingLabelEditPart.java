...
public class WrappingLabelEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				RelationalDatabaseVisualIDRegistry
						.getType(edu.toronto.cs.se.modelepedia.relationaldatabase.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new RelationalDatabaseEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RelationalDatabaseParserProvider.getParser(
