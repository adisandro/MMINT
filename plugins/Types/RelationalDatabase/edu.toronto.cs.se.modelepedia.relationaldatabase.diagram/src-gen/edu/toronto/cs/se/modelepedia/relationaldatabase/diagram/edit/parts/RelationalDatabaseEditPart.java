...
import edu.toronto.cs.se.modelepedia.relationaldatabase.diagram.edit.commands.RelationalDatabaseCreateShortcutDecorationsCommand;
import edu.toronto.cs.se.modelepedia.relationaldatabase.diagram.edit.policies.RelationalDatabaseCanonicalEditPolicy;
import edu.toronto.cs.se.modelepedia.relationaldatabase.diagram.edit.policies.RelationalDatabaseItemSemanticEditPolicy;
import edu.toronto.cs.se.modelepedia.relationaldatabase.diagram.part.RelationalDatabaseVisualIDRegistry;

/**
 * @generated
 */
public class RelationalDatabaseEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "RelationalDatabase"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public RelationalDatabaseEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RelationalDatabaseItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RelationalDatabaseCanonicalEditPolicy());
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new RelationalDatabaseCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
