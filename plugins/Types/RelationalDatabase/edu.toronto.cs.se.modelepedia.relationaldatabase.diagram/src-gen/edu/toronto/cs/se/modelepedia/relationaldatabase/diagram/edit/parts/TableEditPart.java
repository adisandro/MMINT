...
import edu.toronto.cs.se.modelepedia.relationaldatabase.diagram.edit.policies.OpenDiagramEditPolicy;
import edu.toronto.cs.se.modelepedia.relationaldatabase.diagram.edit.policies.TableItemSemanticEditPolicy;
...
public class TableEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						RelationalDatabaseVisualIDRegistry.TYPED_INSTANCE));
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TableTableForeignKeysCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getTableForeignKeysCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TableTableForeignKeysCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TableTableForeignKeysCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getTableForeignKeysCompartmentFigure();
			pane.remove(((TableTableForeignKeysCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof TableTableForeignKeysCompartmentEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(RelationalDatabaseVisualIDRegistry
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == RelationalDatabaseElementTypes.Column_3001) {
				return getChildBySemanticHint(RelationalDatabaseVisualIDRegistry
						.getType(TableTableColumnsCompartmentEditPart.VISUAL_ID));
			}
			if (type == RelationalDatabaseElementTypes.ForeignKey_3002) {
				return getChildBySemanticHint(RelationalDatabaseVisualIDRegistry
