 ...
 * @generated
 */
public class RelationalDatabaseMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = RelationalDatabaseDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			RelationalDatabaseDiagramEditorUtil.selectElementsInDiagram(editor,
