...
import edu.toronto.cs.se.modelepedia.relationaldatabase.diagram.edit.policies.ForeignKeyItemSemanticEditPolicy;
...
public class ForeignKeyEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		...
		if (relationshipType == RelationalDatabaseElementTypes.ForeignKeyTableColumn_4001) {
			types.add(RelationalDatabaseElementTypes.Column_3001);
