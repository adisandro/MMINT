...
import edu.toronto.cs.se.modelepedia.relationaldatabase.diagram.edit.policies.RelationalDatabaseTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ForeignKeyNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ForeignKeyNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new RelationalDatabaseTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new RelationalDatabaseEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return RelationalDatabaseElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RelationalDatabaseParserProvider
					.getParser(
							RelationalDatabaseElementTypes.ForeignKey_3002,
							getParserElement(),
							RelationalDatabaseVisualIDRegistry
									.getType(edu.toronto.cs.se.modelepedia.relationaldatabase.diagram.edit.parts.ForeignKeyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					RelationalDatabaseEditPartFactory
