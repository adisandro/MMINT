 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.relationaldatabase.impl.TableImpl#getColumns <em>Columns</em>}</li>
 *   <li>{@link edu.toronto.cs.se.modelepedia.relationaldatabase.impl.TableImpl#getPrimaryKey <em>Primary Key</em>}</li>
 *   <li>{@link edu.toronto.cs.se.modelepedia.relationaldatabase.impl.TableImpl#getForeignKeys <em>Foreign Keys</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableImpl extends NamedElementImpl implements Table {
	...
	protected EClass eStaticClass() {
		return RelationalDatabasePackage.Literals.TABLE;
	}
	...
	public EList<Column> getColumns() {
		if (columns == null) {
			columns = new EObjectContainmentWithInverseEList<Column>(Column.class, this, RelationalDatabasePackage.TABLE__COLUMNS, RelationalDatabasePackage.COLUMN__TABLE);
		}
		return columns;
	}
		...
		if (primaryKey != null && primaryKey.eIsProxy()) {
			...
			if (primaryKey != oldPrimaryKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RelationalDatabasePackage.TABLE__PRIMARY_KEY, oldPrimaryKey, primaryKey));
			}
		}
		return primaryKey;
	}
	...
	public NotificationChain basicSetPrimaryKey(Column newPrimaryKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RelationalDatabasePackage.TABLE__PRIMARY_KEY, oldPrimaryKey, newPrimaryKey);
	...
	public void setPrimaryKey(Column newPrimaryKey) {
		if (newPrimaryKey != primaryKey) {
			...
			if (primaryKey != null)
				msgs = ((InternalEObject)primaryKey).eInverseRemove(this, RelationalDatabasePackage.COLUMN__TABLE_AS_PRIMARY_KEY, Column.class, msgs);
			if (newPrimaryKey != null)
				msgs = ((InternalEObject)newPrimaryKey).eInverseAdd(this, RelationalDatabasePackage.COLUMN__TABLE_AS_PRIMARY_KEY, Column.class, msgs);
			msgs = basicSetPrimaryKey(newPrimaryKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationalDatabasePackage.TABLE__PRIMARY_KEY, newPrimaryKey, newPrimaryKey));
	}
	...
	public EList<ForeignKey> getForeignKeys() {
		if (foreignKeys == null) {
			foreignKeys = new EObjectContainmentWithInverseEList<ForeignKey>(ForeignKey.class, this, RelationalDatabasePackage.TABLE__FOREIGN_KEYS, RelationalDatabasePackage.FOREIGN_KEY__TABLE);
		}
		return foreignKeys;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RelationalDatabasePackage.TABLE__COLUMNS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getColumns()).basicAdd(otherEnd, msgs);
			case RelationalDatabasePackage.TABLE__PRIMARY_KEY:
				if (primaryKey != null)
					msgs = ((InternalEObject)primaryKey).eInverseRemove(this, RelationalDatabasePackage.COLUMN__TABLE_AS_PRIMARY_KEY, Column.class, msgs);
				return basicSetPrimaryKey((Column)otherEnd, msgs);
			case RelationalDatabasePackage.TABLE__FOREIGN_KEYS:
