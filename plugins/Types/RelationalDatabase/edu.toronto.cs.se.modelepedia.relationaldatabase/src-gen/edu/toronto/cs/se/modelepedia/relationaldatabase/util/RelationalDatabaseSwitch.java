 ...
 * @generated
 */
public class RelationalDatabaseSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public RelationalDatabaseSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RelationalDatabasePackage.RELATIONAL_DATABASE: {
			...
			case RelationalDatabasePackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationalDatabasePackage.TABLE: {
			...
			case RelationalDatabasePackage.COLUMN: {
			...
			case RelationalDatabasePackage.FOREIGN_KEY: {
