...
/**
 * This is the action bar contributor for the LTS model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LTSActionBarContributor
  ...
  protected IAction showPropertiesViewAction =
    new Action(LTSEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
      @Override
      public void run() {
        try {
  ...
  protected IAction refreshViewerAction =
    new Action(LTSEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
      @Override
      public boolean isEnabled() {
        return LTSActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
      }

      @Override
      public void run() {
        if (LTSActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
          var viewer = ((IViewerProvider)LTSActionBarContributor.this.activeEditorPart).getViewer();
          if (viewer != null) {
            viewer.refresh();
          }
        }
   ...
   * @generated
   */
  public LTSActionBarContributor() {
  ...
  public void contributeToToolBar(IToolBarManager toolBarManager) {
    ...
    toolBarManager.add(new Separator("lts-settings"));
    toolBarManager.add(new Separator("lts-additions"));
  }
  ...
  public void contributeToMenu(IMenuManager menuManager) {
    ...
    IMenuManager submenuManager = new MenuManager(LTSEditorPlugin.INSTANCE.getString("_UI_LTSEditor_menu"), "edu.toronto.cs.se.mmint.types.ltsMenuID");
    ...
    //
    this.createChildMenuManager = new MenuManager(LTSEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    submenuManager.insertBefore("additions", this.createChildMenuManager);

    // Prepare for CreateSibling item addition or removal.
    //
    this.createSiblingMenuManager = new MenuManager(LTSEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
  ...
  public void menuAboutToShow(IMenuManager menuManager) {
    ...
    submenuManager = new MenuManager(LTSEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    populateManager(submenuManager, this.createChildActions, null);
    menuManager.insertBefore("edit", submenuManager);

    submenuManager = new MenuManager(LTSEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
