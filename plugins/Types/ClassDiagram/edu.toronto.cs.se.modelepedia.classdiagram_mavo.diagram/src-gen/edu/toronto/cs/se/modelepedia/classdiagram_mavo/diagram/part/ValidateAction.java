...
public class ValidateAction extends Action {
	...
	*/
	public ValidateAction(IWorkbenchPage page) {
		setText(edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	*/
	public static void runValidation(View view) {
		try {
			if (edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.part.ClassDiagram_MAVODiagramEditorUtil
	...
	*/
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.providers.ClassDiagram_MAVOValidationProvider
	...
	*/
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.providers.ClassDiagram_MAVOMarkerNavigationProvider
