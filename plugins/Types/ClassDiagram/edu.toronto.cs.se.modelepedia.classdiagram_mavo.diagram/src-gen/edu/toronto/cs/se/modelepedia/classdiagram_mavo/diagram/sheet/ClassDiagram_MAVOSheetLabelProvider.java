...
public class ClassDiagram_MAVOSheetLabelProvider extends BaseLabelProvider implements ILabelProvider {
	...
	*/
	public String getText(Object element) {
		...
		if (element instanceof edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.navigator.ClassDiagram_MAVONavigatorGroup) {
			return ((edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.navigator.ClassDiagram_MAVONavigatorGroup) element)
					.getGroupName();
		}
	...
	*/
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.part.ClassDiagram_MAVOVisualIDRegistry
					.getVisualID(view);
			IElementType etype = edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.providers.ClassDiagram_MAVOElementTypes
					.getElementType(vid);
			if (etype != null) {
				return etype;
			}
