 ...
 * @generated
 */
public class ClassDiagram_MAVOInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		if (diagramRoot == null) {
			MessageDialog.openError(getShell(),
					edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.part.Messages.InitDiagramFile_ResourceErrorDialogTitle,
					edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.part.Messages.InitDiagramFile_ResourceErrorDialogMessage);
			return;
		}
		Wizard wizard = new edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.part.ClassDiagram_MAVONewDiagramFileWizard(
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(
				edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.part.Messages.InitDiagramFile_WizardTitle,
