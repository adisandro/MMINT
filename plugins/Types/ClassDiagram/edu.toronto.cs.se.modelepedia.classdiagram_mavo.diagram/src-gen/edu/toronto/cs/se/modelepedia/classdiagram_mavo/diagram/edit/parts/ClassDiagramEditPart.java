...
public class ClassDiagramEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "ClassDiagram_MAVO"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.edit.policies.ClassDiagramItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.edit.policies.ClassDiagramCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.edit.commands.ClassDiagram_MAVOCreateShortcutDecorationsCommand(
