...
public class ClassDiagram_MAVOAdapterFactory extends AdapterFactoryImpl {
   ...
   */
    ...
    if (ClassDiagram_MAVOAdapterFactory.modelPackage == null) {
      ClassDiagram_MAVOAdapterFactory.modelPackage = ClassDiagram_MAVOPackage.eINSTANCE;
    }
  }
   ...
   */
    ...
    if (object == ClassDiagram_MAVOAdapterFactory.modelPackage) {
      return true;
    }
    if (object instanceof EObject) {
      return ((EObject)object).eClass().getEPackage() == ClassDiagram_MAVOAdapterFactory.modelPackage;
    }
    return false;
  }
