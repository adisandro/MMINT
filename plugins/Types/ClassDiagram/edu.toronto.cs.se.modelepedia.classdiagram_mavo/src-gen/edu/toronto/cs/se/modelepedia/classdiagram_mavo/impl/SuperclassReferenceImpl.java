...
public class SuperclassReferenceImpl extends MAVOReferenceImpl implements SuperclassReference {
    ...
    if (this.target != null && this.target.eIsProxy()) {
      ...
      if (this.target != oldTarget) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassDiagram_MAVOPackage.SUPERCLASS_REFERENCE__TARGET, oldTarget, this.target));
      }
    }
    return this.target;
  }
   ...
   */
    ...
    if (eNotificationRequired()) {
      var notification = new ENotificationImpl(this, Notification.SET, ClassDiagram_MAVOPackage.SUPERCLASS_REFERENCE__TARGET, oldTarget, newTarget);
  ...
  public void setTarget(edu.toronto.cs.se.modelepedia.classdiagram_mavo.Class newTarget) {
    if (newTarget != this.target) {
      NotificationChain msgs = null;
      if (this.target != null)
        msgs = ((InternalEObject)this.target).eInverseRemove(this, ClassDiagram_MAVOPackage.CLASS__SUBCLASSES, edu.toronto.cs.se.modelepedia.classdiagram_mavo.Class.class, msgs);
      if (newTarget != null)
