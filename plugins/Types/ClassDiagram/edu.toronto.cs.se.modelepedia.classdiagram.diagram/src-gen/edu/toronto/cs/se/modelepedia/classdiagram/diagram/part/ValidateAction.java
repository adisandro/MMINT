...
import edu.toronto.cs.se.modelepedia.classdiagram.diagram.providers.ClassDiagramMarkerNavigationProvider;
import edu.toronto.cs.se.modelepedia.classdiagram.diagram.providers.ClassDiagramValidationProvider;
...
public class ValidateAction extends Action {
	...
	*/
	public static void runValidation(View view) {
		try {
			if (ClassDiagramDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	*/
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		ClassDiagramValidationProvider.runWithConstraints(txDomain, new Runnable() {
	...
	*/
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			ClassDiagramMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	*/
	private static void createMarkers(IFile target, IStatus validationStatus, DiagramEditPart diagramEditPart) {
		...
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			...
			View view = ClassDiagramDiagramEditorUtil
	...
	*/
	private static void addMarker(
			EditPartViewer viewer, IFile target, String elementId, String location, String message,
			int statusSeverity) {
		if (target == null) {
			return;
		}
		ClassDiagramMarkerNavigationProvider.addMarker(target, elementId, location, message, statusSeverity);
	}
	...
	*/
	private static Set<EObject> collectTargetElements(
			IStatus status, Set<EObject> targetElementCollector, List allConstraintStatuses) {
	...
	*/
	private static Set<EObject> collectTargetElements(
			Diagnostic diagnostic, Set<EObject> targetElementCollector, List allDiagnostics) {
