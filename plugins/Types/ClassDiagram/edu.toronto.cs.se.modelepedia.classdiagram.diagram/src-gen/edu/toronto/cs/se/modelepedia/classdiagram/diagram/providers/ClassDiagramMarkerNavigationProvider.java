 ...
 * @generated
 */
public class ClassDiagramMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = ClassDiagramDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ClassDiagramDiagramEditorUtil.selectElementsInDiagram(editor,
