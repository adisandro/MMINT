...
import edu.toronto.cs.se.modelepedia.classdiagram.diagram.edit.policies.ClassDiagramTextSelectionEditPolicy;
...
public class AssociationNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
			ClassDiagramVisualIDRegistry.getType(
				edu.toronto.cs.se.modelepedia.classdiagram.diagram.edit.parts.AssociationNameEditPart.VISUAL_ID),
			new Point(0, 40));
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(
				new TextDirectEditManager(this, null, ClassDiagramEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
