	...
	static {
		...
		final ITabbedPropertySheetPageContributor propertySheetPageContributor = new ITabbedPropertySheetPageContributor() {
			public String getContributorId() {
				return "edu.toronto.cs.se.modelepedia.classdiagram.diagram"; //$NON-NLS-1$
			}
		};
		...
		}, edu.toronto.cs.se.modelepedia.classdiagram.diagram.navigator.ClassDiagramAbstractNavigatorItem.class);
	}
