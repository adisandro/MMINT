...
public class ClassClassOwnedAttributesCompartmentEditPart extends ListCompartmentEditPart {
	...
	*/
	public String getCompartmentName() {
		return Messages.ClassClassOwnedAttributesCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
			...
			new ClassClassOwnedAttributesCompartmentItemSemanticEditPolicy());
		installEditPolicy(
		...
		installEditPolicy(
			...
			new ClassClassOwnedAttributesCompartmentCanonicalEditPolicy());
	}
