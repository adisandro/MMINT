...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.classdiagram_mavo.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssociationItemProvider
    ...
    this.itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)this.adapterFactory).getRootAdapterFactory(),
         ...
         ClassDiagram_MAVOPackage.Literals.ASSOCIATION__SOURCE,
         true,
         false,
         true,
         null,
    ...
    this.itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)this.adapterFactory).getRootAdapterFactory(),
         ...
         ClassDiagram_MAVOPackage.Literals.ASSOCIATION__TARGET,
         true,
         false,
         true,
         null,
   ...
   */
    ...
    var label = ((Association)object).getName();
