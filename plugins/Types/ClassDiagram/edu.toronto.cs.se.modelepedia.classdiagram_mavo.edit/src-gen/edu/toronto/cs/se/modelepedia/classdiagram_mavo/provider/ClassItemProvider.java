...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.classdiagram_mavo.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider
    ...
    this.itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)this.adapterFactory).getRootAdapterFactory(),
         ...
         ClassDiagram_MAVOPackage.Literals.CLASS__DEPENDENCIES_AS_DEPENDEE,
         true,
         false,
         true,
         null,
    ...
    this.itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)this.adapterFactory).getRootAdapterFactory(),
         ...
         ClassDiagram_MAVOPackage.Literals.CLASS__DEPENDENCIES_AS_DEPENDER,
         true,
         false,
         true,
         null,
   ...
   */
    ...
    if (this.childrenFeatures == null) {
      ...
      this.childrenFeatures.add(ClassDiagram_MAVOPackage.Literals.CLASS__OWNED_ATTRIBUTES);
      this.childrenFeatures.add(ClassDiagram_MAVOPackage.Literals.CLASS__OWNED_OPERATIONS);
      this.childrenFeatures.add(ClassDiagram_MAVOPackage.Literals.CLASS__NESTED_IN);
      this.childrenFeatures.add(ClassDiagram_MAVOPackage.Literals.CLASS__SUPERCLASS);
    }
   ...
   */
    ...
    var label = ((edu.toronto.cs.se.modelepedia.classdiagram_mavo.Class)object).getName();
   ...
   */
    ...
    newChildDescriptors.add
      (createChildParameter
        (ClassDiagram_MAVOPackage.Literals.CLASS__OWNED_ATTRIBUTES,
         ClassDiagram_MAVOFactory.eINSTANCE.createAttribute()));
