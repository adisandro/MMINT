...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.classdiagram_mavo.ClassDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassDiagramItemProvider
   ...
   */
    ...
    if (this.childrenFeatures == null) {
      ...
      this.childrenFeatures.add(ClassDiagram_MAVOPackage.Literals.CLASS_DIAGRAM__CLASSES);
      this.childrenFeatures.add(ClassDiagram_MAVOPackage.Literals.CLASS_DIAGRAM__DEPENDENCIES);
      this.childrenFeatures.add(ClassDiagram_MAVOPackage.Literals.CLASS_DIAGRAM__ASSOCIATIONS);
    }
   ...
   */
    ...
    var classDiagram = (ClassDiagram)object;
    return getString("_UI_ClassDiagram_type") + " " + classDiagram.isInc();
  }
   ...
   */
    ...
    newChildDescriptors.add
      (createChildParameter
        (ClassDiagram_MAVOPackage.Literals.CLASS_DIAGRAM__CLASSES,
         ClassDiagram_MAVOFactory.eINSTANCE.createClass()));
