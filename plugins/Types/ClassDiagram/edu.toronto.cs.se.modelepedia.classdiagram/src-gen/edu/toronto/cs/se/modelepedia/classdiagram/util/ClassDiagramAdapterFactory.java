...
public class ClassDiagramAdapterFactory extends AdapterFactoryImpl {
   ...
   */
    ...
    if (ClassDiagramAdapterFactory.modelPackage == null) {
      ClassDiagramAdapterFactory.modelPackage = ClassDiagramPackage.eINSTANCE;
    }
  }
   ...
   */
    ...
    if (object == ClassDiagramAdapterFactory.modelPackage) {
      return true;
    }
    if (object instanceof EObject) {
      return ((EObject)object).eClass().getEPackage() == ClassDiagramAdapterFactory.modelPackage;
    }
    return false;
  }
