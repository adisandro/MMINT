 ...
 * </p>
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.classdiagram.impl.AttributeImpl#getOwner <em>Owner</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeImpl extends TypedElementImpl implements Attribute {
	...
	public void setOwner(edu.toronto.cs.se.modelepedia.classdiagram.Class newOwner) {
		if (newOwner != eInternalContainer() || (eContainerFeatureID() != ClassDiagramPackage.ATTRIBUTE__OWNER && newOwner != null)) {
			...
			if (newOwner != null)
				msgs = ((InternalEObject)newOwner).eInverseAdd(this, ClassDiagramPackage.CLASS__OWNED_ATTRIBUTES, edu.toronto.cs.se.modelepedia.classdiagram.Class.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ClassDiagramPackage.ATTRIBUTE__OWNER:
				return eInternalContainer().eInverseRemove(this, ClassDiagramPackage.CLASS__OWNED_ATTRIBUTES, edu.toronto.cs.se.modelepedia.classdiagram.Class.class, msgs);
		}
