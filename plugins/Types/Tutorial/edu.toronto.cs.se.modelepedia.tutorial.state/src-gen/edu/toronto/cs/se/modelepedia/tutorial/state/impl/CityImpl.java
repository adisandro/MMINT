 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.tutorial.state.impl.CityImpl#getPopulation <em>Population</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CityImpl extends NamedElementImpl implements City {
	/**
	...
	protected EClass eStaticClass() {
		return StatePackage.Literals.CITY;
	}
	...
	public void setPopulation(int newPopulation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatePackage.CITY__POPULATION, oldPopulation, population));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatePackage.CITY__POPULATION:
