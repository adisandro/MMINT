 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.tutorial.state.impl.NamedElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamedElementImpl extends MinimalEObjectImpl.Container implements NamedElement {
	...
	protected EClass eStaticClass() {
		return StatePackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatePackage.NAMED_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatePackage.NAMED_ELEMENT__NAME:
				return getName();
		}
