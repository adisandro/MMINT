 ...
 * @generated
 */
public class ArmyElementTypes {

	/**
	 * @generated
	 */
	private ArmyElementTypes() {
	}
	 ...
	 * @generated
	 */
	public static final IElementType Army_1000 = getElementType("edu.toronto.cs.se.modelepedia.tutorial.army.diagram.Army_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Unit_2001 = getElementType("edu.toronto.cs.se.modelepedia.tutorial.army.diagram.Unit_2001"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Army_1000, ArmyPackage.eINSTANCE.getArmy());

			elements.put(Unit_2001, ArmyPackage.eINSTANCE.getUnit());
		}
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Army_1000);
			KNOWN_ELEMENT_TYPES.add(Unit_2001);
		}
	...
	public static final DiagramElementTypes TYPED_INSTANCE = new DiagramElementTypes(
		...
		public boolean isKnownElementType(IElementType elementType) {
			return edu.toronto.cs.se.modelepedia.tutorial.army.diagram.providers.ArmyElementTypes
