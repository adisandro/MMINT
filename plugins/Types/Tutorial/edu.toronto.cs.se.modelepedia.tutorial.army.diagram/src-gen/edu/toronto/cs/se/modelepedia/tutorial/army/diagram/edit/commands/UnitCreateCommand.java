 ...
 */
package edu.toronto.cs.se.modelepedia.tutorial.army.diagram.edit.commands;
...
public class UnitCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public UnitCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Unit newElement = ArmyFactory.eINSTANCE.createUnit();

		Army owner = (Army) getElementToEdit();
