...
import edu.toronto.cs.se.modelepedia.tutorial.army.diagram.part.ArmyDiagramEditor;
...
import edu.toronto.cs.se.modelepedia.tutorial.army.diagram.part.Messages;

/**
 * @generated
 */
public class ArmyNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof ArmyNavigatorItem) {
					selectedElement = ((ArmyNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, ArmyDiagramEditor.ID);
