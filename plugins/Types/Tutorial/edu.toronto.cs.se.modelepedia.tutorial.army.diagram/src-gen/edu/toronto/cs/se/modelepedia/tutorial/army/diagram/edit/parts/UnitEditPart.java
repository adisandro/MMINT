...
import edu.toronto.cs.se.modelepedia.tutorial.army.diagram.edit.policies.UnitItemSemanticEditPolicy;
...
public class UnitEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ArmyVisualIDRegistry
	...
	public class UnitFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureUnitLabelFigure;
		...
		private void createContents() {
			...
			fFigureUnitLabelFigure = new WrappingLabel();

			fFigureUnitLabelFigure.setText("Unit");

			this.add(fFigureUnitLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureUnitLabelFigure() {
			return fFigureUnitLabelFigure;
		}
