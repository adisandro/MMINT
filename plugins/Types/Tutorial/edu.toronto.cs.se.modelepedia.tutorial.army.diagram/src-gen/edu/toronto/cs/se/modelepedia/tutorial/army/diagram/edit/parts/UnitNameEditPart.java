...
import edu.toronto.cs.se.modelepedia.tutorial.army.diagram.edit.policies.ArmyTextSelectionEditPolicy;
...
public class UnitNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ArmyTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ArmyParserProvider
					.getParser(
							ArmyElementTypes.Unit_2001,
							getParserElement(),
							ArmyVisualIDRegistry
									.getType(edu.toronto.cs.se.modelepedia.tutorial.army.diagram.edit.parts.UnitNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					ArmyEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
