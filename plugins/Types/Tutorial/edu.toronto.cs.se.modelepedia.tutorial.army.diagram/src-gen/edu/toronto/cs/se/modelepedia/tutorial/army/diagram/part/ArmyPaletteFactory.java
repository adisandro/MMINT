 ...
 * @generated
 */
public class ArmyPaletteFactory {
	...
	private ToolEntry createUnit1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections.singletonList(ArmyElementTypes.Unit_2001));
		entry.setId("createUnit1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ArmyElementTypes
				.getImageDescriptor(ArmyElementTypes.Unit_2001));
