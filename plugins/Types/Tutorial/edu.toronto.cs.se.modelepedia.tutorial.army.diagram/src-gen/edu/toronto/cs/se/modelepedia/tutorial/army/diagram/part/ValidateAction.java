...
import edu.toronto.cs.se.modelepedia.tutorial.army.diagram.providers.ArmyMarkerNavigationProvider;
import edu.toronto.cs.se.modelepedia.tutorial.army.diagram.providers.ArmyValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			if (ArmyDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		ArmyValidationProvider.runWithConstraints(txDomain, new Runnable() {
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			ArmyMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		ArmyMarkerNavigationProvider.addMarker(target, elementId, location,
