 ...
 * @generated
 */
public class EconomyInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new EconomyNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				EconomyEditPart.MODEL_ID));
		EconomyDiagramEditorUtil.runWizard(getShell(), wizard,
