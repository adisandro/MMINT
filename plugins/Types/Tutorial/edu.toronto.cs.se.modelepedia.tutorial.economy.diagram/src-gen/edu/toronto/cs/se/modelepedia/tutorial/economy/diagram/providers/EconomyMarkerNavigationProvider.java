...
import edu.toronto.cs.se.modelepedia.tutorial.economy.diagram.part.EconomyDiagramEditorUtil;

/**
 * @generated
 */
public class EconomyMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = EconomyDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			EconomyDiagramEditorUtil.selectElementsInDiagram(editor,
