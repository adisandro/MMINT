 ...
 * @generated
 */
public class StateBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected StateBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						StateVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = StateElementTypes
