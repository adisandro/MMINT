...
import edu.toronto.cs.se.modelepedia.tutorial.state.diagram.edit.commands.RegionCreateCommand;
...
public class StateItemSemanticEditPolicy extends
	...
	public StateItemSemanticEditPolicy() {
		super(StateElementTypes.State_1000);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (StateElementTypes.Region_2001 == req.getElementType()) {
