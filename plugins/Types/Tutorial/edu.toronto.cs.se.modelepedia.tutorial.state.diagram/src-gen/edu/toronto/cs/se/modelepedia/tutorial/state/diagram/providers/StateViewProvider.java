 ...
 * @generated
 */
public class StateViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = StateVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != StateVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = StateVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = StateVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case RegionEditPart.VISUAL_ID:
		...
		case CityEditPart.VISUAL_ID:
			return createCity_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (StateVisualIDRegistry.getVisualID(elementTypeHint)) {
		}
	...
	public Node createRegion_2001(EObject domainElement, View containerView,
		...
		node.setType(StateVisualIDRegistry.getType(RegionEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createCity_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StateVisualIDRegistry.getType(CityEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
