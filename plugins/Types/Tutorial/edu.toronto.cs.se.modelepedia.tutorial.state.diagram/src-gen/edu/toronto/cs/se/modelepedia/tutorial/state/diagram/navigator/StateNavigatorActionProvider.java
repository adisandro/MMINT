...
import edu.toronto.cs.se.modelepedia.tutorial.state.diagram.part.StateDiagramEditor;
 ...
 * @generated
 */
public class StateNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof StateNavigatorItem) {
					selectedElement = ((StateNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, StateDiagramEditor.ID);
