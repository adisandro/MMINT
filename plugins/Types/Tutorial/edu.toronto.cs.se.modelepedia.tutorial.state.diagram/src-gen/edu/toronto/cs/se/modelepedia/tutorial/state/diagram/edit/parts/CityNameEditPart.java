...
import edu.toronto.cs.se.modelepedia.tutorial.state.diagram.edit.policies.StateTextSelectionEditPolicy;
 ...
 * @generated
 */
public class CityNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CityNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new StateTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return StateElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StateParserProvider
					.getParser(
							StateElementTypes.City_3001,
							getParserElement(),
							StateVisualIDRegistry
									.getType(edu.toronto.cs.se.modelepedia.tutorial.state.diagram.edit.parts.CityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					StateEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
