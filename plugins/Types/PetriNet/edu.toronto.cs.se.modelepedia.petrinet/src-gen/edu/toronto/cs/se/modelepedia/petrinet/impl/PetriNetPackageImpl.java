...
import edu.toronto.cs.se.modelepedia.petrinet.util.PetriNetValidator;
...
public class PetriNetPackageImpl extends EPackageImpl implements PetriNetPackage {
	 ...
	 * @see edu.toronto.cs.se.modelepedia.petrinet.PetriNetPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void createPackageContents() {
		...
		createEReference(arcEClass, ARC__SRC);
		createEReference(arcEClass, ARC__TGT);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPlace_Capacity(), ecorePackage.getEInt(), "capacity", null, 1, 1, Place.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getArc_Src(), this.getNode(), null, "src", null, 1, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArc_Tgt(), this.getNode(), null, "tgt", null, 1, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (arcEClass, 
		   source, 
		   new String[] {
			 "nodeTypes", "src.oclIsKindOf(Place) and tgt.oclIsKindOf(Transition) or src.oclIsKindOf(Transition) and tgt.oclIsKindOf(Place)"
		   });
	}
