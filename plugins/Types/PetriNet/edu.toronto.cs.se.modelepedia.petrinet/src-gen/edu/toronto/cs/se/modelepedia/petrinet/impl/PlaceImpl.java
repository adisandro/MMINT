 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.petrinet.impl.PlaceImpl#getCapacity <em>Capacity</em>}</li>
 *   <li>{@link edu.toronto.cs.se.modelepedia.petrinet.impl.PlaceImpl#getTokens <em>Tokens</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlaceImpl extends NodeImpl implements Place {
	...
	public void setCapacity(int newCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetriNetPackage.PLACE__CAPACITY, oldCapacity, capacity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetriNetPackage.PLACE__CAPACITY:
				return getCapacity();
