 ...
 * @generated
 */
public class PowerWindowInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new PowerWindowNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				WindowEditPart.MODEL_ID));
		PowerWindowDiagramEditorUtil.runWizard(getShell(), wizard,
