...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.powerwindow.Sensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SensorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_delay_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_delay_feature", "_UI_Sensor_type"),
				 PowerWindowPackage.Literals.SENSOR__DELAY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Sensor_type") + " " + sensor.getDelay();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Sensor.class)) {
			case PowerWindowPackage.SENSOR__DELAY:
