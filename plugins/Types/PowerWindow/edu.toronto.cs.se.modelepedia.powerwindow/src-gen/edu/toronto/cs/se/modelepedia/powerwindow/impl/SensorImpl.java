 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.powerwindow.impl.SensorImpl#getDelay <em>Delay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class SensorImpl extends EObjectImpl implements Sensor {
	...
	protected EClass eStaticClass() {
		return PowerWindowPackage.Literals.SENSOR;
	}
	...
	public void setDelay(int newDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PowerWindowPackage.SENSOR__DELAY, oldDelay, delay));
	}
