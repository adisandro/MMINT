...
public class Activator extends AbstractUIPlugin {
    // The plug-in ID
    public static final String PLUGIN_ID = "edu.toronto.cs.se.mmint.types.gsn.productline.design";
    ...
    public void start(BundleContext context) throws Exception {
	  ...
	  Activator.viewpoints.addAll(ViewpointRegistry.getInstance().registerFromPlugin(Activator.PLUGIN_ID + "/description/gsn.productline.odesign"));
    }
