 ...
 * </ul>
 *
 * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getSafetyCase()
...
public interface SafetyCase extends EObject {
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getSafetyCase_Goals()
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getSafetyCase_Strategies()
   * @model containment="true"
   * @generated
   */
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getSafetyCase_Solutions()
   * @model containment="true"
   * @generated
   */
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getSafetyCase_Contexts()
   * @model containment="true"
   * @generated
   */
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getSafetyCase_Justifications()
   * @model containment="true"
   * @generated
   */
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getSafetyCase_Assumptions()
   * @model containment="true"
   * @generated
   */
   ...
   * @see edu.toronto.cs.se.modelepedia.safetycase.GSNPackage#getSafetyCase_Connectors()
   * @model containment="true"
   * @generated
   */
