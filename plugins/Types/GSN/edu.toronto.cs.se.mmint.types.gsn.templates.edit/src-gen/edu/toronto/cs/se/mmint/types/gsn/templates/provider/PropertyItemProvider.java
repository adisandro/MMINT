...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmint.types.gsn.templates.Property} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyItemProvider
    ...
    this.itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)this.adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Property_formal_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Property_formal_feature", "_UI_Property_type"),
         GSNTemplatesPackage.Literals.PROPERTY__FORMAL,
         true,
         false,
         false,
  ...
  /**
   * This adds a property descriptor for the Informal feature.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected void addInformalPropertyDescriptor(Object object) {
    this.itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)this.adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Property_informal_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Property_informal_feature", "_UI_Property_type"),
         GSNTemplatesPackage.Literals.PROPERTY__INFORMAL,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public String getText(Object object) {
    var label = ((Property)object).getFormal();
