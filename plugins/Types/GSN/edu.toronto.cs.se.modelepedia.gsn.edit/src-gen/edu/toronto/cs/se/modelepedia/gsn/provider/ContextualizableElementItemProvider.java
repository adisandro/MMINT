...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.gsn.ContextualizableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContextualizableElementItemProvider extends ArgumentElementItemProvider {
  /**
   ...
   * @generated
   */
  public ContextualizableElementItemProvider(AdapterFactory adapterFactory) {
  ...
  public String getText(Object object) {
    var label = ((ContextualizableElement)object).getId();
    return label == null || label.length() == 0 ?
      getString("_UI_ContextualizableElement_type") :
      getString("_UI_ContextualizableElement_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(ContextualizableElement.class)) {
