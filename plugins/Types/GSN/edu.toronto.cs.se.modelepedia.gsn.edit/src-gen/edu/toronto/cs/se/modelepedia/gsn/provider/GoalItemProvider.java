...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.gsn.Goal} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class GoalItemProvider extends DecomposableCoreElementItemProvider {
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_Goal_type") : getString("_UI_Goal_type") + " " + label;
  }
