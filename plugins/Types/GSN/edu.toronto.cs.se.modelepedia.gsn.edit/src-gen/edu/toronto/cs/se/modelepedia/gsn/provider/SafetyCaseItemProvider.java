...
public class SafetyCaseItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  /**
   * This returns SafetyCase.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(GSNPackage.Literals.SAFETY_CASE__GOALS, GSNFactory.eINSTANCE
                                                                                                             .createBasicGoal()));
    ...
    newChildDescriptors.add(createChildParameter(GSNPackage.Literals.SAFETY_CASE__STRATEGIES, GSNFactory.eINSTANCE
                                                                                                                  .createBasicStrategy()));

    newChildDescriptors.add(createChildParameter(GSNPackage.Literals.SAFETY_CASE__STRATEGIES, GSNFactory.eINSTANCE
                                                                                                                  .createASILDecompositionStrategy()));

    newChildDescriptors.add(createChildParameter(GSNPackage.Literals.SAFETY_CASE__STRATEGIES, GSNFactory.eINSTANCE
                                                                                                                  .createDomainDecompositionStrategy()));

    newChildDescriptors.add(createChildParameter(GSNPackage.Literals.SAFETY_CASE__STRATEGIES, GSNFactory.eINSTANCE
                                                                                                                  .createPropertyDecompositionStrategy()));

    newChildDescriptors.add(createChildParameter(GSNPackage.Literals.SAFETY_CASE__SOLUTIONS, GSNFactory.eINSTANCE
                                                                                                                 .createSolution()));

    newChildDescriptors.add(createChildParameter(GSNPackage.Literals.SAFETY_CASE__CONTEXTS, GSNFactory.eINSTANCE
                                                                                                                .createContext()));

    newChildDescriptors.add(createChildParameter(GSNPackage.Literals.SAFETY_CASE__JUSTIFICATIONS, GSNFactory.eINSTANCE
                                                                                                                      .createJustification()));

    newChildDescriptors.add(createChildParameter(GSNPackage.Literals.SAFETY_CASE__ASSUMPTIONS, GSNFactory.eINSTANCE
                                                                                                                   .createAssumption()));

    newChildDescriptors.add(createChildParameter(GSNPackage.Literals.SAFETY_CASE__CONNECTORS, GSNFactory.eINSTANCE
                                                                                                                  .createAndSupporter()));
