 ...
 * @generated
 */
public class SupporterItemProvider extends ArgumentElementItemProvider {
  /**
  ...
  public String getText(Object object) {
    var label = ((Supporter)object).getId();
    return label == null || label.length() == 0 ?
      getString("_UI_Supporter_type") :
