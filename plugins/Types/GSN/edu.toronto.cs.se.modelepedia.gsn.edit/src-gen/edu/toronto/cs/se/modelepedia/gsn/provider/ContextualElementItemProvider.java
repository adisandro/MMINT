...
public class ContextualElementItemProvider extends ArgumentElementItemProvider {
  ...
  /**
   * This adds a property descriptor for the Context Of feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  protected void addContextOfPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                                             getResourceLocator(), getString(
                                                                                             "_UI_ContextualElement_contextOf_feature"),
                                                             getString("_UI_PropertyDescriptor_description",
                                                                       "_UI_ContextualElement_contextOf_feature",
                                                                       "_UI_ContextualElement_type"),
                                                             GSNPackage.Literals.CONTEXTUAL_ELEMENT__CONTEXT_OF, true,
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_ContextualElement_type")
