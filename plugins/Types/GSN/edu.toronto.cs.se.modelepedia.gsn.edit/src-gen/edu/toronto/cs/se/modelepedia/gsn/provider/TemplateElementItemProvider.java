...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.gsn.TemplateElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TemplateElementItemProvider
  ...
  public String getText(Object object) {
    var label = ((TemplateElement)object).getId();
    return label == null || label.length() == 0 ?
      getString("_UI_TemplateElement_type") :
      getString("_UI_TemplateElement_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(TemplateElement.class)) {
