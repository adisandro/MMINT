...
public class SupportableItemProvider extends SupporterItemProvider {
  ...
  /**
   * This adds a property descriptor for the Supported By feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  protected void addSupportedByPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                                             getResourceLocator(), getString(
                                                                                             "_UI_Supportable_supportedBy_feature"),
                                                             getString("_UI_PropertyDescriptor_description",
                                                                       "_UI_Supportable_supportedBy_feature",
                                                                       "_UI_Supportable_type"),
                                                             GSNPackage.Literals.SUPPORTABLE__SUPPORTED_BY, true, false,
                                                             true, null, null, null));
  }
  ...
  /**
   * This returns Supportable.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(GSNPackage.Literals.SUPPORTABLE__SUPPORTED_BY, GSNFactory.eINSTANCE
                                                                                                                    .createSupportedBy()));
  }
