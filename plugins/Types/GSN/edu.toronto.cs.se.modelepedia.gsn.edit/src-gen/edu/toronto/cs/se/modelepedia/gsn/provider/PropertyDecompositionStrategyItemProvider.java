...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.gsn.PropertyDecompositionStrategy}
...
public class PropertyDecompositionStrategyItemProvider extends DecompositionStrategyItemProvider {
  ...
  /**
   * This returns PropertyDecompositionStrategy.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    String label = ((PropertyDecompositionStrategy) object).getId();
    return label == null || label.length() == 0 ? getString("_UI_PropertyDecompositionStrategy_type")
