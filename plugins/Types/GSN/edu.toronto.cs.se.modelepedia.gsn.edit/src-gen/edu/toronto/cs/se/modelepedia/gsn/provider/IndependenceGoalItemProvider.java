...
public class IndependenceGoalItemProvider extends GoalItemProvider {
  ...
  /**
   * This returns IndependenceGoal.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    String label = ((IndependenceGoal) object).getId();
    return label == null || label.length() == 0 ? getString("_UI_IndependenceGoal_type")
