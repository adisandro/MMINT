...
public class DecomposableCoreElementItemProvider extends SupportableItemProvider {
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_DecomposableCoreElement_type")
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(GSNPackage.Literals.DECOMPOSABLE_CORE_ELEMENT__IN_CONTEXT_OF,
