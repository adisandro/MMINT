...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.gsn.Assumption} object. <!--
...
public class AssumptionItemProvider extends ContextualElementItemProvider {
  ...
  /**
   * This returns Assumption.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_Assumption_type")
