...
public abstract class PropertyDecompositionElementImpl extends MinimalEObjectImpl.Container implements
  ...
  public NotificationChain basicSetProperty(Property newProperty, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GSNPackage.PROPERTY_DECOMPOSITION_ELEMENT__PROPERTY, oldProperty, newProperty);
  ...
  public void setProperty(Property newProperty) {
    if (newProperty != this.property) {
      ...
      if (this.property != null)
        msgs = ((InternalEObject)this.property).eInverseRemove(this, InternalEObject.EOPPOSITE_FEATURE_BASE - GSNPackage.PROPERTY_DECOMPOSITION_ELEMENT__PROPERTY, null, msgs);
      if (newProperty != null)
        msgs = ((InternalEObject)newProperty).eInverseAdd(this, InternalEObject.EOPPOSITE_FEATURE_BASE - GSNPackage.PROPERTY_DECOMPOSITION_ELEMENT__PROPERTY, null, msgs);
      msgs = basicSetProperty(newProperty, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GSNPackage.PROPERTY_DECOMPOSITION_ELEMENT__PROPERTY, newProperty, newProperty));
  }
