...
public class PropertyImpl extends MinimalEObjectImpl.Container implements Property {
  ...
  public void setInformal(String newInformal) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GSNPackage.PROPERTY__INFORMAL, oldInformal, this.informal));
  }
  ...
  public void setFormal(String newFormal) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GSNPackage.PROPERTY__FORMAL, oldFormal, this.formal));
  }
