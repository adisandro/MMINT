 ...
 * @model abstract="true" annotation="http://www.eclipse.org/emf/2002/Ecore constraints='SupportCycle
 *        NonSupportableLeaves'" annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot
 ...
 *        NonSupportableLeaves='self.supportedBy.target -&gt; size() &gt; 0 and self.supportedBy.target -&gt;
 *        excludes(null)'"
 * @generated
 */
public interface Supportable extends Supporter {
  /**
   * Returns the value of the '<em><b>Supported By</b></em>' containment reference list. The list contents are of type
   * {@link edu.toronto.cs.se.modelepedia.gsn.SupportedBy}. It is bidirectional and its opposite is
   * '{@link edu.toronto.cs.se.modelepedia.gsn.SupportedBy#getSource <em>Source</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
