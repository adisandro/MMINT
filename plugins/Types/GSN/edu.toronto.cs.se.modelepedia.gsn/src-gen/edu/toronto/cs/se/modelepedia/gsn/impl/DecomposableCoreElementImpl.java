 ...
 * <li>{@link edu.toronto.cs.se.modelepedia.gsn.impl.DecomposableCoreElementImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link edu.toronto.cs.se.modelepedia.gsn.impl.DecomposableCoreElementImpl#getContentValidity <em>Content
 * Validity</em>}</li>
 * <li>{@link edu.toronto.cs.se.modelepedia.gsn.impl.DecomposableCoreElementImpl#getStatus <em>Status</em>}</li>
 * <li>{@link edu.toronto.cs.se.modelepedia.gsn.impl.DecomposableCoreElementImpl#getInContextOf <em>In Context
 * Of</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class DecomposableCoreElementImpl extends SupportableImpl implements DecomposableCoreElement {
  ...
  /**
   * The default value of the '{@link #getContentValidity() <em>Content Validity</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getContentValidity() <em>Content Validity</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getContentValidity()
   * @generated
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GSNPackage.DECOMPOSABLE_CORE_ELEMENT__DESCRIPTION,
  ...
  public void setContentValidity(ValidityValue newContentValidity) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GSNPackage.DECOMPOSABLE_CORE_ELEMENT__CONTENT_VALIDITY,
                                    oldContentValidity, contentValidity));
  }
  ...
  public NotificationChain basicSetStatus(ImpactAnnotation newStatus, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                                                             GSNPackage.DECOMPOSABLE_CORE_ELEMENT__STATUS, oldStatus,
                                                             newStatus);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newStatus != status) {
      ...
      if (status != null)
        msgs = ((InternalEObject) status).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
          - GSNPackage.DECOMPOSABLE_CORE_ELEMENT__STATUS, null, msgs);
      if (newStatus != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, GSNPackage.DECOMPOSABLE_CORE_ELEMENT__STATUS, newStatus,
                                    newStatus));
  }
  ...
  public EList<InContextOf> getInContextOf() {
    if (inContextOf == null) {
      inContextOf = new EObjectContainmentWithInverseEList<InContextOf>(InContextOf.class, this,
                                                                        GSNPackage.DECOMPOSABLE_CORE_ELEMENT__IN_CONTEXT_OF,
                                                                        GSNPackage.IN_CONTEXT_OF__CONTEXT_OF);
    }
    return inContextOf;
  }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
    if (baseClass == ArgumentElement.class) {
      ...
      case GSNPackage.DECOMPOSABLE_CORE_ELEMENT__ID:
        return GSNPackage.ARGUMENT_ELEMENT__ID;
      case GSNPackage.DECOMPOSABLE_CORE_ELEMENT__DESCRIPTION:
        return GSNPackage.ARGUMENT_ELEMENT__DESCRIPTION;
      case GSNPackage.DECOMPOSABLE_CORE_ELEMENT__CONTENT_VALIDITY:
        return GSNPackage.ARGUMENT_ELEMENT__CONTENT_VALIDITY;
      case GSNPackage.DECOMPOSABLE_CORE_ELEMENT__STATUS:
        return GSNPackage.ARGUMENT_ELEMENT__STATUS;
      default:
        return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == ArgumentElement.class) {
      ...
      case GSNPackage.ARGUMENT_ELEMENT__ID:
        return GSNPackage.DECOMPOSABLE_CORE_ELEMENT__ID;
      case GSNPackage.ARGUMENT_ELEMENT__DESCRIPTION:
        return GSNPackage.DECOMPOSABLE_CORE_ELEMENT__DESCRIPTION;
      case GSNPackage.ARGUMENT_ELEMENT__CONTENT_VALIDITY:
        return GSNPackage.DECOMPOSABLE_CORE_ELEMENT__CONTENT_VALIDITY;
      case GSNPackage.ARGUMENT_ELEMENT__STATUS:
        return GSNPackage.DECOMPOSABLE_CORE_ELEMENT__STATUS;
      default:
        return -1;
      }
    }
