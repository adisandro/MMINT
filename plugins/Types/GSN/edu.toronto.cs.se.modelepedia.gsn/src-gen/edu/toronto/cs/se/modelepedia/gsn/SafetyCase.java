...
public interface SafetyCase extends EObject {
  /**
   * Returns the value of the '<em><b>Goals</b></em>' containment reference list. The list contents are of type
   * {@link edu.toronto.cs.se.modelepedia.gsn.Goal}. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Strategies</b></em>' containment reference list. The list contents are of type
   * {@link edu.toronto.cs.se.modelepedia.gsn.Strategy}. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Solutions</b></em>' containment reference list. The list contents are of type
   * {@link edu.toronto.cs.se.modelepedia.gsn.Solution}. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * {@link edu.toronto.cs.se.modelepedia.gsn.Context}. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Justifications</b></em>' containment reference list. The list contents are of type
   * {@link edu.toronto.cs.se.modelepedia.gsn.Justification}. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Assumptions</b></em>' containment reference list. The list contents are of type
   * {@link edu.toronto.cs.se.modelepedia.gsn.Assumption}. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * {@link edu.toronto.cs.se.modelepedia.gsn.SupportConnector}. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
