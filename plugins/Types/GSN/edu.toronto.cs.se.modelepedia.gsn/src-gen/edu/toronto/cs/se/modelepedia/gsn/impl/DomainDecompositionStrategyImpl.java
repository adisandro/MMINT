...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Domain Strategy</b></em>'. <!-- end-user-doc
 * -->
 * <p>
  ...
  public NotificationChain basicSetDomain(Domain newDomain, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                                                             GSNPackage.DOMAIN_DECOMPOSITION_STRATEGY__DOMAIN,
                                                             oldDomain, newDomain);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newDomain != domain) {
      ...
      if (domain != null)
        msgs = ((InternalEObject) domain).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
          - GSNPackage.DOMAIN_DECOMPOSITION_STRATEGY__DOMAIN, null, msgs);
      if (newDomain != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, GSNPackage.DOMAIN_DECOMPOSITION_STRATEGY__DOMAIN, newDomain,
                                    newDomain));
  }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == DomainDecompositionElement.class) {
      ...
      case GSNPackage.DOMAIN_DECOMPOSITION_ELEMENT__DOMAIN:
        return GSNPackage.DOMAIN_DECOMPOSITION_STRATEGY__DOMAIN;
      default:
        return -1;
      }
    }
