...
public abstract class ArgumentElementImpl extends MinimalEObjectImpl.Container implements ArgumentElement {
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GSNPackage.ARGUMENT_ELEMENT__DESCRIPTION, oldDescription,
                                    description));
  }
  ...
  public void setContentValidity(ValidityValue newContentValidity) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GSNPackage.ARGUMENT_ELEMENT__CONTENT_VALIDITY,
  ...
  public NotificationChain basicSetStatus(ImpactAnnotation newStatus, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                                                             GSNPackage.ARGUMENT_ELEMENT__STATUS, oldStatus, newStatus);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newStatus != status) {
      ...
      if (status != null)
        msgs = ((InternalEObject) status).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
          - GSNPackage.ARGUMENT_ELEMENT__STATUS, null, msgs);
      if (newStatus != null)
