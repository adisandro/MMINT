...
public class EcoreToSMTLIBListener implements IAcceleoTextGenerationListener {
	...
	public EcoreToSMTLIBListener(@NonNull Map<String, MAVOElement> mavoModelObjs, boolean isMayOnly) {
