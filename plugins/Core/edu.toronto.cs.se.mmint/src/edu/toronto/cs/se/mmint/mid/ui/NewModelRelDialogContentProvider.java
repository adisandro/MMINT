...
public class NewModelRelDialogContentProvider implements ITreeContentProvider {

	private List<String> allowedModelRelTypeUris;

	public NewModelRelDialogContentProvider(List<String> allowedModelRelTypeUris) {
