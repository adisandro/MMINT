...
public class Experiment extends OperatorImpl {
    ...
    public void readInputProperties(Properties inputProperties) throws MMINTException {
        ...
        for (var variable : MIDOperatorIOUtils.getStringPropertySet(inputProperties, PROPERTY_IN_VARIABLES)) {
            ...
            if (MIDOperatorIOUtils.getOptionalBoolProperty(inputProperties, variable + PROPERTY_IN_VARIABLEX_SUFFIX,
                                                           false)) {
                this.varX = variable;
            }
        }
        ...
        this.distribution = DistributionType.valueOf(
                                MIDOperatorIOUtils.getStringProperty(inputProperties, PROPERTY_IN_DISTRIBUTIONTYPE));
