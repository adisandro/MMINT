 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see edu.toronto.cs.se.mmint.primitive.file.FileFactory
 * @model kind="package"
 * @generated
 */
public interface FilePackage extends EPackage {
   ...
   * @generated
   */
	String eNS_URI = "http://se.cs.toronto.edu/mmint/File";
   ...
   * @generated
   */
	FilePackage eINSTANCE = edu.toronto.cs.se.mmint.primitive.file.impl.FilePackageImpl.init();

	/**
   * The meta object id for the '{@link edu.toronto.cs.se.mmint.primitive.file.impl.FileModelImpl <em>Model</em>}' class.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @see edu.toronto.cs.se.mmint.primitive.file.impl.FileModelImpl
   * @see edu.toronto.cs.se.mmint.primitive.file.impl.FilePackageImpl#getFileModel()
   * @generated
   */
	int FILE_MODEL = 0;
   ...
   * @ordered
   */
  int FILE_MODEL__EMF_INSTANCE_ROOT = MIDPackage.MODEL__EMF_INSTANCE_ROOT;
   ...
   * @ordered
   */
    int FILE_MODEL___GET_CLOSEST_TYPE_CONSTRAINT = MIDPackage.MODEL___GET_CLOSEST_TYPE_CONSTRAINT;
   ...
   * @ordered
   */
    int FILE_MODEL___CREATE_INSTANCE_EDITOR__BOOLEAN = MIDPackage.MODEL___CREATE_INSTANCE_EDITOR__BOOLEAN;
   ...
   */
	...
	/**
   * Returns the meta object for class '{@link edu.toronto.cs.se.mmint.primitive.file.FileModel <em>Model</em>}'.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @return the meta object for class '<em>Model</em>'.
   * @see edu.toronto.cs.se.mmint.primitive.file.FileModel
   * @generated
   */
	EClass getFileModel();

	/**
   * Returns the meta object for the '{@link edu.toronto.cs.se.mmint.primitive.file.FileModel#openInstance() <em>Open Instance</em>}' operation.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @return the meta object for the '<em>Open Instance</em>' operation.
   * @see edu.toronto.cs.se.mmint.primitive.file.FileModel#openInstance()
   * @generated
   */
   ...
   */
	interface Literals {
		/**
     * The meta object literal for the '{@link edu.toronto.cs.se.mmint.primitive.file.impl.FileModelImpl <em>Model</em>}' class.
     * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
     * @see edu.toronto.cs.se.mmint.primitive.file.impl.FileModelImpl
     * @see edu.toronto.cs.se.mmint.primitive.file.impl.FilePackageImpl#getFileModel()
