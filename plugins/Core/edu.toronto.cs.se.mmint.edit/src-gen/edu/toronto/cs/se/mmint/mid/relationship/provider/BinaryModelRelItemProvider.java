...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmint.mid.relationship.BinaryModelRel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BinaryModelRelItemProvider
   ...
   * @generated
   */
	public BinaryModelRelItemProvider(AdapterFactory adapterFactory) {
   ...
   */
	...
	/**
   * This returns BinaryModelRel.gif.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @generated
   */
    ...
    return overlayImage(object, getResourceLocator().getImage("full/obj16/BinaryModelRel"));
  }
   ...
   */
    ...
    String label = ((BinaryModelRel)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_BinaryModelRel_type") :
      getString("_UI_BinaryModelRel_type") + " " + label;
  }
