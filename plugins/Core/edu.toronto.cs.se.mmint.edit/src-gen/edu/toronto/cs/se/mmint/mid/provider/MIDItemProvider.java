...
public class MIDItemProvider
   ...
   */
    ...
    if (this.itemPropertyDescriptors == null) {
      ...
      addEMFInstanceResourceSetPropertyDescriptor(object);
    }
   ...
   */
	...
	/**
   * This adds a property descriptor for the EMF Instance Resource Set feature.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected void addEMFInstanceResourceSetPropertyDescriptor(Object object) {
    this.itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)this.adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_MID_EMFInstanceResourceSet_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_MID_EMFInstanceResourceSet_feature", "_UI_MID_type"),
         MIDPackage.Literals.MID__EMF_INSTANCE_RESOURCE_SET,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
