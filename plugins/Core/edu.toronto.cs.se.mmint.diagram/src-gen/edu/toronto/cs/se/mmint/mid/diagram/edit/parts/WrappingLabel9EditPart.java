...
public class WrappingLabel9EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
			MIDVisualIDRegistry.getType(edu.toronto.cs.se.mmint.mid.diagram.edit.parts.WrappingLabel9EditPart.VISUAL_ID),
			new Point(0, 80));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MIDParserProvider.getParser(
				...
				getParserElement(),
				MIDVisualIDRegistry
						.getType(edu.toronto.cs.se.mmint.mid.diagram.edit.parts.WrappingLabel9EditPart.VISUAL_ID));
		}
		return parser;
	}
