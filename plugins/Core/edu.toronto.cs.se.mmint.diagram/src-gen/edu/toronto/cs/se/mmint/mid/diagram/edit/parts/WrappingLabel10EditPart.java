...
public class WrappingLabel10EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MIDParserProvider.getParser(MIDElementTypes.Model_2011, getParserElement(), MIDVisualIDRegistry
					.getType(edu.toronto.cs.se.mmint.mid.diagram.edit.parts.WrappingLabel10EditPart.VISUAL_ID));
		}
		return parser;
	}
