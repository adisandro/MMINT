...
public class ExtendibleElementSupertypeCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof ExtendibleElement) {
			return false;
		}
		...
		return MIDBaseItemSemanticEditPolicy.getLinkConstraints().canCreateExtendibleElementSupertype_4013(
			getSource(),
			getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setSupertype(getTarget());
		}
