 ...
 * @generated
 */
public class ModelEndpointNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
			MIDVisualIDRegistry.getType(edu.toronto.cs.se.mmint.mid.diagram.edit.parts.ModelEndpointNameEditPart.VISUAL_ID),
			new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ModelEndpointNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MIDParserProvider.getParser(
				...
				getParserElement(),
				MIDVisualIDRegistry
						.getType(edu.toronto.cs.se.mmint.mid.diagram.edit.parts.ModelEndpointNameEditPart.VISUAL_ID));
		}
		return parser;
	}
