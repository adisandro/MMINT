...
import edu.toronto.cs.se.mmint.mid.diagram.edit.policies.ModelRel2ItemSemanticEditPolicy;
import edu.toronto.cs.se.mmint.mid.diagram.edit.policies.ModelRelImportedSemanticEditPolicy;
...
public class ModelRel2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel7EditPart) {
			((WrappingLabel7EditPart) childEditPart).setLabel(getPrimaryShape().getFigureModelRelLabelFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel8EditPart) {
			((WrappingLabel8EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCustomModelRelLabelFigure());
			return true;
		}
		return false;
	}
