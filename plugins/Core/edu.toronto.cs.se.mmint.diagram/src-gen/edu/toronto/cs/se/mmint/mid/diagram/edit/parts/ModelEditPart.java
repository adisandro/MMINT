...
import edu.toronto.cs.se.mmint.mid.diagram.edit.policies.ModelCreatedSemanticEditPolicy;
...
public class ModelEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WrappingLabel2EditPart) {
			((WrappingLabel2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCustomModelLabelFigure());
			return true;
		}
		return false;
	}
