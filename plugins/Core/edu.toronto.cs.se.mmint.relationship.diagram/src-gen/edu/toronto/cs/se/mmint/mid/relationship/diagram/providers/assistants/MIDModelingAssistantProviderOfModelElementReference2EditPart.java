 ...
 * @generated
 */
public class MIDModelingAssistantProviderOfModelElementReference2EditPart
		extends MIDModelingAssistantProvider {
	...
	public List<IElementType> doGetRelTypesOnSource(
			ModelElementReference2EditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(ModelElementReference2EditPart) sourceEditPart, targetEditPart);
	}
	...
	public List<IElementType> getTypesForTarget(IAdaptable source,
		...
		return doGetTypesForTarget(
				(ModelElementReference2EditPart) sourceEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForTarget(
			ModelElementReference2EditPart source, IElementType relationshipType) {
	...
	public List<IElementType> doGetRelTypesOnTarget(
			ModelElementReference2EditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(ModelElementReference2EditPart) targetEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForSource(
			ModelElementReference2EditPart target, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == MIDElementTypes.ExtendibleElementReferenceSupertypeRef_4010) {
			types.add(MIDElementTypes.ModelEndpointReference_2007);
			types.add(MIDElementTypes.LinkReference_2008);
