 ...
 * @generated
 */
public class WrappingLabel18EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				MIDVisualIDRegistry.getType(
						edu.toronto.cs.se.mmint.mid.relationship.diagram.edit.parts.WrappingLabel18EditPart.VISUAL_ID),
				new Point(0, 60));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MIDParserProvider.getParser(MIDElementTypes.BinaryMappingReference_4003, getParserElement(),
					MIDVisualIDRegistry.getType(
							edu.toronto.cs.se.mmint.mid.relationship.diagram.edit.parts.WrappingLabel18EditPart.VISUAL_ID));
		}
		return parser;
