...
public class WrappingLabel4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MIDParserProvider.getParser(MIDElementTypes.MappingReference_2002, getParserElement(),
					MIDVisualIDRegistry.getType(
							edu.toronto.cs.se.mmint.mid.relationship.diagram.edit.parts.WrappingLabel4EditPart.VISUAL_ID));
		}
		return parser;
	}
