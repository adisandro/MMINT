 ...
 * @generated
 */
public class MIDModelingAssistantProviderOfModelEndpointReference2EditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			ModelEndpointReference2EditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(ModelEndpointReference2EditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			ModelEndpointReference2EditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(MIDElementTypes.ExtendibleElementReferenceSupertypeRef_4010);
		return types;
	}
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(ModelEndpointReference2EditPart) targetEditPart,
				relationshipType);
	}
