...
public class WrappingLabel13EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MIDParserProvider.getParser(MIDElementTypes.ModelElementReference_3003, getParserElement(),
					MIDVisualIDRegistry.getType(
							edu.toronto.cs.se.mmint.mid.relationship.diagram.edit.parts.WrappingLabel13EditPart.VISUAL_ID));
		}
		return parser;
	}
