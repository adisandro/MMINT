 ...
 * @generated
 */
public class BinaryLinkReference2ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BinaryLinkReference2ReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return MIDBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistBinaryLinkReference_4013(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		ModelRel container = (ModelRel) getLink().eContainer();
		return MIDBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistBinaryLinkReference_4013(container, getLink(), source,
						getNewTarget());
	}
