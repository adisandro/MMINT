...
public class BinaryMappingReferenceReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public BinaryMappingReferenceReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return MIDBaseItemSemanticEditPolicy.getLinkConstraints().canExistBinaryMappingReference_4003(container,
