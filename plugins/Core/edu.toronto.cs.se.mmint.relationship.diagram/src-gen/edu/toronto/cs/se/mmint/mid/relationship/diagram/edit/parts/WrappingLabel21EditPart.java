 ...
 * @generated
 */
public class WrappingLabel21EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				MIDVisualIDRegistry.getType(
						edu.toronto.cs.se.mmint.mid.relationship.diagram.edit.parts.WrappingLabel21EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MIDParserProvider.getParser(MIDElementTypes.BinaryMappingReference_4004, getParserElement(),
					MIDVisualIDRegistry.getType(
							edu.toronto.cs.se.mmint.mid.relationship.diagram.edit.parts.WrappingLabel21EditPart.VISUAL_ID));
		}
		return parser;
