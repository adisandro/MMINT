 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see edu.toronto.cs.se.mmint.mid.productline.MIDPLFactory
 * @model kind="package"
 * @generated
 */
public interface MIDPLPackage extends EPackage {
  /**
   * The package name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  MIDPLPackage eINSTANCE = edu.toronto.cs.se.mmint.mid.productline.impl.MIDPLPackageImpl.init();
   ...
   * @see edu.toronto.cs.se.mmint.mid.productline.impl.MIDPLPackageImpl#getPLModelRel()
   * @generated
   */
  int PL_MODEL_REL = 0;
   ...
   * @see edu.toronto.cs.se.mmint.mid.productline.impl.MIDPLPackageImpl#getPLBinaryModelRel()
   * @generated
   */
   ...
   * @see edu.toronto.cs.se.mmint.mid.productline.impl.MIDPLPackageImpl#getPLMapping()
   * @generated
   */
  int PL_MAPPING = 2;
   ...
   * @see edu.toronto.cs.se.mmint.mid.productline.impl.MIDPLPackageImpl#getPLBinaryMapping()
   * @generated
   */
   ...
   * @see edu.toronto.cs.se.mmint.mid.productline.impl.MIDPLPackageImpl#getPLMappingReference()
   * @generated
   */
   ...
   * @see edu.toronto.cs.se.mmint.mid.productline.impl.MIDPLPackageImpl#getPLBinaryMappingReference()
   * @generated
   */
  ...
  interface Literals {
     ...
     * @generated
     */
    EClass PL_MODEL_REL = MIDPLPackage.eINSTANCE.getPLModelRel();
     ...
     * @generated
     */
    EClass PL_BINARY_MODEL_REL = MIDPLPackage.eINSTANCE.getPLBinaryModelRel();
     ...
     * @generated
     */
    EClass PL_MAPPING = MIDPLPackage.eINSTANCE.getPLMapping();
     ...
     * @generated
     */
    EClass PL_BINARY_MAPPING = MIDPLPackage.eINSTANCE.getPLBinaryMapping();
     ...
     * @generated
     */
    EClass PL_MAPPING_REFERENCE = MIDPLPackage.eINSTANCE.getPLMappingReference();
     ...
     * @generated
     */
    EClass PL_BINARY_MAPPING_REFERENCE = MIDPLPackage.eINSTANCE.getPLBinaryMappingReference();
