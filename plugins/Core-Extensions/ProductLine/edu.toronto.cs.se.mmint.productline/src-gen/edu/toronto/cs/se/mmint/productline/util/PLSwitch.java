 ...
 * @generated
 */
public class PLSwitch<T> extends Switch<T> {
  /**
   ...
   */
  public PLSwitch() {
    if (PLSwitch.modelPackage == null) {
      PLSwitch.modelPackage = PLPackage.eINSTANCE;
    }
  }
  ...
  protected boolean isSwitchFor(EPackage ePackage) {
    return ePackage == PLSwitch.modelPackage;
  }
