...
public class PLMappingImpl extends MappingImpl implements PLMapping {
  ...
  public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
    if (baseClass == PLElement.class) {
      ...
      case PLPackage.PL_ELEMENT___IS_IN_ALL_PRODUCTS -> PLMIDPackage.PL_MAPPING___IS_IN_ALL_PRODUCTS;
      case PLPackage.PL_ELEMENT___GET_PRESENCE_CONDITION_LABEL -> PLMIDPackage.PL_MAPPING___GET_PRESENCE_CONDITION_LABEL;
      default -> -1;
      };
    }
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case PLMIDPackage.PL_MAPPING___IS_IN_ALL_PRODUCTS:
      return isInAllProducts();
    case PLMIDPackage.PL_MAPPING___GET_PRESENCE_CONDITION_LABEL:
