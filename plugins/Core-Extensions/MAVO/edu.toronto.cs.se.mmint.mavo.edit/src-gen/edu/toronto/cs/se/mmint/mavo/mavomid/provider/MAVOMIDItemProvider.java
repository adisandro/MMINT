...
import edu.toronto.cs.se.mmint.mid.provider.MIDItemProvider;
...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmint.mavo.mavomid.MAVOMID} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MAVOMIDItemProvider extends MIDItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MAVOMIDItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MAVOMID"));
	}
	...
	public String getText(Object object) {
		MIDLevel labelValue = ((MAVOMID)object).getLevel();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_MAVOMID_type") :
			getString("_UI_MAVOMID_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MAVOMID.class)) {
