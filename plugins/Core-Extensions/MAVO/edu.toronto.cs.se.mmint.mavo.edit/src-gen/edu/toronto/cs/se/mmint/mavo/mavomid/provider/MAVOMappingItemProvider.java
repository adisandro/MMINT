...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmint.mavo.mavomid.MAVOMapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MAVOMappingItemProvider extends MappingItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MAVOMappingItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MAVOMapping"));
	}
	...
	public String getText(Object object) {
		String label = ((MAVOMapping)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MAVOMapping_type") :
			getString("_UI_MAVOMapping_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MAVOMapping.class)) {
