...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MAVO Mapping</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOMappingImpl#getFormulaVariable <em>Formula Variable</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOMappingImpl#isMay <em>May</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOMappingImpl#isSet <em>Set</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOMappingImpl#isVar <em>Var</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOMappingImpl#getCollections <em>Collections</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MAVOMappingImpl extends MappingImpl implements MAVOMapping {
	/**
   ...
   */
    ...
    return MAVOMIDPackage.Literals.MAVO_MAPPING;
  }
  ...
  public void setFormulaVariable(String newFormulaVariable) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MAVOMIDPackage.MAVO_MAPPING__FORMULA_VARIABLE, oldFormulaVariable, formulaVariable));
  }
  ...
  public void setMay(boolean newMay) {
    ...
    may = newMay;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MAVOMIDPackage.MAVO_MAPPING__MAY, oldMay, may));
  }
  ...
  public void setSet(boolean newSet) {
    ...
    set = newSet;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MAVOMIDPackage.MAVO_MAPPING__SET, oldSet, set));
  }
  ...
  public void setVar(boolean newVar) {
    ...
    var = newVar;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MAVOMIDPackage.MAVO_MAPPING__VAR, oldVar, var));
  }
  ...
  public EList<MAVOCollection> getCollections() {
    if (collections == null) {
      collections = new EObjectWithInverseResolvingEList.ManyInverse<MAVOCollection>(MAVOCollection.class, this, MAVOMIDPackage.MAVO_MAPPING__COLLECTIONS, MAVOPackage.MAVO_COLLECTION__MAVO_ELEMENTS);
    }
    return collections;
  }
   ...
   */
    ...
    switch (featureID) {
      case MAVOMIDPackage.MAVO_MAPPING__COLLECTIONS:
   ...
   */
    ...
    switch (featureID) {
      case MAVOMIDPackage.MAVO_MAPPING__FORMULA_VARIABLE:
        return getFormulaVariable();
      case MAVOMIDPackage.MAVO_MAPPING__MAY:
        return isMay();
      case MAVOMIDPackage.MAVO_MAPPING__SET:
        return isSet();
      case MAVOMIDPackage.MAVO_MAPPING__VAR:
        return isVar();
      case MAVOMIDPackage.MAVO_MAPPING__COLLECTIONS:
   ...
   */
    ...
    if (baseClass == LogicElement.class) {
      switch (derivedFeatureID) {
        case MAVOMIDPackage.MAVO_MAPPING__FORMULA_VARIABLE: return MAVOPackage.LOGIC_ELEMENT__FORMULA_VARIABLE;
        default: return -1;
      }
    }
    if (baseClass == MAVOElement.class) {
      switch (derivedFeatureID) {
        case MAVOMIDPackage.MAVO_MAPPING__MAY: return MAVOPackage.MAVO_ELEMENT__MAY;
        case MAVOMIDPackage.MAVO_MAPPING__SET: return MAVOPackage.MAVO_ELEMENT__SET;
        case MAVOMIDPackage.MAVO_MAPPING__VAR: return MAVOPackage.MAVO_ELEMENT__VAR;
        case MAVOMIDPackage.MAVO_MAPPING__COLLECTIONS: return MAVOPackage.MAVO_ELEMENT__COLLECTIONS;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == LogicElement.class) {
      switch (baseFeatureID) {
        case MAVOPackage.LOGIC_ELEMENT__FORMULA_VARIABLE: return MAVOMIDPackage.MAVO_MAPPING__FORMULA_VARIABLE;
        default: return -1;
      }
    }
    if (baseClass == MAVOElement.class) {
      switch (baseFeatureID) {
        case MAVOPackage.MAVO_ELEMENT__MAY: return MAVOMIDPackage.MAVO_MAPPING__MAY;
        case MAVOPackage.MAVO_ELEMENT__SET: return MAVOMIDPackage.MAVO_MAPPING__SET;
        case MAVOPackage.MAVO_ELEMENT__VAR: return MAVOMIDPackage.MAVO_MAPPING__VAR;
        case MAVOPackage.MAVO_ELEMENT__COLLECTIONS: return MAVOMIDPackage.MAVO_MAPPING__COLLECTIONS;
        default: return -1;
      }
    }
