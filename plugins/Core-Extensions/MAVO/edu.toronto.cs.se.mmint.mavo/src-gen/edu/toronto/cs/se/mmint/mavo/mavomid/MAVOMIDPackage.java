...
public interface MAVOMIDPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOBinaryModelRelImpl <em>MAVO Binary Model Rel</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The number of structural features of the '<em>MAVO Binary Model Rel</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MODEL_REL___CREATE_SUBTYPE__STRING_STRING_STRING_BOOLEAN = RelationshipPackage.BINARY_MODEL_REL___CREATE_SUBTYPE__STRING_STRING_STRING_BOOLEAN;
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MODEL_REL___CREATE_INSTANCE__STRING_MID = RelationshipPackage.BINARY_MODEL_REL___CREATE_INSTANCE__STRING_MID;
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MODEL_REL___CREATE_INSTANCE_EDITOR = RelationshipPackage.BINARY_MODEL_REL___CREATE_INSTANCE_EDITOR;
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MODEL_REL___CREATE_INSTANCE_AND_EDITOR__STRING_MID = RelationshipPackage.BINARY_MODEL_REL___CREATE_INSTANCE_AND_EDITOR__STRING_MID;
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MODEL_REL___COPY_INSTANCE__MODEL_STRING_MID = RelationshipPackage.BINARY_MODEL_REL___COPY_INSTANCE__MODEL_STRING_MID;
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MODEL_REL___GET_EMF_INSTANCE_ROOT = RelationshipPackage.BINARY_MODEL_REL___GET_EMF_INSTANCE_ROOT;
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MODEL_REL___CREATE_BINARY_SUBTYPE__STRING_STRING_STRING_BOOLEAN = RelationshipPackage.BINARY_MODEL_REL___CREATE_BINARY_SUBTYPE__STRING_STRING_STRING_BOOLEAN;
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MODEL_REL___CREATE_INSTANCE_AND_ENDPOINTS_AND_REFERENCES__STRING_ELIST_MID = RelationshipPackage.BINARY_MODEL_REL___CREATE_INSTANCE_AND_ENDPOINTS_AND_REFERENCES__STRING_ELIST_MID;
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MODEL_REL___CREATE_BINARY_INSTANCE__STRING_MID = RelationshipPackage.BINARY_MODEL_REL___CREATE_BINARY_INSTANCE__STRING_MID;
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MODEL_REL___CREATE_BINARY_INSTANCE_AND_ENDPOINTS_AND_REFERENCES__STRING_MODEL_MODEL_MID = RelationshipPackage.BINARY_MODEL_REL___CREATE_BINARY_INSTANCE_AND_ENDPOINTS_AND_REFERENCES__STRING_MODEL_MODEL_MID;
	...
	/**
	 * The number of operations of the '<em>MAVO Binary Model Rel</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int MAVO_BINARY_MODEL_REL_OPERATION_COUNT = RelationshipPackage.BINARY_MODEL_REL_OPERATION_COUNT + 0;
	...
	/**
	 * The meta object id for the '{@link edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOBinaryMappingImpl <em>MAVO Binary Mapping</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The number of structural features of the '<em>MAVO Binary Mapping</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MAPPING___TO_MID_CUSTOM_PRINT_LABEL = RelationshipPackage.BINARY_MAPPING___TO_MID_CUSTOM_PRINT_LABEL;
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MAPPING___TO_MID_CUSTOM_EDIT_LABEL = RelationshipPackage.BINARY_MAPPING___TO_MID_CUSTOM_EDIT_LABEL;
	 ...
	 * @ordered
	 */
	int MAVO_BINARY_MAPPING___UPDATE_MID_CUSTOM_LABEL__STRING = RelationshipPackage.BINARY_MAPPING___UPDATE_MID_CUSTOM_LABEL__STRING;
	...
	/**
	 * The number of operations of the '<em>MAVO Binary Mapping</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int MAVO_BINARY_MAPPING_OPERATION_COUNT = RelationshipPackage.BINARY_MAPPING_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link edu.toronto.cs.se.mmint.mavo.mavomid.MAVOBinaryModelRel <em>MAVO Binary Model Rel</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>MAVO Binary Model Rel</em>'.
	...
	/**
	 * Returns the meta object for class '{@link edu.toronto.cs.se.mmint.mavo.mavomid.MAVOBinaryMapping <em>MAVO Binary Mapping</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>MAVO Binary Mapping</em>'.
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOBinaryModelRelImpl <em>MAVO Binary Model Rel</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOBinaryModelRelImpl
		 * @see edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOMIDPackageImpl#getMAVOBinaryModelRel()
		...
		/**
		 * The meta object literal for the '{@link edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOBinaryMappingImpl <em>MAVO Binary Mapping</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOBinaryMappingImpl
		 * @see edu.toronto.cs.se.mmint.mavo.mavomid.impl.MAVOMIDPackageImpl#getMAVOBinaryMapping()
