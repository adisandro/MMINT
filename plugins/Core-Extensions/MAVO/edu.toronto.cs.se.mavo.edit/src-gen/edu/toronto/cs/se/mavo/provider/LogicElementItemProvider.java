...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mavo.LogicElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LogicElementItemProvider
	 ...
	 * @generated
	 */
	public LogicElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((LogicElement)object).getFormulaVariable();
		return label == null || label.length() == 0 ?
			getString("_UI_LogicElement_type") :
			getString("_UI_LogicElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LogicElement.class)) {
	...
	public ResourceLocator getResourceLocator() {
		return MAVOEditPlugin.INSTANCE;
	}
