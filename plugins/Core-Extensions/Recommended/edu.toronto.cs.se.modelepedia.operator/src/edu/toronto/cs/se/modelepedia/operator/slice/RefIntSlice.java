...
// The referential integrity slice operator returns a sub-model (i.e. slice) 
// of the original model instance that satisfies referential integrity given 
...
public class RefIntSlice extends OperatorImpl {
