...
public class StringAdapterFactory extends AdapterFactoryImpl {
	...
	protected StringSwitch<Adapter> modelSwitch =
		new StringSwitch<Adapter>() {
			@Override
			public Adapter caseString(edu.toronto.cs.se.modelepedia.primitive.string.String object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.toronto.cs.se.modelepedia.primitive.string.String <em>String</em>}'.
	 * <!-- begin-user-doc -->
