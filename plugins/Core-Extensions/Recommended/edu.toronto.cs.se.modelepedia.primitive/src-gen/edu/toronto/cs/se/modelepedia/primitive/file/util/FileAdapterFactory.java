...
import edu.toronto.cs.se.modelepedia.primitive.file.*;
 ...
 * <!-- end-user-doc -->
 * @see edu.toronto.cs.se.modelepedia.primitive.file.FilePackage
 * @generated
 */
public class FileAdapterFactory extends AdapterFactoryImpl {
   ...
   */
	protected FileSwitch<Adapter> modelSwitch =
      ...
      @Override
      public Adapter caseFileModel(FileModel object) {
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link edu.toronto.cs.se.modelepedia.primitive.file.FileModel <em>Model</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
	public Adapter createFileModelAdapter() {
    return null;
  }
