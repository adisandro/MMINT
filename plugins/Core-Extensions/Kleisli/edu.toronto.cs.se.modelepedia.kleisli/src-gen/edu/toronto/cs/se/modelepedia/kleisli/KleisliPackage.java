...
public interface KleisliPackage extends EPackage {
   ...
   * @ordered
   */
  int KLEISLI_MODEL__EMF_INSTANCE_ROOT = MIDPackage.MODEL__EMF_INSTANCE_ROOT;
   ...
   * @ordered
   */
	int KLEISLI_MODEL_OPERATION_COUNT = MIDPackage.MODEL_OPERATION_COUNT + 5;
   ...
   * @ordered
   */
  int KLEISLI_MODEL_REL__EMF_INSTANCE_ROOT = RelationshipPackage.MODEL_REL__EMF_INSTANCE_ROOT;
   ...
   * @ordered
   */
  int BINARY_KLEISLI_MODEL_REL__EMF_INSTANCE_ROOT = KLEISLI_MODEL_REL__EMF_INSTANCE_ROOT;
