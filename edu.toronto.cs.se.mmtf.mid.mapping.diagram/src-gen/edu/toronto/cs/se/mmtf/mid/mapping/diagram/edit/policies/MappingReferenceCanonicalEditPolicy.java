 ...
 * @generated
 */
public class MappingReferenceCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<MIDNodeDescriptor> childDescriptors = MIDDiagramUpdater
				.getMappingReference_1000SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<MIDNodeDescriptor> childDescriptors = MIDDiagramUpdater
				.getMappingReference_1000SemanticChildren((View) getHost()
						.getModel());
		...
		case MappingReferenceEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(MIDDiagramUpdater
						.getMappingReference_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
