 ...
 * @generated
 */
public class ModelContainerNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelContainerNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MIDParserProvider
					.getParser(
							...
							getParserElement(),
							MIDVisualIDRegistry
									.getType(edu.toronto.cs.se.mmtf.mid.mapping.diagram.edit.parts.ModelContainerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
