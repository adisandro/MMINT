 ...
 * @generated
 */
public class MappingItemSemanticEditPolicy extends
		MIDBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public MappingItemSemanticEditPolicy() {
		super(MIDElementTypes.Mapping_2004);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MIDVisualIDRegistry.getVisualID(outgoingLink) == MappingElementsEditPart.VISUAL_ID) {
