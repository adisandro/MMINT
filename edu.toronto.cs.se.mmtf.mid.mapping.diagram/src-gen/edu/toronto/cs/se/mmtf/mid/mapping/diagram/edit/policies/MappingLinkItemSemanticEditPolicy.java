 ...
 * @generated
 */
public class MappingLinkItemSemanticEditPolicy extends
		MIDBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public MappingLinkItemSemanticEditPolicy() {
		super(MIDElementTypes.MappingLink_2006);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MIDVisualIDRegistry.getVisualID(outgoingLink) == MappingLinkElementsEditPart.VISUAL_ID) {
