...
import edu.toronto.cs.se.mmtf.mid.mapping.diagram.edit.policies.MIDTextSelectionEditPolicy;
 ...
 * @generated
 */
public class MappingLinkNameTypeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MappingLinkNameTypeEditPart(View view) {
		super(view);
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof MIDTextSelectionEditPolicy) {
			((MIDTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof MIDTextSelectionEditPolicy) {
			((MIDTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
		...
		if (parser == null) {
			parser = MIDParserProvider
					.getParser(
							...
							getParserElement(),
							MIDVisualIDRegistry
									.getType(edu.toronto.cs.se.mmtf.mid.mapping.diagram.edit.parts.MappingLinkNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
