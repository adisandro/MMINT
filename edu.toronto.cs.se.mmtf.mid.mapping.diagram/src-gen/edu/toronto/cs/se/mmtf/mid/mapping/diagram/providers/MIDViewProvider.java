...
public class MIDViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return MappingReferenceEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!MappingReferenceEditPart.MODEL_ID
						.equals(MIDVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(MappingReferenceEditPart.MODEL_ID);
	...
	private void stampShortcut(View containerView, Node target) {
		if (!MappingReferenceEditPart.MODEL_ID.equals(MIDVisualIDRegistry
				.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", MappingReferenceEditPart.MODEL_ID); //$NON-NLS-1$
