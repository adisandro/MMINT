...
public class MIDNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case ModelContainerEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http:///edu/toronto/cs/se/mmtf/mid/model/mid.ecore/mapping?ModelContainer", MIDElementTypes.ModelContainer_2003); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case ModelContainerEditPart.VISUAL_ID:
			return getModelContainer_2003Text(view);
		case MappingElementsEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getModelContainer_2003Text(View view) {
		return ""; //$NON-NLS-1$
	}
