...
public class ModelElementReferenceEditPart extends ShapeNodeEditPart {
	...
	public class ModelElementReferenceFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureModelElementNameFigure;
		...
		private void createContents() {
			...
			fFigureModelElementNameFigure = new WrappingLabel();
			fFigureModelElementNameFigure.setText("<...>");

			this.add(fFigureModelElementNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureModelElementNameFigure() {
			return fFigureModelElementNameFigure;
		}
