...
import edu.toronto.cs.se.mmtf.xt.statechart.diagram.parsers.MessageFormatParser;
...
public class StatechartParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser superStateName_5003Parser;

	/**
	 * @generated
	 */
	private IParser getSuperStateName_5003Parser() {
		if (superStateName_5003Parser == null) {
			EAttribute[] features = new EAttribute[] { StatechartPackage.eINSTANCE
					.getState_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			superStateName_5003Parser = parser;
		}
		return superStateName_5003Parser;
	}
	 ...
	 * @generated
	 */
	private IParser superStateName_5002Parser;

	/**
	 * @generated
	 */
	private IParser getSuperStateName_5002Parser() {
		if (superStateName_5002Parser == null) {
			EAttribute[] features = new EAttribute[] { StatechartPackage.eINSTANCE
					.getState_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			superStateName_5002Parser = parser;
		}
		return superStateName_5002Parser;
	}
	...
	protected IParser getParser(int visualID) {
		switch (visualID) {
		case SuperStateNameEditPart.VISUAL_ID:
			return getSuperStateName_5003Parser();
		case StateNameEditPart.VISUAL_ID:
			return getStateName_5004Parser();
		case StateName2EditPart.VISUAL_ID:
			return getStateName_5001Parser();
		case SuperStateName2EditPart.VISUAL_ID:
			return getSuperStateName_5002Parser();
		}
		return null;
	}
