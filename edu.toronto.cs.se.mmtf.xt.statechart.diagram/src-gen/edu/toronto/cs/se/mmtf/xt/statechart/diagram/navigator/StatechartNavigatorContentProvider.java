...
public class StatechartNavigatorContentProvider implements
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case SuperState3EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StatechartNavigatorGroup incominglinks = new StatechartNavigatorGroup(
					Messages.NavigatorGroupName_SuperState_3002_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			StatechartNavigatorGroup outgoinglinks = new StatechartNavigatorGroup(
					Messages.NavigatorGroupName_SuperState_3002_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
		...
		case SuperState2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			StatechartNavigatorGroup incominglinks = new StatechartNavigatorGroup(
					Messages.NavigatorGroupName_SuperState_2001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			StatechartNavigatorGroup outgoinglinks = new StatechartNavigatorGroup(
					Messages.NavigatorGroupName_SuperState_2001_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case SuperStateEditPart.VISUAL_ID: {
			...
			StatechartNavigatorGroup links = new StatechartNavigatorGroup(
					Messages.NavigatorGroupName_SuperState_1000_links,
