	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case SuperStateEditPart.VISUAL_ID:
				return new SuperStateEditPart(view);

			case SuperState2EditPart.VISUAL_ID:
				return new SuperState2EditPart(view);

			case SuperStateNameEditPart.VISUAL_ID:
				return new SuperStateNameEditPart(view);
			...
			case SuperState3EditPart.VISUAL_ID:
				return new SuperState3EditPart(view);

			case SuperStateName2EditPart.VISUAL_ID:
				return new SuperStateName2EditPart(view);

			case SuperStateSuperStateCompartmentEditPart.VISUAL_ID:
				return new SuperStateSuperStateCompartmentEditPart(view);

			case SuperStateSuperStateCompartment2EditPart.VISUAL_ID:
				return new SuperStateSuperStateCompartment2EditPart(view);
