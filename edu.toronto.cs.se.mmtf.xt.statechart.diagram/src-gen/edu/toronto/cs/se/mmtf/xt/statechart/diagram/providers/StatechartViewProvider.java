...
public class StatechartViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return SuperStateEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!SuperStateEditPart.MODEL_ID
						.equals(StatechartVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return SuperState2EditPart.VISUAL_ID == visualID
				|| StateEditPart.VISUAL_ID == visualID
				|| State2EditPart.VISUAL_ID == visualID
				|| SuperState3EditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(SuperStateEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case SuperState2EditPart.VISUAL_ID:
			return createSuperState_2001(domainElement, containerView, index,
		...
		case State2EditPart.VISUAL_ID:
			return createState_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case SuperState3EditPart.VISUAL_ID:
			return createSuperState_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createSuperState_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StatechartVisualIDRegistry
				.getType(SuperState2EditPart.VISUAL_ID));
		...
		createCompartment(
				node,
				StatechartVisualIDRegistry
						.getType(SuperStateSuperStateCompartmentEditPart.VISUAL_ID),
	 ...
	 * @generated
	 */
	public Node createSuperState_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StatechartVisualIDRegistry
				.getType(SuperState3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		createCompartment(
				node,
				StatechartVisualIDRegistry
						.getType(SuperStateSuperStateCompartment2EditPart.VISUAL_ID),
				false, false, false, false);
		return node;
	}
	...
	private void stampShortcut(View containerView, Node target) {
		if (!SuperStateEditPart.MODEL_ID.equals(StatechartVisualIDRegistry
				.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", SuperStateEditPart.MODEL_ID); //$NON-NLS-1$
