 ...
 * @generated
 */
public class SuperStateSuperStateCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StatechartNodeDescriptor> childDescriptors = StatechartDiagramUpdater
				.getSuperStateSuperStateCompartment_7002SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == State2EditPart.VISUAL_ID
				|| visualID == SuperState3EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<StatechartNodeDescriptor> childDescriptors = StatechartDiagramUpdater
				.getSuperStateSuperStateCompartment_7002SemanticChildren((View) getHost()
						.getModel());
