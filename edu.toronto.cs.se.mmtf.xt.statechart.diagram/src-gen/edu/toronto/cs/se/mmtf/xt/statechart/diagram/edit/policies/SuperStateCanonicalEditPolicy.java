...
import edu.toronto.cs.se.mmtf.xt.statechart.diagram.part.StatechartDiagramUpdater;
import edu.toronto.cs.se.mmtf.xt.statechart.diagram.part.StatechartLinkDescriptor;
import edu.toronto.cs.se.mmtf.xt.statechart.diagram.part.StatechartNodeDescriptor;
import edu.toronto.cs.se.mmtf.xt.statechart.diagram.part.StatechartVisualIDRegistry;

/**
 * @generated
 */
public class SuperStateCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return StatechartPackage.eINSTANCE.getSuperState_States();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<StatechartNodeDescriptor> childDescriptors = StatechartDiagramUpdater
				.getSuperState_1000SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == SuperState2EditPart.VISUAL_ID
	...
	protected void refreshSemantic() {
		...
		List<StatechartNodeDescriptor> childDescriptors = StatechartDiagramUpdater
				.getSuperState_1000SemanticChildren((View) getHost().getModel());
	...
	private Collection<StatechartLinkDescriptor> collectAllLinks(View view,
		...
		case SuperStateEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(StatechartDiagramUpdater
						.getSuperState_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case SuperState2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(StatechartDiagramUpdater
						.getSuperState_2001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case SuperState3EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(StatechartDiagramUpdater
						.getSuperState_3002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
