 ...
 * </p>
 * <ul>
 *   <li>{@link edu.toronto.cs.se.nlsfung.gsn.impl.AdditionalElementImpl#getAttachment <em>Attachment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdditionalElementImpl extends BasicNodeImpl implements AdditionalElement {
	...
	protected EClass eStaticClass() {
		return GSNPackage.Literals.ADDITIONAL_ELEMENT;
	}
	...
	public void setAttachment(String newAttachment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GSNPackage.ADDITIONAL_ELEMENT__ATTACHMENT, oldAttachment, attachment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GSNPackage.ADDITIONAL_ELEMENT__ATTACHMENT:
