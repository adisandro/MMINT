...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmtf.mid.mapping.TypedElementReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypedElementReferenceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.TYPED_ELEMENT_REFERENCE__REFERENCED_OBJECT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.TYPED_ELEMENT_REFERENCE__OBJECT,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.TYPED_ELEMENT_REFERENCE__NAME,
				 false,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.TYPED_ELEMENT_REFERENCE__TYPE,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MappingPackage.Literals.TYPED_ELEMENT_REFERENCE__CONTAINED_OBJECT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MappingPackage.Literals.TYPED_ELEMENT_REFERENCE__CONTAINED_OBJECT,
				 MappingFactory.eINSTANCE.createHomomorphismLink()));
