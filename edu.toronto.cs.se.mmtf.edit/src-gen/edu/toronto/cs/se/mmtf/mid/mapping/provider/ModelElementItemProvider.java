		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.MODEL_ELEMENT__CATEGORY,
				 true,
				 false,
				 false,
	...
	protected void addLinksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelElement_links_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelElement_links_feature", "_UI_ModelElement_type"),
				 MappingPackage.Literals.MODEL_ELEMENT__LINKS,
				 true,
				 false,
				 true,
				 null,
