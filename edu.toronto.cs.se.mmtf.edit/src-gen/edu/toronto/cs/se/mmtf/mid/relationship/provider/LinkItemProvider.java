...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmtf.mid.relationship.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RelationshipPackage.Literals.LINK__ELEMENT_REFS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUnboundedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_unbounded_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_unbounded_feature", "_UI_Link_type"),
				 RelationshipPackage.Literals.LINK__UNBOUNDED,
				 true,
				 false,
				 false,
