...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.mmtf.mid.relationship.ModelElementReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelElementReference_links_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelElementReference_links_feature", "_UI_ModelElementReference_type"),
				 RelationshipPackage.Literals.MODEL_ELEMENT_REFERENCE__LINKS,
				 true,
				 false,
				 true,
				 null,
