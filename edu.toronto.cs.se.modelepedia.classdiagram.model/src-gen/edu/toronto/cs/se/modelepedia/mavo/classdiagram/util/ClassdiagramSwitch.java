...
public class ClassdiagramSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ClassdiagramPackage.CLASS: {
				edu.toronto.cs.se.modelepedia.mavo.classdiagram.Class class_ = (edu.toronto.cs.se.modelepedia.mavo.classdiagram.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(edu.toronto.cs.se.modelepedia.mavo.classdiagram.Class object) {
		return null;
	}
