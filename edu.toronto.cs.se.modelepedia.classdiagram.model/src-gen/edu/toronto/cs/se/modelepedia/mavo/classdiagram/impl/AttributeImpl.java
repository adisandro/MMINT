 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.mavo.classdiagram.impl.AttributeImpl#isMay <em>May</em>}</li>
 *   <li>{@link edu.toronto.cs.se.modelepedia.mavo.classdiagram.impl.AttributeImpl#isSet <em>Set</em>}</li>
 *   <li>{@link edu.toronto.cs.se.modelepedia.mavo.classdiagram.impl.AttributeImpl#isVar <em>Var</em>}</li>
 *   <li>{@link edu.toronto.cs.se.modelepedia.mavo.classdiagram.impl.AttributeImpl#getVisibility <em>Visibility</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeImpl extends NamedElementImpl implements Attribute {
	...
	public void setMay(boolean newMay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassdiagramPackage.ATTRIBUTE__MAY, oldMay, may));
	}
	...
	public void setSet(boolean newSet) {
		...
		set = newSet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassdiagramPackage.ATTRIBUTE__SET, oldSet, set));
	}
	...
	public void setVar(boolean newVar) {
		...
		var = newVar;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassdiagramPackage.ATTRIBUTE__VAR, oldVar, var));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassdiagramPackage.ATTRIBUTE__MAY:
				return isMay();
			case ClassdiagramPackage.ATTRIBUTE__SET:
				return isSet();
			case ClassdiagramPackage.ATTRIBUTE__VAR:
				return isVar();
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MAVOElement.class) {
			switch (derivedFeatureID) {
				case ClassdiagramPackage.ATTRIBUTE__MAY: return MavoPackage.MAVO_ELEMENT__MAY;
				case ClassdiagramPackage.ATTRIBUTE__SET: return MavoPackage.MAVO_ELEMENT__SET;
				case ClassdiagramPackage.ATTRIBUTE__VAR: return MavoPackage.MAVO_ELEMENT__VAR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MAVOElement.class) {
			switch (baseFeatureID) {
				case MavoPackage.MAVO_ELEMENT__MAY: return ClassdiagramPackage.ATTRIBUTE__MAY;
				case MavoPackage.MAVO_ELEMENT__SET: return ClassdiagramPackage.ATTRIBUTE__SET;
				case MavoPackage.MAVO_ELEMENT__VAR: return ClassdiagramPackage.ATTRIBUTE__VAR;
				default: return -1;
			}
		}
