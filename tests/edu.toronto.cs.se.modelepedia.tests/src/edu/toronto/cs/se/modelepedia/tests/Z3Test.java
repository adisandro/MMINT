...
public class Z3Test extends MMINTTest {
	...
	public void ecoreAllSAT() throws Exception {
		...
		Map<String, MID> outputMIDsByName = MIDOperatorUtils.createSimpleOutputMIDsByName(ecore2smt, instanceMID);
		ecore2smt.start(inputs, null, new BasicEList<>(), outputMIDsByName, instanceMID);
