 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.ExtendibleElementEndpoint#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.ExtendibleElementEndpoint#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.ExtendibleElementEndpoint#getTarget <em>Target</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.ExtendibleElementEndpoint#getTargetUri <em>Target Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @see edu.toronto.cs.se.mmtf.mid.MidPackage#getExtendibleElementEndpoint()
 * @model abstract="true"
...
public interface ExtendibleElementEndpoint extends ExtendibleElement {
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.MidPackage#getExtendibleElementEndpoint_LowerBound()
	 * @model required="true"
	 * @generated
	 */
	int getLowerBound();
	...
	/**
	 * Sets the value of the '{@link edu.toronto.cs.se.mmtf.mid.ExtendibleElementEndpoint#getLowerBound <em>Lower Bound</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.MidPackage#getExtendibleElementEndpoint_UpperBound()
	 * @model required="true"
	 * @generated
	 */
	int getUpperBound();
	...
	/**
	 * Sets the value of the '{@link edu.toronto.cs.se.mmtf.mid.ExtendibleElementEndpoint#getUpperBound <em>Upper Bound</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.MidPackage#getExtendibleElementEndpoint_Target()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.toronto.cs.se.mmtf.mid.ExtendibleElementEndpoint#getTarget <em>Target</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.MidPackage#getExtendibleElementEndpoint_TargetUri()
