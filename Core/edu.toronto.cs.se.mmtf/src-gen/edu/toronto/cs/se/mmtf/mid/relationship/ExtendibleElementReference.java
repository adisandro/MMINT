 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.ExtendibleElementReference#getReferencedObject <em>Referenced Object</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.ExtendibleElementReference#getContainedObject <em>Contained Object</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.ExtendibleElementReference#getObject <em>Object</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.ExtendibleElementReference#getSupertypeRef <em>Supertype Ref</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.ExtendibleElementReference#isModifiable <em>Modifiable</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.ExtendibleElementReference#getUri <em>Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getExtendibleElementReference()
 * @model abstract="true"
...
public interface ExtendibleElementReference extends EObject {
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getExtendibleElementReference_ReferencedObject()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.toronto.cs.se.mmtf.mid.relationship.ExtendibleElementReference#getReferencedObject <em>Referenced Object</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getExtendibleElementReference_ContainedObject()
	...
	/**
	 * Sets the value of the '{@link edu.toronto.cs.se.mmtf.mid.relationship.ExtendibleElementReference#getContainedObject <em>Contained Object</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getExtendibleElementReference_Object()
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getExtendibleElementReference_SupertypeRef()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.toronto.cs.se.mmtf.mid.relationship.ExtendibleElementReference#getSupertypeRef <em>Supertype Ref</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getExtendibleElementReference_Modifiable()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.toronto.cs.se.mmtf.mid.relationship.ExtendibleElementReference#isModifiable <em>Modifiable</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getExtendibleElementReference_Uri()
	 * @model required="true" transient="true" changeable="false" volatile="true" derived="true"
