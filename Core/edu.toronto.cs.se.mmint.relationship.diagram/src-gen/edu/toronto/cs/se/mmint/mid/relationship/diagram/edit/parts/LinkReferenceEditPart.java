...
import edu.toronto.cs.se.mmint.mid.relationship.diagram.edit.policies.LinkReferenceItemSemanticEditPolicy;
import edu.toronto.cs.se.mmint.mid.relationship.diagram.edit.policies.LinkReferenceSemanticEditPolicy;
...
public class LinkReferenceEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof edu.toronto.cs.se.mmint.mid.relationship.diagram.edit.parts.LinkReferenceEditPart) {
			types.add(MidElementTypes.ExtendibleElementReferenceSupertypeRef_4010);
		}
