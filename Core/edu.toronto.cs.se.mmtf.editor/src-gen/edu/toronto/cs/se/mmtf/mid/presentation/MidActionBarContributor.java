...
public class MidActionBarContributor
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("mid-settings"));
		toolBarManager.add(new Separator("mid-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(MidEditorPlugin.INSTANCE.getString("_UI_MidEditor_menu"), "edu.toronto.cs.se.mmtf.midMenuID");
