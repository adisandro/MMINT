 ...
 */
package edu.toronto.cs.se.mmint.mavo.util;

import edu.toronto.cs.se.mmint.mavo.*;
 ...
 * <!-- end-user-doc -->
 * @see edu.toronto.cs.se.mmint.mavo.MavoPackage
 * @generated
 */
public class MavoAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.toronto.cs.se.mmint.mavo.MAVOReference <em>MAVO Reference</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
