 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.mmint.mavo.MAVOModel#isInc <em>Inc</em>}</li>
 * </ul>
 * </p>
 *
 * @see edu.toronto.cs.se.mmint.mavo.MavoPackage#getMAVOModel()
 * @model abstract="true"
 * @generated
 */
public interface MAVOModel extends EObject {
	 ...
	 * @see #setInc(boolean)
	 * @see edu.toronto.cs.se.mmint.mavo.MavoPackage#getMAVOModel_Inc()
	 * @model
	 * @generated
	 */
	boolean isInc();
	...
	/**
	 * Sets the value of the '{@link edu.toronto.cs.se.mmint.mavo.MAVOModel#isInc <em>Inc</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
