 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.mmint.mid.operator.impl.EStringToParameterMapImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmint.mid.operator.impl.EStringToParameterMapImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EStringToParameterMapImpl extends EObjectImpl implements BasicEMap.Entry<String,Parameter> {
	...
	protected EClass eStaticClass() {
		return OperatorPackage.Literals.ESTRING_TO_PARAMETER_MAP;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperatorPackage.ESTRING_TO_PARAMETER_MAP__KEY, oldKey, key));
	}
