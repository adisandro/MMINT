...
public class MAVODecisionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MAVODecision_logic_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MAVODecision_logic_feature", "_UI_MAVODecision_type"),
				 MAVOPackage.Literals.MAVO_DECISION__LOGIC,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MAVOPackage.Literals.MAVO_DECISION__ALTERNATIVES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MAVODecision.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MAVOPackage.Literals.MAVO_DECISION__ALTERNATIVES,
