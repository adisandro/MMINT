 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.classdiagram_mavo.impl.OperationImpl#getVisibility <em>Visibility</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationImpl extends NamedElementImpl implements Operation {
	...
	public void setVisibility(Visibility newVisibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassDiagram_MAVOPackage.OPERATION__VISIBILITY, oldVisibility, visibility));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassDiagram_MAVOPackage.OPERATION__VISIBILITY:
