 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.classdiagram_mavo.impl.AttributeImpl#getVisibility <em>Visibility</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeImpl extends NamedElementImpl implements Attribute {
	...
	public void setVisibility(Visibility newVisibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassDiagram_MAVOPackage.ATTRIBUTE__VISIBILITY, oldVisibility, visibility));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassDiagram_MAVOPackage.ATTRIBUTE__VISIBILITY:
