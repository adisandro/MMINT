 ...
 */
package edu.toronto.cs.se.mmtf.xt.statechart.util;

import edu.toronto.cs.se.mmtf.xt.statechart.*;
 ...
 * <!-- end-user-doc -->
 * @see edu.toronto.cs.se.mmtf.xt.statechart.StatechartPackage
 * @generated
 */
public class StatechartSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StatechartPackage.SUPER_STATE: {
