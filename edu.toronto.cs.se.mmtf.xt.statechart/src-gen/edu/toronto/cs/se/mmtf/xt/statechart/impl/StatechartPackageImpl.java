...
public class StatechartPackageImpl extends EPackageImpl implements StatechartPackage {
	 ...
	 * @see edu.toronto.cs.se.mmtf.xt.statechart.StatechartPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getSuperState_States() {
	 ...
	 * @generated
	 */
	public EReference getSuperState_Transitions() {
		return (EReference)superStateEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTransition_Guards() {
	...
	public void createPackageContents() {
		...
		createEReference(superStateEClass, SUPER_STATE__STATES);
		createEReference(superStateEClass, SUPER_STATE__TRANSITIONS);

		transitionEClass = createEClass(TRANSITION);
		createEReference(transitionEClass, TRANSITION__START);
		createEReference(transitionEClass, TRANSITION__END);
		createEAttribute(transitionEClass, TRANSITION__NAME);
		createEAttribute(transitionEClass, TRANSITION__GUARDS);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getSuperState_States(), this.getState(), null, "states", null, 0, -1, SuperState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSuperState_Transitions(), this.getTransition(), null, "transitions", null, 0, -1, SuperState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTransition_Guards(), ecorePackage.getEString(), "guards", null, 0, -1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
