...
public class StatechartFactoryImpl extends EFactoryImpl implements StatechartFactory {
	...
	public static StatechartFactory init() {
		try {
			StatechartFactory theStatechartFactory = (StatechartFactory)EPackage.Registry.INSTANCE.getEFactory("http:///edu/toronto/cs/se/mmtf/xt/statechart/model/statechart.ecore"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case StatechartPackage.SUPER_STATE: return createSuperState();
