...
import edu.toronto.cs.se.mmtf.mid.diagram.menu.OpenTypeMidHandler;
...
public class MidDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	public static final String ID = "edu.toronto.cs.se.mmtf.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public void startGen(BundleContext context) throws Exception {
		super.start(context);
		instance = this;
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, MidDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, MidDiagramEditorPlugin.ID, IStatus.OK,
						message, throwable));
