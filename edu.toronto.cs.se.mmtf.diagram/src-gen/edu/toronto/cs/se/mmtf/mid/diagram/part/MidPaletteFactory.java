...
public class MidPaletteFactory {
	...
	private PaletteContainer createNew1Group() {
		...
		paletteContainer.add(createNewNaryRelLink4CreationTool());
	...
	private ToolEntry createNewModel1CreationTool() {
		...
		entry.setSmallIcon(MidElementTypes
				.getImageDescriptor(MidElementTypes.Model_2001));
	...
	private ToolEntry createNewBinaryRel2CreationTool() {
		...
		entry.setSmallIcon(MidElementTypes
				.getImageDescriptor(MidElementTypes.BinaryModelRel_4003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createNewNaryRel3CreationTool() {
		...
		entry.setSmallIcon(MidElementTypes
				.getImageDescriptor(MidElementTypes.ModelRel_2003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	 ...
	 * @generated
	 */
	private ToolEntry createNewNaryRelLink4CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				Messages.NewNaryRelLink4CreationTool_title,
				Messages.NewNaryRelLink4CreationTool_desc,
				Collections.singletonList(MidElementTypes.ModelRelModels_4002));
		entry.setId("createNewNaryRelLink4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(MidElementTypes
	...
	private ToolEntry createImportModel1CreationTool() {
		...
		entry.setSmallIcon(MidElementTypes
				.getImageDescriptor(MidElementTypes.Model_2002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createImportNaryRel2CreationTool() {
		...
		entry.setSmallIcon(MidElementTypes
				.getImageDescriptor(MidElementTypes.ModelRel_2004));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
