 ...
 * @generated
 */
public class ModelNameTypeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelNameTypeEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MidParserProvider
					.getParser(
							...
							getParserElement(),
							MidVisualIDRegistry
									.getType(edu.toronto.cs.se.mmtf.mid.diagram.edit.parts.ModelNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
