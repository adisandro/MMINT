 ...
 * @generated
 */
public class BinaryModelRelTargetModelEndpointLabelExpressionLabelParser
		implements IParser {
	/**
	 * @generated
	 */
	public BinaryModelRelTargetModelEndpointLabelExpressionLabelParser() {
	}
	...
	private IStatus updateValues(EObject target, String newString) {
		((ModelRel) target).getModelEndpoints().get(1).setName(newString);
