 ...
 * @generated
 */
public class ModelRelNameTypeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelRelNameTypeEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MidParserProvider
					.getParser(
							...
							getParserElement(),
							MidVisualIDRegistry
									.getType(edu.toronto.cs.se.mmtf.mid.diagram.edit.parts.ModelRelNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
