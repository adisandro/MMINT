 ...
 * @generated
 */
public class ModelRelNameType2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelRelNameType2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MidParserProvider
					.getParser(
							...
							getParserElement(),
							MidVisualIDRegistry
									.getType(edu.toronto.cs.se.mmtf.mid.diagram.edit.parts.ModelRelNameType2EditPart.VISUAL_ID));
		}
		return parser;
	}
