 ...
 * @generated
 */
public class ModelRelModelsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ModelRelModelsReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof ModelRel) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Model && newEnd instanceof ModelRel)) {
			return false;
		}
		return MidBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistModelRelModels_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return MidBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistModelRelModels_4002(getOldSource(), getNewTarget());
	}
	...
	protected ModelRel getOldSource() {
		return (ModelRel) referenceOwner;
	}
