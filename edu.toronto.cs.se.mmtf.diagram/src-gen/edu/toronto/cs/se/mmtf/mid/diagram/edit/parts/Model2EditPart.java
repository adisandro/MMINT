...
import edu.toronto.cs.se.mmtf.mid.diagram.edit.policies.Model2ItemSemanticEditPolicy;
import edu.toronto.cs.se.mmtf.mid.diagram.edit.policies.ModelImportedSemanticEditPolicy;
import edu.toronto.cs.se.mmtf.mid.diagram.edit.policies.ModelOpenDiagramEditPolicy;
import edu.toronto.cs.se.mmtf.mid.diagram.edit.policies.ModelOpenEditorEditPolicy;
...
public class Model2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ModelImportedSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.OPEN_ROLE,
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ModelNameType2EditPart) {
			((ModelNameType2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MidVisualIDRegistry
				.getType(ModelNameType2EditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof edu.toronto.cs.se.mmtf.mid.diagram.edit.parts.Model2EditPart) {
			types.add(MidElementTypes.ExtendibleElementSupertype_4001);
		}
