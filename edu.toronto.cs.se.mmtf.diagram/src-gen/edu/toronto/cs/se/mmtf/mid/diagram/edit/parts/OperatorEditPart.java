...
import edu.toronto.cs.se.mmtf.mid.diagram.edit.policies.OperatorItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OperatorEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new OperatorFigure();
	}
	...
	public OperatorFigure getPrimaryShape() {
		return (OperatorFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OperatorNameEditPart) {
			((OperatorNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MidVisualIDRegistry
				.getType(OperatorNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	public class OperatorFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureOperatorLabelFigure;
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureOperatorLabelFigure() {
			return fFigureOperatorLabelFigure;
		}
