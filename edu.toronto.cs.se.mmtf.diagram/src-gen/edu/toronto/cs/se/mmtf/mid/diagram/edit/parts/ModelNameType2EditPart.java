 ...
 * @generated
 */
public class ModelNameType2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelNameType2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MidParserProvider
					.getParser(
							...
							getParserElement(),
							MidVisualIDRegistry
									.getType(edu.toronto.cs.se.mmtf.mid.diagram.edit.parts.ModelNameType2EditPart.VISUAL_ID));
		}
		return parser;
	}
