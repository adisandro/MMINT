...
public class ExtendibleElementSupertypeEditPart extends ConnectionNodeEditPart
	...
	protected Connection createConnectionFigure() {
		return new ModelSupertypeFigure();
	}

	/**
	 * @generated
	 */
	public ModelSupertypeFigure getPrimaryShape() {
		return (ModelSupertypeFigure) getFigure();
	}

	/**
	 * @generated
	 */
	public class ModelSupertypeFigure extends PolylineConnectionEx {

		/**
		 * @generated
		 */
		public ModelSupertypeFigure() {
			this.setLineWidth(2);
