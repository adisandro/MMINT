...
public class MidViewProvider extends AbstractProvider implements IViewProvider {
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case ModelEditPart.VISUAL_ID:
			return createModel_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case Model2EditPart.VISUAL_ID:
			return createModel_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case ModelRelEditPart.VISUAL_ID:
			return createModelRel_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case ModelRel2EditPart.VISUAL_ID:
			return createModelRel_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case OperatorEditPart.VISUAL_ID:
			return createOperator_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case ModelRelModelsEditPart.VISUAL_ID:
			return createModelRelModels_4002(containerView, index, persisted,
					preferencesHint);
	 ...
	 * @generated
	 */
	public Node createModelRel_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		Node label5003 = createLabel(node,
				MidVisualIDRegistry.getType(ModelRelNameTypeEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createModelRel_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createOperator_2005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Edge createModelRelModels_4002(View containerView, int index,
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(MidVisualIDRegistry
				.getType(ModelRelModelsEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
