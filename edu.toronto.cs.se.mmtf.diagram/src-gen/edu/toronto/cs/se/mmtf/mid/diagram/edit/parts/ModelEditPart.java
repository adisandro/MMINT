...
import edu.toronto.cs.se.mmtf.mid.diagram.edit.policies.ModelCreatedSemanticEditPolicy;
import edu.toronto.cs.se.mmtf.mid.diagram.edit.policies.ModelItemSemanticEditPolicy;
...
public class ModelEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ModelNameTypeEditPart) {
			((ModelNameTypeEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MidVisualIDRegistry
				.getType(ModelNameTypeEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof edu.toronto.cs.se.mmtf.mid.diagram.edit.parts.ModelEditPart) {
			types.add(MidElementTypes.ExtendibleElementSupertype_4001);
		}
