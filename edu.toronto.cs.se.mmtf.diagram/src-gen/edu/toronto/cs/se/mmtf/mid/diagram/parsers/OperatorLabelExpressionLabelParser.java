 ...
 * @generated
 */
public class OperatorLabelExpressionLabelParser implements IParser {
	/**
	 * @generated
	 */
	...
	public String getPrintString(IAdaptable element, int flags) {
		...
		Object result = MidOCLFactory.getExpression(4,
				OperatorPackage.eINSTANCE.getOperator(), null).evaluate(target);
