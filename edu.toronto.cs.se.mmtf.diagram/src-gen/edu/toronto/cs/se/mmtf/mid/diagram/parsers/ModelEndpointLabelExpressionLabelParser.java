 ...
 * @generated
 */
public class ModelEndpointLabelExpressionLabelParser implements IParser {
	/**
	 * @generated
	 */
	public ModelEndpointLabelExpressionLabelParser() {
	}
	...
	private IStatus updateValues(EObject target, String newString) {
		((ExtendibleElementEndpoint) target).setName(newString);
	...
	private String evaluatePrintExpression(EObject self) {
		return MultiModelRegistry
				.getEndpointLabel((ExtendibleElementEndpoint) self);
	}
