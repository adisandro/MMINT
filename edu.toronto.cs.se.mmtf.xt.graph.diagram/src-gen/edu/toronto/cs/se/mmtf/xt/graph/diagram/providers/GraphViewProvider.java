 ...
 * @generated
 */
public class GraphViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = GraphVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = GraphVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!GraphElementTypes.isKnownElementType(elementType)
				...
				case NodeEditPart.VISUAL_ID:
					if (domainElement == null
							|| visualID != GraphVisualIDRegistry
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = GraphVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != GraphVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = GraphVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = GraphVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case NodeEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (GraphVisualIDRegistry.getVisualID(elementTypeHint)) {
	...
	public Node createNode_2001(EObject domainElement, View containerView,
		...
		node.setType(GraphVisualIDRegistry.getType(NodeEditPart.VISUAL_ID));
	...
	public Edge createEdge_4001(EObject domainElement, View containerView,
		...
		edge.setType(GraphVisualIDRegistry.getType(EdgeEditPart.VISUAL_ID));
