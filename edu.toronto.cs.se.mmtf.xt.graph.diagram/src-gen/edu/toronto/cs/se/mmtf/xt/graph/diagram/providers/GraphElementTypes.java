...
public class GraphElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType Graph_1000 = getElementType("edu.toronto.cs.se.mmtf.xt.graph.diagram.Graph_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Node_2001 = getElementType("edu.toronto.cs.se.mmtf.xt.graph.diagram.Node_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Edge_4001 = getElementType("edu.toronto.cs.se.mmtf.xt.graph.diagram.Edge_4001"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Graph_1000, GraphPackage.eINSTANCE.getGraph());

			elements.put(Node_2001, GraphPackage.eINSTANCE.getNode());

			elements.put(Edge_4001, GraphPackage.eINSTANCE.getEdge());
		}
