...
import edu.toronto.cs.se.mmtf.xt.graph.diagram.edit.policies.NodeItemSemanticEditPolicy;
...
public class NodeEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GraphVisualIDRegistry
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(GraphElementTypes.Edge_4001);
		return types;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof edu.toronto.cs.se.mmtf.xt.graph.diagram.edit.parts.NodeEditPart) {
			types.add(GraphElementTypes.Edge_4001);
		}
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == GraphElementTypes.Edge_4001) {
			types.add(GraphElementTypes.Node_2001);
		}
		return types;
	}
