...
public class KleisliTest {
	...
	public void test() throws Exception {
		...
		kRootModelTypeEndpoint.createSubtypeAndReference(SRC_MODELTYPEENDPOINT_NAME, srcModelType, kModelRelType);
		...
		kRootModelTypeEndpoint.createSubtypeAndReference(TGT_MODELTYPEENDPOINT_NAME, tgtModelType, kModelRelType);
