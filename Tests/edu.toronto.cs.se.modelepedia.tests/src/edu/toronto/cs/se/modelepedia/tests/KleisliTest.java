...
public class KleisliTest {
	...
	public void test() throws Exception {
		...
		kRootModelTypeEndpoint.createSubtypeAndReference(null, SRC_MODELTYPEENDPOINT_NAME, srcModelType, kModelRelType);
		...
		kRootModelTypeEndpoint.createSubtypeAndReference(null, TGT_MODELTYPEENDPOINT_NAME, tgtModelType, kModelRelType);
