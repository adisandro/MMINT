 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.classdiagram.impl.AttributeImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.toronto.cs.se.modelepedia.classdiagram.impl.AttributeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeImpl extends NamedElementImpl implements Attribute {
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassdiagramPackage.ATTRIBUTE__VALUE, oldValue, value));
	}
