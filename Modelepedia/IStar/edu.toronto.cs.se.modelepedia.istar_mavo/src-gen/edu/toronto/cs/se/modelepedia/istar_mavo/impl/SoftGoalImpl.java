 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.istar_mavo.impl.SoftGoalImpl#getContributionsAsContributee <em>Contributions As Contributee</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SoftGoalImpl extends GoalImpl implements SoftGoal {
	...
	protected EClass eStaticClass() {
		return IStar_MAVOPackage.Literals.SOFT_GOAL;
	}
	...
	public EList<Contribution> getContributionsAsContributee() {
		if (contributionsAsContributee == null) {
			contributionsAsContributee = new EObjectWithInverseResolvingEList<Contribution>(Contribution.class, this, IStar_MAVOPackage.SOFT_GOAL__CONTRIBUTIONS_AS_CONTRIBUTEE, IStar_MAVOPackage.CONTRIBUTION__CONTRIBUTEE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IStar_MAVOPackage.SOFT_GOAL__CONTRIBUTIONS_AS_CONTRIBUTEE:
