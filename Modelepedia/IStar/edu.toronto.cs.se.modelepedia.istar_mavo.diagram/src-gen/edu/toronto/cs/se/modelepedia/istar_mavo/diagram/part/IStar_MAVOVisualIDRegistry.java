...
public class IStar_MAVOVisualIDRegistry {
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (edu.toronto.cs.se.modelepedia.istar_mavo.IStar_MAVOPackage.eINSTANCE
				.getIStar().isSuperTypeOf(domainElement.eClass())
				&& isDiagram((edu.toronto.cs.se.modelepedia.istar_mavo.IStar) domainElement)) {
			return edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.IStarEditPart.VISUAL_ID;
		}
		return -1;
	}
	...
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (edu.toronto.cs.se.modelepedia.istar_mavo.IStar_MAVOPackage.eINSTANCE
				.getDependerLink().isSuperTypeOf(domainElement.eClass())) {
			return edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.DependerLinkEditPart.VISUAL_ID;
		}
		if (edu.toronto.cs.se.modelepedia.istar_mavo.IStar_MAVOPackage.eINSTANCE
				.getDependeeLink().isSuperTypeOf(domainElement.eClass())) {
	...
	private static boolean isDiagram(
			edu.toronto.cs.se.modelepedia.istar_mavo.IStar element) {
		return true;
	}
