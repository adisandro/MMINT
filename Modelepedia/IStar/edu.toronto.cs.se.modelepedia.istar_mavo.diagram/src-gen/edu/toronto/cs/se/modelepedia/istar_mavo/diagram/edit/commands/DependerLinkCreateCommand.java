...
public class DependerLinkCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null
				&& false == source instanceof edu.toronto.cs.se.modelepedia.istar_mavo.DependencyEndpoint) {
			return false;
		}
		if (target != null
		...
		return edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.policies.IStar_MAVOBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateDependerLink_4004(
	...
	protected void doConfigure(
			edu.toronto.cs.se.modelepedia.istar_mavo.DependerLink newElement,
