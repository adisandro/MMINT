 ...
 * @generated
 */
public class IStar_MAVONavigatorLinkHelper implements ILinkHelper {
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		if (false == aSelection.getFirstElement() instanceof edu.toronto.cs.se.modelepedia.istar_mavo.diagram.navigator.IStar_MAVOAbstractNavigatorItem) {
			return;
		}
		...
		if (abstractNavigatorItem instanceof edu.toronto.cs.se.modelepedia.istar_mavo.diagram.navigator.IStar_MAVONavigatorItem) {
			navigatorView = ((edu.toronto.cs.se.modelepedia.istar_mavo.diagram.navigator.IStar_MAVONavigatorItem) abstractNavigatorItem)
					.getView();
		} else if (abstractNavigatorItem instanceof edu.toronto.cs.se.modelepedia.istar_mavo.diagram.navigator.IStar_MAVONavigatorGroup) {
			...
			if (navigatorGroup.getParent() instanceof edu.toronto.cs.se.modelepedia.istar_mavo.diagram.navigator.IStar_MAVONavigatorItem) {
