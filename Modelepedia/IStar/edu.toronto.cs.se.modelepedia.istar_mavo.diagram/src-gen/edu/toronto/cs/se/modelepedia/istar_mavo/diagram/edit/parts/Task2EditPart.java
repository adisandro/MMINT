...
public class Task2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.policies.Task2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.TaskName2EditPart) {
			((edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.TaskName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureTaskLabelFigure());
			return true;
		}
		if (childEditPart instanceof edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.WrappingLabel7EditPart) {
			((edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.WrappingLabel7EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureMAVOTaskLabelFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class TaskFigure extends
			edu.toronto.cs.se.modelepedia.istar.diagram.figures.TaskFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureMAVOTaskLabelFigure;
		...
		private void createContents() {
			...
			fFigureMAVOTaskLabelFigure = new WrappingLabel();

			fFigureMAVOTaskLabelFigure.setText("");
			fFigureMAVOTaskLabelFigure.setMaximumSize(new Dimension(
					getMapMode().DPtoLP(10000), getMapMode().DPtoLP(50)));

			this.add(fFigureMAVOTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMAVOTaskLabelFigure() {
			return fFigureMAVOTaskLabelFigure;
		}
