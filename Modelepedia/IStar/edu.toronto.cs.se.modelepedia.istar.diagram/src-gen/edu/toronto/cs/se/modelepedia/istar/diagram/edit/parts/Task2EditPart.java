...
import edu.toronto.cs.se.modelepedia.istar.diagram.edit.policies.Task2ItemSemanticEditPolicy;
...
public class Task2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TaskName2EditPart) {
			((TaskName2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof edu.toronto.cs.se.modelepedia.istar.diagram.edit.parts.Task2EditPart) {
			types.add(IStarElementTypes.MeansEnd_4001);
		}
