...
public class ClassDiagram_MAVONavigatorLinkHelper implements ILinkHelper {
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		if (false == aSelection.getFirstElement() instanceof edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.navigator.ClassDiagram_MAVOAbstractNavigatorItem) {
			return;
		}
		...
		if (abstractNavigatorItem instanceof edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.navigator.ClassDiagram_MAVONavigatorItem) {
			navigatorView = ((edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.navigator.ClassDiagram_MAVONavigatorItem) abstractNavigatorItem)
					.getView();
		} else if (abstractNavigatorItem instanceof edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.navigator.ClassDiagram_MAVONavigatorGroup) {
			...
			if (navigatorGroup.getParent() instanceof edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.navigator.ClassDiagram_MAVONavigatorItem) {
