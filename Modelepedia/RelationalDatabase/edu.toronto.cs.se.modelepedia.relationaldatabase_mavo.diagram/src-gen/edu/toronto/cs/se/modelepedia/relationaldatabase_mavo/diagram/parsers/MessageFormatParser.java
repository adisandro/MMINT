...
public class MessageFormatParser
		extends
		edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.diagram.parsers.AbstractParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.diagram.part.Messages.MessageFormatParser_InvalidInputError,
