 ...
 * @generated
 */
public class ForeignKeyTableColumnCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ForeignKeyTableColumnCreateCommand(
	...
	public boolean canExecute() {
		...
		return RelationalDatabaseBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateForeignKeyTableColumn_4001(
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setTableColumn(getTarget());
		}
