 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.modelepedia.petrinet.impl.ArcImpl#getWeight <em>Weight</em>}</li>
 *   <li>{@link edu.toronto.cs.se.modelepedia.petrinet.impl.ArcImpl#getSrc <em>Src</em>}</li>
 *   <li>{@link edu.toronto.cs.se.modelepedia.petrinet.impl.ArcImpl#getTgt <em>Tgt</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArcImpl extends EObjectImpl implements Arc {
	...
	public Node getSrc() {
		if (src != null && src.eIsProxy()) {
			...
			if (src != oldSrc) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PetrinetPackage.ARC__SRC, oldSrc, src));
			}
		}
		return src;
	}
	...
	public void setSrc(Node newSrc) {
		...
		src = newSrc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.ARC__SRC, oldSrc, src));
	}
	...
	public Node getTgt() {
		if (tgt != null && tgt.eIsProxy()) {
			...
			if (tgt != oldTgt) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PetrinetPackage.ARC__TGT, oldTgt, tgt));
			}
		}
		return tgt;
	}
	...
	public void setTgt(Node newTgt) {
		...
		tgt = newTgt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.ARC__TGT, oldTgt, tgt));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetPackage.ARC__WEIGHT:
				return getWeight();
			case PetrinetPackage.ARC__SRC:
				if (resolve) return getSrc();
				return basicGetSrc();
			case PetrinetPackage.ARC__TGT:
