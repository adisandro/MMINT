...
public class GsnSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GsnPackage.ASIL: {
				...
				if (result == null) result = caseBasicNode(asil);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case GsnPackage.IS_SUPPORTED_BY: {
				IsSupportedBy isSupportedBy = (IsSupportedBy)theEObject;
				T result = caseIsSupportedBy(isSupportedBy);
				if (result == null) result = caseBasicLink(isSupportedBy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Is Supported By</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Is Supported By</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIsSupportedBy(IsSupportedBy object) {
		return null;
	}
