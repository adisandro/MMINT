 ...
 * </p>
 * <ul>
 *   <li>{@link edu.toronto.cs.nlsfung.gsn.impl.EvidenceImpl#getState <em>State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvidenceImpl extends BasicNodeImpl implements Evidence {
	...
	public void setState(ValidityState newState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GsnPackage.EVIDENCE__STATE, oldState, state));
	}
