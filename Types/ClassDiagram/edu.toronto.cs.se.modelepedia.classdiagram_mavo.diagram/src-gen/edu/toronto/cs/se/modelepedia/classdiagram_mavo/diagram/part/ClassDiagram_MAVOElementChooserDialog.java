 ...
 * @generated
 */
public class ClassDiagram_MAVOElementChooserDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						edu.toronto.cs.se.modelepedia.classdiagram_mavo.diagram.part.Messages.ClassDiagram_MAVOElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "classdiagram_mavo".equals(fileExtension); //$NON-NLS-1$
	}
