 ...
 * @generated
 */
public class ClassDiagramElementChooserDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.ClassDiagramElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "classdiagram".equals(fileExtension); //$NON-NLS-1$
	}
