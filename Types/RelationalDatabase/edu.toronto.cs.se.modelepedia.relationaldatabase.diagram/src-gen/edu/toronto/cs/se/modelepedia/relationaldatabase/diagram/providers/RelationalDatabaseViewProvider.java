 ...
 * @generated
 */
public class RelationalDatabaseViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return RelationalDatabaseEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(RelationalDatabaseEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (RelationalDatabaseVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ForeignKeyTableColumnEditPart.VISUAL_ID:
			return createForeignKeyTableColumn_4001(containerView, index,
					persisted, preferencesHint);
		case ForeignKeyForeignColumnEditPart.VISUAL_ID:
			return createForeignKeyForeignColumn_4002(containerView, index,
					persisted, preferencesHint);
		}
	...
	public Node createTable_2001(EObject domainElement, View containerView,
		...
		node.setType(RelationalDatabaseVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createForeignKeyTableColumn_4001(View containerView, int index,
		...
		edge.setType(RelationalDatabaseVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createForeignKeyForeignColumn_4002(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
