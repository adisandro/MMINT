...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.relationaldatabase.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_primaryKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_primaryKey_feature", "_UI_Table_type"),
				 RelationalDatabasePackage.Literals.TABLE__PRIMARY_KEY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RelationalDatabasePackage.Literals.TABLE__COLUMNS);
			childrenFeatures.add(RelationalDatabasePackage.Literals.TABLE__FOREIGN_KEYS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RelationalDatabasePackage.Literals.TABLE__COLUMNS,
				 RelationalDatabaseFactory.eINSTANCE.createColumn()));

		newChildDescriptors.add
			(createChildParameter
				(RelationalDatabasePackage.Literals.TABLE__FOREIGN_KEYS,
				 RelationalDatabaseFactory.eINSTANCE.createForeignKey()));
	}
