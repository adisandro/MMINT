 ...
 * @generated
 */
public class RelationalDatabase_MAVOElementChooserDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.diagram.part.Messages.RelationalDatabase_MAVOElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "relationaldatabase_mavo".equals(fileExtension); //$NON-NLS-1$
	}
