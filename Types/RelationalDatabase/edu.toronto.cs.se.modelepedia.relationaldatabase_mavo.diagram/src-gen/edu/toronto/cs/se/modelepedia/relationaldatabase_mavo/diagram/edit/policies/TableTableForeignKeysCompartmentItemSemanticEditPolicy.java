 ...
 * @generated
 */
public class TableTableForeignKeysCompartmentItemSemanticEditPolicy
		extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.diagram.providers.RelationalDatabase_MAVOElementTypes.ForeignKey_3002 == req
				.getElementType()) {
			return getGEFWrapper(new edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.diagram.edit.commands.ForeignKeyCreateCommand(
					req));
		}
