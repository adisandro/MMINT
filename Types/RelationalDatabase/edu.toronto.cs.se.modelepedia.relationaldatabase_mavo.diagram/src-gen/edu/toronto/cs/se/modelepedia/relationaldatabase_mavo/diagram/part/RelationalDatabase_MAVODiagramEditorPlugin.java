 ...
 * @generated
 */
public class RelationalDatabase_MAVODiagramEditorPlugin extends
		AbstractUIPlugin {
	...
	protected void fillItemProviderFactories(List<AdapterFactory> factories) {
		factories
				.add(new edu.toronto.cs.se.modelepedia.relationaldatabase_mavo.provider.RelationalDatabase_MAVOItemProviderAdapterFactory());
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR,
						RelationalDatabase_MAVODiagramEditorPlugin.ID,
