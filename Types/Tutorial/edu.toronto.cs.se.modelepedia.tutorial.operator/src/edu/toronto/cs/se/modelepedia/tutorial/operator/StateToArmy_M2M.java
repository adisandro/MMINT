...
public class StateToArmy_M2M {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 2) {
				...
				StateToArmy_M2M runner = new StateToArmy_M2M();
				runner.loadModels(args[0]);
				runner.doStateToArmy_M2M(new NullProgressMonitor());
	 ...
	 * @generated
	 */
	public StateToArmy_M2M() throws IOException {
	 ...
	 * @generated
	 */
	public Object doStateToArmy_M2M(IProgressMonitor monitor) throws ATLCoreException, IOException, ATLExecutionException {
	...
	protected static URL getFileURL(String fileName) throws IOException {
		final URL fileURL;
		if (isEclipseRunning()) {
			URL resourceURL = StateToArmy_M2M.class.getResource(fileName);
			if (resourceURL != null) {
			...
			fileURL = StateToArmy_M2M.class.getResource(fileName);
		}
		if (fileURL == null) {
