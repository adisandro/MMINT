...
import edu.toronto.cs.se.modelepedia.tutorial.army.diagram.part.ArmyDiagramEditorUtil;

/**
 * @generated
 */
public class ArmyMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = ArmyDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ArmyDiagramEditorUtil.selectElementsInDiagram(editor,
