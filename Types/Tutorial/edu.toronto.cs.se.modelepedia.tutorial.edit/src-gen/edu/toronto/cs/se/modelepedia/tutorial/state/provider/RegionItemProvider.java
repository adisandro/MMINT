...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.tutorial.state.Region} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Region_capital_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Region_capital_feature", "_UI_Region_type"),
				 StatePackage.Literals.REGION__CAPITAL,
				 true,
				 false,
				 true,
				 null,
