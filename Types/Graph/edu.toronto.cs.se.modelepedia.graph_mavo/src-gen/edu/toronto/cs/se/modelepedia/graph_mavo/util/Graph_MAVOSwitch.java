 ...
 * @generated
 */
public class Graph_MAVOSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Graph_MAVOPackage.NAMED_ELEMENT: {
