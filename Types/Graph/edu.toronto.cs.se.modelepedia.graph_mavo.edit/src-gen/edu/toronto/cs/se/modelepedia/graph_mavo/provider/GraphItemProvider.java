...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.graph_mavo.Graph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Graph_MAVOPackage.Literals.GRAPH__NODES);
			childrenFeatures.add(Graph_MAVOPackage.Literals.GRAPH__EDGES);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Graph_type") + " " + graph.isInc();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Graph_MAVOPackage.Literals.GRAPH__NODES,
				 Graph_MAVOFactory.eINSTANCE.createNode()));

		newChildDescriptors.add
			(createChildParameter
				(Graph_MAVOPackage.Literals.GRAPH__EDGES,
				 Graph_MAVOFactory.eINSTANCE.createEdge()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return Graph_MAVOEditPlugin.INSTANCE;
	}
