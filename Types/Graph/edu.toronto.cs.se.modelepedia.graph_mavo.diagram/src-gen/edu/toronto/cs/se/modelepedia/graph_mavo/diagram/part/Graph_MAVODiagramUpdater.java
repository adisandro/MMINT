...
public class Graph_MAVODiagramUpdater {
	...
	private static Collection<edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVOLinkDescriptor> getContainedTypeModelFacetLinks_Edge_4001(
		...
		for (Iterator<?> links = container.getEdges().iterator(); links
			...
			edu.toronto.cs.se.modelepedia.graph_mavo.Node dst = link
					.getTarget();
			edu.toronto.cs.se.modelepedia.graph_mavo.Node src = link
					.getSource();
			result.add(new edu.toronto.cs.se.modelepedia.graph_mavo.diagram.part.Graph_MAVOLinkDescriptor(
					src,
					dst,
					link,
