...
public class DependerLinkCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DependerLinkCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof DependencyEndpoint) {
			return false;
		}
		...
		return IStarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateDependerLink_4004(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		DependerLink newElement = IStarFactory.eINSTANCE.createDependerLink();
	 ...
	 * @generated
	 */
	protected DependencyEndpoint getSource() {
		return (DependencyEndpoint) source;
	}
