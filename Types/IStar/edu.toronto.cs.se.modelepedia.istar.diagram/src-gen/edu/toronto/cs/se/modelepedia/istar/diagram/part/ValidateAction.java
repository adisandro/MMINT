...
import edu.toronto.cs.se.modelepedia.istar.diagram.providers.IStarMarkerNavigationProvider;
import edu.toronto.cs.se.modelepedia.istar.diagram.providers.IStarValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			if (IStarDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		IStarValidationProvider.runWithConstraints(txDomain, new Runnable() {
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			IStarMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			...
			View view = IStarDiagramEditorUtil.findView(diagramEditPart,
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		IStarMarkerNavigationProvider.addMarker(target, elementId, location,
