 ...
 */
package edu.toronto.cs.se.modelepedia.istar_mavo.diagram.parsers;
			...
			if (Boolean.TYPE.equals(iClass)) {
				if (value instanceof Boolean) {
					...
					value = new InvalidValue(
							NLS.bind(
									edu.toronto.cs.se.modelepedia.istar_mavo.diagram.part.Messages.AbstractParser_UnexpectedValueType,
									iClass.getName()));
				}
				...
				if (value instanceof Byte) {
					...
					if (s.length() == 0) {
						...
						try {
							...
							value = new InvalidValue(
									NLS.bind(
											edu.toronto.cs.se.modelepedia.istar_mavo.diagram.part.Messages.AbstractParser_WrongStringConversion,
											iClass.getName()));
						}
					}
				} else {
				...
				if (value instanceof String) {
					...
					if (literal == null) {
						value = new InvalidValue(
								NLS.bind(
										edu.toronto.cs.se.modelepedia.istar_mavo.diagram.part.Messages.AbstractParser_UnknownLiteral,
										value));
					} else {
