 ...
 * @generated
 */
public class IStar_MAVOEditPartProvider extends AbstractEditPartProvider {
	...
	public IStar_MAVOEditPartProvider() {
		setFactory(new edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.IStar_MAVOEditPartFactory());
