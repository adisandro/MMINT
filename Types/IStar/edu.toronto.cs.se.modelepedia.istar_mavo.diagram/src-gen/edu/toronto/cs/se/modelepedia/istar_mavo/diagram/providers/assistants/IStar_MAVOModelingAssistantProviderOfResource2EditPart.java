...
public class IStar_MAVOModelingAssistantProviderOfResource2EditPart
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.Resource2EditPart) sourceEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.Resource2EditPart) targetEditPart);
	}
