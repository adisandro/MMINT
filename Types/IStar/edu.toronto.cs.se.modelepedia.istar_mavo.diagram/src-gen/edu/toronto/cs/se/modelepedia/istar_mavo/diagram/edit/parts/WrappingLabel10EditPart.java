...
public class WrappingLabel10EditPart extends LabelEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.policies.IStar_MAVOTextSelectionEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.IStarEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = edu.toronto.cs.se.modelepedia.istar_mavo.diagram.providers.IStar_MAVOParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					edu.toronto.cs.se.modelepedia.istar_mavo.diagram.edit.parts.IStar_MAVOEditPartFactory
