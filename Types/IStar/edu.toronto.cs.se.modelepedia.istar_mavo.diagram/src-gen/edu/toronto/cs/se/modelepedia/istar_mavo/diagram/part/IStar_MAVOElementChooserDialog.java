 ...
 * @generated
 */
public class IStar_MAVOElementChooserDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						edu.toronto.cs.se.modelepedia.istar_mavo.diagram.part.Messages.IStar_MAVOElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "istar_mavo".equals(fileExtension); //$NON-NLS-1$
	}
