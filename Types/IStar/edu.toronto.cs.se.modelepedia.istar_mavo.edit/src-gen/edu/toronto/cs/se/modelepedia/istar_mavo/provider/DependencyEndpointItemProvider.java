...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.istar_mavo.DependencyEndpoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IStar_MAVOPackage.Literals.DEPENDENCY_ENDPOINT__DEPENDENCIES_AS_DEPENDER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IStar_MAVOPackage.Literals.DEPENDENCY_ENDPOINT__DEPENDENCIES_AS_DEPENDEE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IStar_MAVOPackage.Literals.DEPENDENCY_ENDPOINT__NAME,
				 true,
				 false,
				 false,
