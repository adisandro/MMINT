 ...
 * @generated
 */
public class PowerWindowValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = PowerWindowDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof PowerWindowDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& WindowEditPart.MODEL_ID.equals(PowerWindowVisualIDRegistry
						.getModelID(view));
	}
