 ...
 * @generated
 */
public class MultiModelCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return MidPackage.eINSTANCE.getMultiModel_Elements();
	}
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == MappingReferenceEditPart.VISUAL_ID
				|| visualID == ModelReferenceEditPart.VISUAL_ID
				|| visualID == ModelReference2EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<MIDNodeDescriptor> childDescriptors = MIDDiagramUpdater
				.getMultiModel_1000SemanticChildren((View) getHost().getModel());
	...
	private Collection<MIDLinkDescriptor> collectAllLinks(View view,
		...
		case ModelReferenceEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(MIDDiagramUpdater
						.getModelReference_2002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case ModelReference2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(MIDDiagramUpdater
						.getModelReference_2003ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
