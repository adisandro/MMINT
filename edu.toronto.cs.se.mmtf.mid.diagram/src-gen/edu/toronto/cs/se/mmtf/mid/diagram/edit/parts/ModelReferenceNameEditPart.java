 ...
 * @generated
 */
public class ModelReferenceNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelReferenceNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MIDParserProvider
					.getParser(
							...
							getParserElement(),
							MIDVisualIDRegistry
									.getType(edu.toronto.cs.se.mmtf.mid.diagram.edit.parts.ModelReferenceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
