 ...
 * @generated
 */
public class MappingReferenceName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public MappingReferenceName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MIDParserProvider
					.getParser(
							MIDElementTypes.MappingReference_2005,
							getParserElement(),
							MIDVisualIDRegistry
									.getType(edu.toronto.cs.se.mmtf.mid.diagram.edit.parts.MappingReferenceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
