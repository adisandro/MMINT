 ...
 * @generated
 */
public class ModelReferenceName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelReferenceName2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MIDParserProvider
					.getParser(
							...
							getParserElement(),
							MIDVisualIDRegistry
									.getType(edu.toronto.cs.se.mmtf.mid.diagram.edit.parts.ModelReferenceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
