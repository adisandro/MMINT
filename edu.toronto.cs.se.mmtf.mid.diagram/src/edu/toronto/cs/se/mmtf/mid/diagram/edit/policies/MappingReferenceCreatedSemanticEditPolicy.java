...
/**
 * The semantic edit policy for created mapping references.
 * 
 * @author Alessio Di Sandro
 * 
 */
public class MappingReferenceCreatedSemanticEditPolicy extends MappingReferenceItemSemanticEditPolicy {
