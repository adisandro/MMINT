...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.nlsfung.gsn.Strategy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StrategyItemProvider extends GoalSupporterItemProvider {
	/**
	...
	protected void addSupportsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Strategy_supports_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Strategy_supports_feature", "_UI_Strategy_type"),
				 GSNPackage.Literals.STRATEGY__SUPPORTS,
				 true,
				 false,
				 true,
				 null,
