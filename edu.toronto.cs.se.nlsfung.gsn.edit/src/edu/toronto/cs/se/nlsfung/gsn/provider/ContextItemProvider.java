	...
	protected void addContextOfPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Context_contextOf_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Context_contextOf_feature", "_UI_Context_type"),
				 GSNPackage.Literals.CONTEXT__CONTEXT_OF,
				 true,
				 false,
				 true,
				 null,
