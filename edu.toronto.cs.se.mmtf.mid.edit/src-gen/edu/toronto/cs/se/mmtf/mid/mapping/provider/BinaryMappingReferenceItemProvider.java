 ...
 * @generated
 */
public class BinaryMappingReferenceItemProvider
	extends MappingReferenceItemProvider
	implements
	...
	public String getText(Object object) {
		String label = ((BinaryMappingReference)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BinaryMappingReference_type") :
			getString("_UI_BinaryMappingReference_type") + " " + label;
	}
