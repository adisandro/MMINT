...
(assert	(exists ((c IntentionalElementConcretization)) (edge Inflo2ModerationTasks c)))
...
(assert	(exists ((c DependeeConcretization)) (edge Moderation2ModerateInflo c)))
...
(assert (forall ((c TaskConcretization)) (=>
	(node UseAutomatedReputationSystem c)
	(exists ((dc1 DecompositionConcretization)) (and (= (tgtEndpoint dc1) ENDPOINT_TASK) (= ((as tgt (TaskConcretization)) dc1) c) (not (exists ((dc2 DecompositionConcretization)) (and (= (tgtEndpoint dc2) ENDPOINT_TASK) (= ((as tgt (TaskConcretization)) dc2) c) (not (= dc1 dc2)))))))
)))

(assert (or
	(and (exists ((c TaskConcretization)) (node CreateDiscussions c)) (exists ((c DecompositionConcretization)) (edge UseDiscussions2CreateDiscussions c)))
	(and (not (exists ((c TaskConcretization)) (node CreateDiscussions c))) (not (exists ((c DecompositionConcretization)) (edge UseDiscussions2CreateDiscussions c))))
))
