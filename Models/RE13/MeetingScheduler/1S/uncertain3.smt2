...
;WaysToOrganizeMeeting is Unique
(assert	(forall ((c1 TaskConcretization) (c2 TaskConcretization)) (=>
	(and (node WaysToOrganizeMeeting c1) (node WaysToOrganizeMeeting c2))
	(= c1 c2)
)))
...
(assert	(exists ((c IntentionalElementConcretization)) (edge MeetingInitiator2WaysToOrganizeMeeting c)))
;MeetingInitiator2WaysToOrganizeMeeting is Unique
(assert	(forall ((c1 IntentionalElementConcretization) (c2 IntentionalElementConcretization)) (=>
	(and (edge MeetingInitiator2WaysToOrganizeMeeting c1) (edge MeetingInitiator2WaysToOrganizeMeeting c2))
	(= c1 c2)
)))
...
(assert	(exists ((c IntentionalElementConcretization)) (edge DateDeterminer2DetermineMeetingDate c)))
...
;WaysToOrganizeMeeting2Quick is Unique
(assert	(forall ((c1 ContributionConcretization) (c2 ContributionConcretization)) (=>
	(and (edge WaysToOrganizeMeeting2Quick c1) (edge WaysToOrganizeMeeting2Quick c2))
	(= c1 c2)
)))
...
;WaysToOrganizeMeeting2LowEffortMI is Unique
(assert	(forall ((c1 ContributionConcretization) (c2 ContributionConcretization)) (=>
	(and (edge WaysToOrganizeMeeting2LowEffortMI c1) (edge WaysToOrganizeMeeting2LowEffortMI c2))
	(= c1 c2)
)))
...
(assert (and (forall ((c TaskConcretization)) (=> (node OrganizeMeeting c) (un c))) (forall ((c TaskConcretization)) (=> (node ParticipateInMeeting c) (fs c)))))

(assert (or
	(and (exists ((c TaskConcretization)) (node ProvideDetails c)) (exists ((c DecompositionConcretization)) (edge ParticipateInMeeting2ProvideDetails c)))
	(and (not (exists ((c TaskConcretization)) (node ProvideDetails c))) (not (exists ((c DecompositionConcretization)) (edge ParticipateInMeeting2ProvideDetails c))))
))
