...
(declare-const DateDeterminer Node)
(assert (= DateDeterminer 104))
(declare-const WaysToOrganizeMeeting Node)
(assert (= WaysToOrganizeMeeting 105))
(declare-const LetSchedulerScheduleMeeting Node)
(assert (= LetSchedulerScheduleMeeting 106))
(declare-const OrganizeMeeting Node)
(assert (= OrganizeMeeting 107))
...
(declare-const DateDeterminer2DetermineMeetingDate Edge)
(assert (= DateDeterminer2DetermineMeetingDate 139))
(declare-const WaysToOrganizeMeeting2MeetingBeScheduledMI Edge)
(assert (= WaysToOrganizeMeeting2MeetingBeScheduledMI 140))
(declare-const LetSchedulerScheduleMeeting2MeetingBeScheduledMI Edge)
(assert (= LetSchedulerScheduleMeeting2MeetingBeScheduledMI 141))
(declare-const DecideConvenientDates2ConvenientMeetingDate Edge)
(assert (= DecideConvenientDates2ConvenientMeetingDate 142))

(declare-const MeetingBeScheduledMI2OrganizeMeeting Edge)
(assert (= MeetingBeScheduledMI2OrganizeMeeting 143))
(declare-const Quick2OrganizeMeeting Edge)
(assert (= Quick2OrganizeMeeting 144))
(declare-const LowEffortMI2OrganizeMeeting Edge)
(assert (= LowEffortMI2OrganizeMeeting 145))
...
(declare-const WaysToOrganizeMeeting2Quick Edge)
(assert (= WaysToOrganizeMeeting2Quick 152))
(declare-const WaysToOrganizeMeeting2LowEffortMI Edge)
(assert (= WaysToOrganizeMeeting2LowEffortMI 153))
...
;MeetingInitiator2WaysToOrganizeMeeting tgtType constant
(assert (forall ((c Containment)) (=>
	(edge MeetingInitiator2WaysToOrganizeMeeting c)
	(= (tgtType c) TASK)
)))
...
(assert (forall ((c Containment)) (=>
	...
	(and
		(node MeetingInitiator (src c))
		(node WaysToOrganizeMeeting ((as tgt (Task)) c))
	)
)))
;MeetingInitiator2WaysToOrganizeMeeting Exists
(assert	(exists ((c Containment)) (edge MeetingInitiator2WaysToOrganizeMeeting c)))
;MeetingInitiator2WaysToOrganizeMeeting is Distinct
(assert	(forall ((c Containment)) (=>
	(edge MeetingInitiator2WaysToOrganizeMeeting c)
	(not (or
		(edge MeetingInitiator2LetSchedulerScheduleMeeting c)
...
;DateDeterminer2DetermineMeetingDate tgtType constant
(assert (forall ((c Containment)) (=>
	(edge DateDeterminer2DetermineMeetingDate c)
	(= (tgtType c) TASK)
)))
...
(assert	(exists ((c Containment)) (edge DateDeterminer2DetermineMeetingDate c)))
...
;DateDeterminer2DetermineMeetingDate is Distinct
(assert	(forall ((c Containment)) (=>
	(edge DateDeterminer2DetermineMeetingDate c)
	(not (or
		(edge MeetingInitiator2WaysToOrganizeMeeting c)
...
;WaysToOrganizeMeeting2Quick srcType constant
(assert (forall ((c Contribution)) (=>
	(edge WaysToOrganizeMeeting2Quick c)
	(= (srcType c) TASK)
)))
...
;WaysToOrganizeMeeting2LowEffortMI srcType constant
(assert (forall ((c Contribution)) (=>
	(edge WaysToOrganizeMeeting2LowEffortMI c)
	(= (srcType c) TASK)
)))
