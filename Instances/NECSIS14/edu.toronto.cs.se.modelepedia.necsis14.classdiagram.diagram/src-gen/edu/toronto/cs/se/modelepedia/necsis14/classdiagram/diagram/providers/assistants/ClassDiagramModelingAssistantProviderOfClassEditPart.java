 ...
 */
package edu.toronto.cs.se.modelepedia.necsis14.classdiagram.diagram.providers.assistants;
...
import edu.toronto.cs.se.modelepedia.necsis14.classdiagram.diagram.providers.ClassDiagramModelingAssistantProvider;

/**
 * @generated
 */
public class ClassDiagramModelingAssistantProviderOfClassEditPart extends
		ClassDiagramModelingAssistantProvider {
	...
	public List<IElementType> doGetRelTypesOnSource(ClassEditPart source) {
		...
		types.add(ClassDiagramElementTypes.ClassParent_4002);
		return types;
	}
	...
	public List<IElementType> doGetTypesForTarget(ClassEditPart source,
		...
		} else if (relationshipType == ClassDiagramElementTypes.ClassParent_4002) {
			types.add(ClassDiagramElementTypes.Class_2001);
		}
		return types;
	}
