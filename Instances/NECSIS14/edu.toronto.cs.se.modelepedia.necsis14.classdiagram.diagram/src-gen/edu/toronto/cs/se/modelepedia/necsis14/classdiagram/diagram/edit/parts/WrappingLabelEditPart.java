...
import edu.toronto.cs.se.modelepedia.necsis14.classdiagram.diagram.edit.policies.ClassDiagramTextSelectionEditPolicy;
...
public class WrappingLabelEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ClassDiagramVisualIDRegistry
						.getType(edu.toronto.cs.se.modelepedia.necsis14.classdiagram.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ClassDiagramTextSelectionEditPolicy());
