...
import edu.toronto.cs.se.modelepedia.necsis14.classdiagram.Class;
...
public class ClassDiagramDiagramUpdater {
	 ...
	 * @generated
	 */
	public static List<ClassDiagramNodeDescriptor> getClassClassAttributesCompartment_7001SemanticChildren(
			View view) {
	 ...
	 * @generated
	 */
	private static Collection<ClassDiagramLinkDescriptor> getIncomingFeatureModelFacetLinks_Class_Parent_4002(
			Class target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<ClassDiagramLinkDescriptor> result = new LinkedList<ClassDiagramLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == ClassDiagramPackage.eINSTANCE
				...
				result.add(new ClassDiagramLinkDescriptor(setting.getEObject(),
						target, ClassDiagramElementTypes.ClassParent_4002,
						ClassParentEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<ClassDiagramLinkDescriptor> getOutgoingFeatureModelFacetLinks_Class_Parent_4002(
			Class source) {
		LinkedList<ClassDiagramLinkDescriptor> result = new LinkedList<ClassDiagramLinkDescriptor>();
		Class destination = source.getParent();
		if (destination == null) {
			return result;
		}
