...
import edu.toronto.cs.se.modelepedia.necsis14.classdiagram.diagram.edit.policies.ClassItemSemanticEditPolicy;
import edu.toronto.cs.se.modelepedia.necsis14.classdiagram.diagram.edit.policies.OpenDiagramEditPolicy;
...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ClassClassAttributesCompartmentEditPart) {
			...
			pane.add(((ClassClassAttributesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ClassClassAttributesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getClassAttributesCompartmentFigure();
			pane.remove(((ClassClassAttributesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ClassClassAttributesCompartmentEditPart) {
