...
import edu.toronto.cs.se.modelepedia.necsis14.classdiagram.diagram.edit.policies.ClassDiagramBaseItemSemanticEditPolicy;
import edu.toronto.cs.se.modelepedia.necsis14.classdiagram.diagram.providers.ElementInitializers;
...
public class ClassDiagramDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	public static final String ID = "edu.toronto.cs.se.modelepedia.necsis14.classdiagram.diagram"; //$NON-NLS-1$
	...
	public void setLinkConstraints(
			ClassDiagramBaseItemSemanticEditPolicy.LinkConstraints lc) {
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, ClassDiagramDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, ClassDiagramDiagramEditorPlugin.ID,
