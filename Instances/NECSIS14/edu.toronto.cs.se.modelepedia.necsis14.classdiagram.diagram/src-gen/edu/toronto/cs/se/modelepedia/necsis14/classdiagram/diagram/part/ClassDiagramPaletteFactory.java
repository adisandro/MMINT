...
public class ClassDiagramPaletteFactory {
	...
	private ToolEntry createParent2CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				Messages.Parent2CreationTool_title,
				Messages.Parent2CreationTool_desc,
				Collections
						.singletonList(ClassDiagramElementTypes.ClassParent_4002));
		entry.setId("createParent2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ClassDiagramElementTypes
				.getImageDescriptor(ClassDiagramElementTypes.ClassParent_4002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
