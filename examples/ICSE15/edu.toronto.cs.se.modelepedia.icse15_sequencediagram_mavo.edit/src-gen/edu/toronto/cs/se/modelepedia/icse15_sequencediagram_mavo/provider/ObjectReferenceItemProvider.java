...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.ObjectReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectReferenceItemProvider extends MAVOReferenceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectReference_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectReference_target_feature", "_UI_ObjectReference_type"),
				 ICSE15_SequenceDiagram_MAVOPackage.Literals.OBJECT_REFERENCE__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((ObjectReference)object).getFormulaVariable();
