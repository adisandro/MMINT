...
public class OperationReferenceReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.Operation target = getLink()
				.getTarget();
		...
		return edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.edit.policies.ICSE15_SequenceDiagram_MAVOBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistOperationReference_4002(
	...
	protected boolean canReorientTarget() {
		if (!(oldEnd instanceof edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.Operation && newEnd instanceof edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.Operation)) {
			return false;
		}
