 ...
 * @generated
 */
public class SourceLifelineReferenceReorientCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.SourceLifelineReference) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.edit.policies.ICSE15_SequenceDiagram_MAVOBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistSourceLifelineReference_4003(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.edit.policies.ICSE15_SequenceDiagram_MAVOBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistSourceLifelineReference_4003(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.SourceLifelineReference getLink() {
		return (edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.SourceLifelineReference) getElementToEdit();
	}
