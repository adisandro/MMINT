 ...
 * @generated
 */
public class ICSE15_SequenceDiagram_MAVODiagramActionBarContributor extends DiagramActionBarContributor {

	/**
	* @generated
	*/
	protected Class getEditorClass() {
		return edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.part.ICSE15_SequenceDiagram_MAVODiagramEditor.class;
	}
	...
	*/
	public void init(IActionBars bars, IWorkbenchPage page) {
		...
		IAction validateAction = new edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.part.ValidateAction(
				page);
