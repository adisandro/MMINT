 ...
 * @generated
 */
public class ICSE15_SequenceDiagram_MAVOCreationWizard extends Wizard implements
		INewWizard {
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setWindowTitle(edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.part.Messages.ICSE15_SequenceDiagram_MAVOCreationWizardTitle);
		setDefaultPageImageDescriptor(edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.part.ICSE15_SequenceDiagram_MAVODiagramEditorPlugin
	...
	public void addPages() {
		...
		diagramModelFilePage
				.setTitle(edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.part.Messages.ICSE15_SequenceDiagram_MAVOCreationWizard_DiagramModelFilePageTitle);
		diagramModelFilePage
				.setDescription(edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.part.Messages.ICSE15_SequenceDiagram_MAVOCreationWizard_DiagramModelFilePageDescription);
			...
			public void setVisible(boolean visible) {
				if (visible) {
					...
					fileName = fileName.substring(0, fileName.length()
							- ".icse15_sequencediagramdiag_mavo".length()); //$NON-NLS-1$
					setFileName(edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.part.ICSE15_SequenceDiagram_MAVODiagramEditorUtil
							.getUniqueFileName(getContainerFullPath(),
									fileName, "icse15_sequencediagram_mavo")); //$NON-NLS-1$
				}
				super.setVisible(visible);
			}
		};
		domainModelFilePage
				.setTitle(edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.part.Messages.ICSE15_SequenceDiagram_MAVOCreationWizard_DomainModelFilePageTitle);
		domainModelFilePage
				.setDescription(edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.part.Messages.ICSE15_SequenceDiagram_MAVOCreationWizard_DomainModelFilePageDescription);
