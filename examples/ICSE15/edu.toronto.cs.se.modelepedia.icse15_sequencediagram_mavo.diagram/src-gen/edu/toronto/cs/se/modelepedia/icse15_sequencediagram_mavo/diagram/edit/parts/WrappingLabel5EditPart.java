...
public class WrappingLabel5EditPart extends LabelEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.edit.policies.ICSE15_SequenceDiagram_MAVOTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.providers.ICSE15_SequenceDiagram_MAVOParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.edit.parts.ICSE15_SequenceDiagram_MAVOEditPartFactory
