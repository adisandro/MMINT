...
public class ICSE15_SequenceDiagram_MAVONewDiagramFileWizard extends Wizard {
			...
			protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
				...
				if (diagramVID != edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.edit.parts.SequenceDiagramEditPart.VISUAL_ID) {
					return CommandResult.newErrorCommandResult(
							edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.part.Messages.ICSE15_SequenceDiagram_MAVONewDiagramFileWizard_IncorrectRootError);
				}
	...
	*/
	private static class DiagramRootElementSelectionPage
			extends edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.part.ModelElementSelectionPage {
		...
		*/
		protected boolean validatePage() {
			if (getModelElement() == null) {
				setErrorMessage(
						edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.diagram.part.Messages.ICSE15_SequenceDiagram_MAVONewDiagramFileWizard_RootSelectionPageNoSelectionMessage);
				return false;
			}
