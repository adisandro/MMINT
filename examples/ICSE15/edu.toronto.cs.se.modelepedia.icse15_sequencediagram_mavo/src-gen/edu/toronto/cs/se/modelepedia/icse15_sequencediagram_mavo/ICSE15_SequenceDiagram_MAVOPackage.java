...
public interface ICSE15_SequenceDiagram_MAVOPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SEQUENCE_DIAGRAM__INC = MAVOPackage.MAVO_ROOT__INC;
	 ...
	 * @ordered
	 */
	int SEQUENCE_DIAGRAM__DECISIONS = MAVOPackage.MAVO_ROOT__DECISIONS;
	 ...
	 * @ordered
	 */
	int SEQUENCE_DIAGRAM__LIFELINES = MAVOPackage.MAVO_ROOT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SEQUENCE_DIAGRAM__CLASSES = MAVOPackage.MAVO_ROOT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SEQUENCE_DIAGRAM__MESSAGES = MAVOPackage.MAVO_ROOT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int SEQUENCE_DIAGRAM_FEATURE_COUNT = MAVOPackage.MAVO_ROOT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int SEQUENCE_DIAGRAM_OPERATION_COUNT = MAVOPackage.MAVO_ROOT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int LIFELINE__FORMULA_VARIABLE = NAMED_ELEMENT__FORMULA_VARIABLE;
	 ...
	 * @ordered
	 */
	int LIFELINE__MAY = NAMED_ELEMENT__MAY;
	 ...
	 * @ordered
	 */
	int LIFELINE__SET = NAMED_ELEMENT__SET;
	 ...
	 * @ordered
	 */
	int LIFELINE__CLASS = NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int LIFELINE__MESSAGES_AS_SOURCE = NAMED_ELEMENT_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.Lifeline#getClass_ <em>Class</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference list '{@link edu.toronto.cs.se.modelepedia.icse15_sequencediagram_mavo.Class#getLifelines <em>Lifelines</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
