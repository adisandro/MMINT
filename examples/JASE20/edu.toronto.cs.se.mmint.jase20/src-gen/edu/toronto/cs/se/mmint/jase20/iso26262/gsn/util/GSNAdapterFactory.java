 ...
 */
package edu.toronto.cs.se.mmint.jase20.iso26262.gsn.util;
...
public class GSNAdapterFactory extends AdapterFactoryImpl {
  ...
  /**
   * Creates a new adapter for an object of class '{@link edu.toronto.cs.se.mmint.jase20.iso26262.gsn.GSNRoot <em>Root</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link edu.toronto.cs.se.mmint.jase20.iso26262.gsn.SafetyGoal <em>Safety Goal</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
