...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.necsis14_databaseschema.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_primaryKeys_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_primaryKeys_feature", "_UI_Table_type"),
				 NECSIS14_DatabaseSchemaPackage.Literals.TABLE__PRIMARY_KEYS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NECSIS14_DatabaseSchemaPackage.Literals.TABLE__COLUMNS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NECSIS14_DatabaseSchemaPackage.Literals.TABLE__COLUMNS,
				 NECSIS14_DatabaseSchemaFactory.eINSTANCE.createColumn()));
	}
