 ...
 * @generated
 */
public class DatabaseSchemaEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "NECSIS14_DatabaseSchema"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public DatabaseSchemaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.edit.policies.DatabaseSchemaItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.edit.policies.DatabaseSchemaCanonicalEditPolicy());
		installEditPolicy(
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.edit.commands.NECSIS14_DatabaseSchemaCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
