...
public class TableNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.edit.policies.NECSIS14_DatabaseSchemaTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.providers.NECSIS14_DatabaseSchemaParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.edit.parts.NECSIS14_DatabaseSchemaEditPartFactory
