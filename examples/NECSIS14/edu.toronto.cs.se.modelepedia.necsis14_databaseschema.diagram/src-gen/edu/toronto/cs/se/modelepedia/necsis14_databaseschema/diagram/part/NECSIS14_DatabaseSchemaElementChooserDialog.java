 ...
 * @generated
 */
public class NECSIS14_DatabaseSchemaElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public NECSIS14_DatabaseSchemaElementChooserDialog(Shell parentShell,
			View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.part.Messages.NECSIS14_DatabaseSchemaElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "necsis14_databaseschema".equals(fileExtension); //$NON-NLS-1$
	}
