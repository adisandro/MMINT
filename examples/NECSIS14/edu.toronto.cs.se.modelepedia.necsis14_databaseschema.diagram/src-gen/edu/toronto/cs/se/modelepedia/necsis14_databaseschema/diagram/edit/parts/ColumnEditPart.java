...
public class ColumnEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.edit.policies.ColumnItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.edit.parts.ColumnNameEditPart) {
			((edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.edit.parts.ColumnNameEditPart) childEditPart)
