...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	public static void runValidation(View view) {
		try {
			if (edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.part.NECSIS14_DatabaseSchemaDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		edu.toronto.cs.se.modelepedia.necsis14_databaseschema.diagram.providers.NECSIS14_DatabaseSchemaValidationProvider
