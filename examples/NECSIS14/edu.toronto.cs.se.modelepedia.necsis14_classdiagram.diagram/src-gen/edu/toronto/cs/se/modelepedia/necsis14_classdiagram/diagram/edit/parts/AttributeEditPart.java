...
public class AttributeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.edit.policies.AttributeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.edit.parts.AttributeNameEditPart) {
			((edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.edit.parts.AttributeNameEditPart) childEditPart)
