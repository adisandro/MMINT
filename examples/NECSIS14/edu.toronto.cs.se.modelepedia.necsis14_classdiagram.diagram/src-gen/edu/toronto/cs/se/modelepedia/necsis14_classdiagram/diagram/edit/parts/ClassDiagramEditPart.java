...
public class ClassDiagramEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "NECSIS14_ClassDiagram"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.edit.policies.ClassDiagramItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.edit.policies.ClassDiagramCanonicalEditPolicy());
		installEditPolicy(
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.edit.commands.NECSIS14_ClassDiagramCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
