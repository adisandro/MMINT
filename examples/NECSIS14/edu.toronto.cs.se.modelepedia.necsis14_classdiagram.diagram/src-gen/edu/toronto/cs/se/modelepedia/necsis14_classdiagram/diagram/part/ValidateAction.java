...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	public static void runValidation(View view) {
		try {
			if (edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.part.NECSIS14_ClassDiagramDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.providers.NECSIS14_ClassDiagramValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.providers.NECSIS14_ClassDiagramMarkerNavigationProvider
