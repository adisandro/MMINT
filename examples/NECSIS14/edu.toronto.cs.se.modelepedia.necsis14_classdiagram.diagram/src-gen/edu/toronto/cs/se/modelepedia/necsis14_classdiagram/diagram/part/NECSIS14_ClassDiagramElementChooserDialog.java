 ...
 * @generated
 */
public class NECSIS14_ClassDiagramElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public NECSIS14_ClassDiagramElementChooserDialog(Shell parentShell,
			View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.part.Messages.NECSIS14_ClassDiagramElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "necsis14_classdiagram".equals(fileExtension); //$NON-NLS-1$
	}
