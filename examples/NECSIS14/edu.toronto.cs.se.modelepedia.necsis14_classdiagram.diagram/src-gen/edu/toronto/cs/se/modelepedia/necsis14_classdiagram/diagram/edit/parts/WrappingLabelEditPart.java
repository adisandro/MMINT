...
public class WrappingLabelEditPart extends LabelEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.edit.policies.NECSIS14_ClassDiagramTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.providers.NECSIS14_ClassDiagramParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					edu.toronto.cs.se.modelepedia.necsis14_classdiagram.diagram.edit.parts.NECSIS14_ClassDiagramEditPartFactory
