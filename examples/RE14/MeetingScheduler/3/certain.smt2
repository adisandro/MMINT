...
(declare-const OtherWaysToOrganizeMeeting Node);Node
(assert (= OtherWaysToOrganizeMeeting 14))
(declare-const OtherWaysToOrganizeMeeting2MeetingBeScheduledMI Edge)
(assert (= OtherWaysToOrganizeMeeting2MeetingBeScheduledMI 15))
(declare-const OtherWaysToOrganizeMeeting2Quick Edge)
(assert (= OtherWaysToOrganizeMeeting2Quick 16))
(declare-const OtherWaysToOrganizeMeeting2LowEffortMI Edge)
(assert (= OtherWaysToOrganizeMeeting2LowEffortMI 17))
