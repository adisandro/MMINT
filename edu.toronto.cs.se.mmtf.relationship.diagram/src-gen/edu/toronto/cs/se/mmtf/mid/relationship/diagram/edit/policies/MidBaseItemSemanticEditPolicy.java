...
import edu.toronto.cs.se.mmtf.mid.relationship.diagram.edit.helpers.MidBaseEditHelper;
...
public class MidBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(MidBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(MidBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				requestContextElementType);
		ICommand command = requestContextElementType.getEditCommand(request);
		request.setParameter(MidBaseEditHelper.EDIT_POLICY_COMMAND, null);
		request.setParameter(MidBaseEditHelper.CONTEXT_ELEMENT_TYPE, null);
		if (command != null) {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public boolean canCreateExtendibleElementSupertype_4001(
		 ...
		 * @generated
		 */
		public boolean canCreateLinkElementRefs_4002(Link source,
				ModelElementReference target) {
			if (source != null) {
				if (source.getElementRefs().contains(target)) {
					return false;
				}
			}
			...
			return canExistLinkElementRefs_4002(source, target);
		}

		/**
		 * @generated
		 */
		public boolean canCreateBinaryLink_4003(ModelRel container,
				ModelElementReference source, ModelElementReference target) {
			return canExistBinaryLink_4003(container, null, source, target);
		}

		/**
		 * @generated
		 */
		public boolean canExistExtendibleElementSupertype_4001(
				ExtendibleElement source, ExtendibleElement target) {
			return true;
		}
		 ...
		 * @generated
		 */
		public boolean canExistLinkElementRefs_4002(Link source,
				ModelElementReference target) {
			try {
				if (source == null) {
					return true;
					...
					Object sourceVal = MidOCLFactory.getExpression(1,
							RelationshipPackage.eINSTANCE.getLink(), env)
							.evaluate(
									source,
		 ...
		 * @generated
		 */
		public boolean canExistBinaryLink_4003(ModelRel container,
				BinaryLink linkInstance, ModelElementReference source,
				ModelElementReference target) {
			return true;
		}
	}
