...
import edu.toronto.cs.se.mmtf.mid.relationship.diagram.edit.commands.BinaryLinkCreateCommand;
import edu.toronto.cs.se.mmtf.mid.relationship.diagram.edit.commands.BinaryLinkReorientCommand;
...
public class ModelElementReferenceItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (MidElementTypes.BinaryLink_4003 == req.getElementType()) {
			return getGEFWrapper(new BinaryLinkCreateCommand(req,
	...
	protected Command getReorientRelationshipCommand(
		...
		case BinaryLinkEditPart.VISUAL_ID:
			return getGEFWrapper(new BinaryLinkReorientCommand(req));
		}
