 ...
 * @generated
 */
public class LinkNameTypeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LinkNameTypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MidParserProvider
					.getParser(
							MidElementTypes.Link_2002,
							getParserElement(),
							MidVisualIDRegistry
									.getType(edu.toronto.cs.se.mmtf.mid.relationship.diagram.edit.parts.LinkNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
