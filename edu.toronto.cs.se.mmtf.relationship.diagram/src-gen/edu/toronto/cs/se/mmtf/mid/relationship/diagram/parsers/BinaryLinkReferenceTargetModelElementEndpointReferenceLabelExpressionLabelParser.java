 ...
 */
package edu.toronto.cs.se.mmtf.mid.relationship.diagram.parsers;
 ...
 * @generated
 */
public class BinaryLinkReferenceTargetModelElementEndpointReferenceLabelExpressionLabelParser
		implements IParser {
	/**
	 * @generated
	 */
	public BinaryLinkReferenceTargetModelElementEndpointReferenceLabelExpressionLabelParser() {
	}
	...
	private IStatus updateValues(EObject target, String newString) {
		((LinkReference) target).getModelElemEndpointRefs().get(1).getObject()
				.setName(newString);
	...
	private String evaluatePrintExpression(EObject self) {
		return MultiModelRegistry
				.getEndpointReferenceLabel(((LinkReference) self)
	...
	private String evaluateEditExpression(EObject self) {
		return MultiModelRegistry
				.editElementReferenceLabel(((LinkReference) self)
						.getModelElemEndpointRefs().get(1));
	}
