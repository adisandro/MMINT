 ...
 * @generated
 */
public class ModelReferenceNameTypeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ModelReferenceNameTypeEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MidParserProvider
					.getParser(
							...
							getParserElement(),
							MidVisualIDRegistry
									.getType(edu.toronto.cs.se.mmtf.mid.relationship.diagram.edit.parts.ModelReferenceNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
