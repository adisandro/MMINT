...
import edu.toronto.cs.se.mmtf.mid.relationship.diagram.edit.policies.LinkItemSemanticEditPolicy;
import edu.toronto.cs.se.mmtf.mid.relationship.diagram.edit.policies.LinkSemanticEditPolicy;
...
public class LinkEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new LinkFigure();
	}
	...
	public LinkFigure getPrimaryShape() {
		return (LinkFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LinkNameTypeEditPart) {
			((LinkNameTypeEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureLinkLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MidVisualIDRegistry
				.getType(LinkNameTypeEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof edu.toronto.cs.se.mmtf.mid.relationship.diagram.edit.parts.LinkEditPart) {
			types.add(MidElementTypes.ExtendibleElementSupertype_4001);
		}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		...
		} else if (relationshipType == MidElementTypes.LinkElementRefs_4002) {
	 ...
	 * @generated
	 */
	public class LinkFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureLinkLabelFigure;
		...
		private void createContents() {
			...
			fFigureLinkLabelFigure = new WrappingLabel();
			fFigureLinkLabelFigure.setText("<...>");
			fFigureLinkLabelFigure.setForegroundColor(ColorConstants.darkGray);

			this.add(fFigureLinkLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLinkLabelFigure() {
			return fFigureLinkLabelFigure;
		}
