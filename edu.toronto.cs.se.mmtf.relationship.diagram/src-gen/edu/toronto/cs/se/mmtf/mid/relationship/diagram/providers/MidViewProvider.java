...
public class MidViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return ModelReferenceEditPart.VISUAL_ID == visualID
				|| LinkEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case ModelReferenceEditPart.VISUAL_ID:
			return createModelReference_2001(domainElement, containerView,
					index, persisted, preferencesHint);
		case LinkEditPart.VISUAL_ID:
			return createLink_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case ModelElementReferenceEditPart.VISUAL_ID:
			return createModelElementReference_3001(domainElement,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case ExtendibleElementSupertypeEditPart.VISUAL_ID:
			return createExtendibleElementSupertype_4001(containerView, index,
					persisted, preferencesHint);
		case LinkElementRefsEditPart.VISUAL_ID:
			return createLinkElementRefs_4002(containerView, index, persisted,
					preferencesHint);
		case BinaryLinkEditPart.VISUAL_ID:
			return createBinaryLink_4003(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createModelReference_2001(EObject domainElement,
		...
		createCompartment(
				node,
				MidVisualIDRegistry
						.getType(ModelReferenceModelReferenceCompartmentEditPart.VISUAL_ID),
	 ...
	 * @generated
	 */
	public Node createLink_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MidVisualIDRegistry.getType(LinkEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createModelElementReference_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Edge createExtendibleElementSupertype_4001(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createLinkElementRefs_4002(View containerView, int index,
	 ...
	 * @generated
	 */
	public Edge createBinaryLink_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(MidVisualIDRegistry.getType(BinaryLinkEditPart.VISUAL_ID));
