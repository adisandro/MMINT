 ...
 * @generated
 */
public class BinaryLinkNameTypeEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				MidVisualIDRegistry
						.getType(edu.toronto.cs.se.mmtf.mid.relationship.diagram.edit.parts.BinaryLinkNameTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public BinaryLinkNameTypeEditPart(View view) {
		super(view);
	}
