...
public class MidPaletteFactory {
	...
	private PaletteContainer createNew1Group() {
		...
		paletteContainer.add(createNewNaryLinkElem3CreationTool());
	...
	private ToolEntry createNewBinaryLink1CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections.singletonList(MidElementTypes.BinaryLink_4003));
		entry.setId("createNewBinaryLink1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(MidElementTypes
				.getImageDescriptor(MidElementTypes.BinaryLink_4003));
	...
	private ToolEntry createNewNaryLink2CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections.singletonList(MidElementTypes.Link_2002));
		entry.setId("createNewNaryLink2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(MidElementTypes
				.getImageDescriptor(MidElementTypes.Link_2002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	 ...
	 * @generated
	 */
	private ToolEntry createNewNaryLinkElem3CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				Messages.NewNaryLinkElem3CreationTool_title,
				Messages.NewNaryLinkElem3CreationTool_desc,
				Collections.singletonList(MidElementTypes.LinkElementRefs_4002));
		entry.setId("createNewNaryLinkElem3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(MidElementTypes
				.getImageDescriptor(MidElementTypes.LinkElementRefs_4002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createImportModel1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections.singletonList(MidElementTypes.ModelReference_2001));
		entry.setId("createImportModel1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(MidElementTypes
				.getImageDescriptor(MidElementTypes.ModelReference_2001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
