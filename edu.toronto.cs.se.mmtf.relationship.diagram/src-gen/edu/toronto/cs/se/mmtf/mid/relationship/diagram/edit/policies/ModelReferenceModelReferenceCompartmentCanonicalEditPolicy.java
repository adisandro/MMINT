 ...
 * @generated
 */
public class ModelReferenceModelReferenceCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return RelationshipPackage.eINSTANCE.getModelReference_ElementRefs();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<MidNodeDescriptor> childDescriptors = MidDiagramUpdater
				.getModelReferenceModelReferenceCompartment_7001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<MidNodeDescriptor> childDescriptors = MidDiagramUpdater
				.getModelReferenceModelReferenceCompartment_7001SemanticChildren((View) getHost()
						.getModel());
