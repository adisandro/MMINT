 ...
 * @generated
 */
public class BinaryLinkReferenceLabelExpressionLabelParser implements IParser {
	/**
	 * @generated
	 */
	public BinaryLinkReferenceLabelExpressionLabelParser() {
	}
	...
	private IStatus updateValues(EObject target, String newString) {
		((ExtendibleElementReference) target).getObject().setName(newString);
	...
	private String evaluatePrintExpression(EObject self) {
		return MultiModelRegistry
				.getElementReferenceLabel((ExtendibleElementReference) self);
	}
