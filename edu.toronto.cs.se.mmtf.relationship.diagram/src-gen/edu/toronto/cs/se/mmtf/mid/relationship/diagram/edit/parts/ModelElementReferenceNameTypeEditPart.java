 ...
 * @generated
 */
public class ModelElementReferenceNameTypeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ModelElementReferenceNameTypeEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MidParserProvider
					.getParser(
							...
							getParserElement(),
							MidVisualIDRegistry
									.getType(edu.toronto.cs.se.mmtf.mid.relationship.diagram.edit.parts.ModelElementReferenceNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
