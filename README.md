...
* Java 26
* [Eclipse Modeling Tools 2026-06](https://www.eclipse.org/downloads/packages/release/2026-06/r/eclipse-modeling-tools)
...
Add the following update sites to Eclipse (`Help > Install New Software > Available Software Sites`):
  * `https://download.eclipse.org/tools/orbit/simrel/orbit-aggregation/2026-06`
