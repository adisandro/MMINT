...
* After downloading Eclipse, open the `eclipse.ini` file and change the line below `-vm` to point to your Java 25 installation (for example, on Debian Linux change it to `/lib/jvm/java-25-openjdk-amd64/bin`, on Windows change it to `C:\Program Files\Java\jdk-25\bin`)
...
Add the following update sites to Eclipse (`Help > Install New Software > Available Software Sites`):
  * `https://download.eclipse.org/tools/orbit/simrel/orbit-aggregation/2026-03`
...
FAC 26 | Install: `Examples > MMINT - FAC26` | [Readme](examples/FAC26/edu.toronto.cs.se.mmint.examples.fac26/FAC26/README.md)
