...
import edu.toronto.cs.se.modelepedia.petrinet.diagram.part.PetrinetDiagramEditorUtil;

/**
 * @generated
 */
public class PetrinetMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = PetrinetDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			PetrinetDiagramEditorUtil.selectElementsInDiagram(editor,
