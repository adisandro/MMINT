...
public class PetrinetViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = PetrinetVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = PetrinetVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!PetrinetElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != PetrinetVisualIDRegistry
		...
		return TransitionEditPart.VISUAL_ID == visualID
				|| PlaceEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = PetrinetVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != PetrinetVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = PetrinetVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = PetrinetVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case TransitionEditPart.VISUAL_ID:
		...
		case PlaceEditPart.VISUAL_ID:
			return createPlace_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (PetrinetVisualIDRegistry.getVisualID(elementTypeHint)) {
	...
	public Node createTransition_2001(EObject domainElement,
		...
		node.setType(PetrinetVisualIDRegistry
	...
	public Edge createArc_4001(EObject domainElement, View containerView,
		...
		edge.setType(PetrinetVisualIDRegistry.getType(ArcEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!PetriNetEditPart.MODEL_ID.equals(PetrinetVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", PetriNetEditPart.MODEL_ID); //$NON-NLS-1$
