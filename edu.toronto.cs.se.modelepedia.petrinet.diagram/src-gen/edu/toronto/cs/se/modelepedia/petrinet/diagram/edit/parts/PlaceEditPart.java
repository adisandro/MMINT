...
import edu.toronto.cs.se.modelepedia.petrinet.diagram.edit.policies.PlaceItemSemanticEditPolicy;
...
public class PlaceEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PlaceNameTokensEditPart) {
			((PlaceNameTokensEditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof edu.toronto.cs.se.modelepedia.petrinet.diagram.edit.parts.PlaceEditPart) {
			types.add(PetrinetElementTypes.Arc_4001);
		}
		return types;
	}
