...
public class PetrinetNavigatorContentProvider implements ICommonContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<PetrinetNavigatorItem> result = new ArrayList<PetrinetNavigatorItem>();
		...
		if (parentElement instanceof PetrinetNavigatorGroup) {
			PetrinetNavigatorGroup group = (PetrinetNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof PetrinetNavigatorItem) {
			PetrinetNavigatorItem navigatorItem = (PetrinetNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case PetriNetEditPart.VISUAL_ID: {
			...
			PetrinetNavigatorGroup links = new PetrinetNavigatorGroup(
					Messages.NavigatorGroupName_PetriNet_1000_links,
			...
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					PetrinetVisualIDRegistry.getType(ArcEditPart.VISUAL_ID));
		...
		case ArcEditPart.VISUAL_ID: {
			LinkedList<PetrinetAbstractNavigatorItem> result = new LinkedList<PetrinetAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			PetrinetNavigatorGroup target = new PetrinetNavigatorGroup(
					Messages.NavigatorGroupName_Arc_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PetrinetNavigatorGroup source = new PetrinetNavigatorGroup(
		...
		case PlaceEditPart.VISUAL_ID: {
			...
			PetrinetNavigatorGroup outgoinglinks = new PetrinetNavigatorGroup(
					Messages.NavigatorGroupName_Place_2002_outgoinglinks,
		...
		case TransitionEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			PetrinetNavigatorGroup incominglinks = new PetrinetNavigatorGroup(
					Messages.NavigatorGroupName_Transition_2001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PetrinetNavigatorGroup outgoinglinks = new PetrinetNavigatorGroup(
	 ...
	 * @generated
	 */
	private Collection<PetrinetNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<PetrinetNavigatorItem> result = new ArrayList<PetrinetNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new PetrinetNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
