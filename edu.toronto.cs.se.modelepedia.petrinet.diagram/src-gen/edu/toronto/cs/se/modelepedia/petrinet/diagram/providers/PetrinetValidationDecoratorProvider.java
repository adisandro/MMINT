 ...
 * @generated
 */
public class PetrinetValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = PetrinetDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof PetrinetDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& PetriNetEditPart.MODEL_ID.equals(PetrinetVisualIDRegistry
						.getModelID(view));
	}
