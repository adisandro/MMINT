...
import edu.toronto.cs.se.modelepedia.petrinet.diagram.edit.policies.ArcItemSemanticEditPolicy;
...
public class ArcEditPart extends ConnectionNodeEditPart implements
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ArcWeightEditPart) {
			((ArcWeightEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureArcWeightFigure());
			return true;
		}
		return false;
	}
