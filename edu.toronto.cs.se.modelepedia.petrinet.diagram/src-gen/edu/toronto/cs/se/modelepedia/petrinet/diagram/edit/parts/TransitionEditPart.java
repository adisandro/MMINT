...
import edu.toronto.cs.se.modelepedia.petrinet.diagram.edit.policies.TransitionItemSemanticEditPolicy;
...
public class TransitionEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PetrinetVisualIDRegistry
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof edu.toronto.cs.se.modelepedia.petrinet.diagram.edit.parts.TransitionEditPart) {
			types.add(PetrinetElementTypes.Arc_4001);
		}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		...
		if (relationshipType == PetrinetElementTypes.Arc_4001) {
			...
			types.add(PetrinetElementTypes.Place_2002);
		}
		return types;
	}
