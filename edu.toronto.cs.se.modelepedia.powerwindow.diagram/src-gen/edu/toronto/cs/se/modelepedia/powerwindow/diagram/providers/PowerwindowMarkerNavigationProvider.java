...
import edu.toronto.cs.se.modelepedia.powerwindow.diagram.part.PowerwindowDiagramEditorUtil;

/**
 * @generated
 */
public class PowerwindowMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = PowerwindowDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			PowerwindowDiagramEditorUtil.selectElementsInDiagram(editor,
