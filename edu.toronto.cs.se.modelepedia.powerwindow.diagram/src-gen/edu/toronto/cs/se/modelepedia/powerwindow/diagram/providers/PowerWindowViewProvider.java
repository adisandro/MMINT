 ...
 * @generated
 */
public class PowerWindowViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return WindowEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = PowerWindowVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = PowerWindowVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!PowerWindowElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != PowerWindowVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!WindowEditPart.MODEL_ID.equals(PowerWindowVisualIDRegistry
		...
		return PushPullEditPart.VISUAL_ID == visualID
				|| RockerEditPart.VISUAL_ID == visualID
				|| InfraredEditPart.VISUAL_ID == visualID
				|| LockOutEditPart.VISUAL_ID == visualID
				|| ForceDetectingEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = PowerWindowVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != PowerWindowVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(WindowEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = PowerWindowVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case PushPullEditPart.VISUAL_ID:
			return createPushPull_2011(domainElement, containerView, index,
					persisted, preferencesHint);
		case RockerEditPart.VISUAL_ID:
			return createRocker_2012(domainElement, containerView, index,
					persisted, preferencesHint);
		case InfraredEditPart.VISUAL_ID:
			return createInfrared_2013(domainElement, containerView, index,
					persisted, preferencesHint);
		case LockOutEditPart.VISUAL_ID:
			return createLockOut_2014(domainElement, containerView, index,
					persisted, preferencesHint);
		case ForceDetectingEditPart.VISUAL_ID:
			return createForceDetecting_2015(domainElement, containerView,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (PowerWindowVisualIDRegistry.getVisualID(elementTypeHint)) {
		}
	 ...
	 * @generated
	 */
	public Node createPushPull_2011(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PowerWindowVisualIDRegistry
				.getType(PushPullEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createRocker_2012(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PowerWindowVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createInfrared_2013(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PowerWindowVisualIDRegistry
				.getType(InfraredEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createLockOut_2014(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PowerWindowVisualIDRegistry
				.getType(LockOutEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createForceDetecting_2015(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PowerWindowVisualIDRegistry
				.getType(ForceDetectingEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	private void stampShortcut(View containerView, Node target) {
		if (!WindowEditPart.MODEL_ID.equals(PowerWindowVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", WindowEditPart.MODEL_ID); //$NON-NLS-1$
