...
//		tempProperties.load(new FileInputStream(ResourcesPlugin.getWorkspace().getRoot().getLocation().toString() + MultiModelRegistry.replaceFileExtensionInUri(randommodelModel.getUri(), "mavoelems")));
