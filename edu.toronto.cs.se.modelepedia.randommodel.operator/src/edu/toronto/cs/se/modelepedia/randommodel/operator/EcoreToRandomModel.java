...
/**
 * Entry point of the 'EcoreToRandomModel' transformation module.
 */
public class EcoreToRandomModel {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 2) {
				...
				EcoreToRandomModel runner = new EcoreToRandomModel();
				runner.loadModels(args[0]);
				runner.doEcoreToRandomModel(new NullProgressMonitor());
	...
	public void loadModels(String inModelPath) throws ATLCoreException {
		...
		injector.inject(ecoreMetamodel, getMetamodelUri("Ecore"));
	 	IReferenceModel randommodelMetamodel = factory.newReferenceModel();
		injector.inject(randommodelMetamodel, getMetamodelUri("RandomModel"));
		this.inModel = factory.newModel(ecoreMetamodel);
		injector.inject(inModel, inModelPath);
		this.outModel = factory.newModel(randommodelMetamodel);
	}
	 ...
	 * @generated
	 */
	public Object doEcoreToRandomModel(IProgressMonitor monitor) throws ATLCoreException, IOException, ATLExecutionException {
		ILauncher launcher = new EMFVMLauncher();
		Map<String, Object> launcherOptions = getOptions();
		launcher.initialize(launcherOptions);
		launcher.addInModel(inModel, "IN", "Ecore");
		launcher.addOutModel(outModel, "OUT", "RandomModel");
	...
	protected InputStream[] getModulesList() throws IOException {
		...
		String modulesList = properties.getProperty("EcoreToRandomModel.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("EcoreToRandomModel.metamodels." + metamodelName);
	}
	...
	protected InputStream getLibraryAsStream(String libraryName) throws IOException {
		return getFileURL(properties.getProperty("EcoreToRandomModel.libraries." + libraryName)).openStream();
	}
	...
	protected Map<String, Object> getOptions() {
		...
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("EcoreToRandomModel.options.")) {
				options.put(entry.getKey().toString().replaceFirst("EcoreToRandomModel.options.", ""), 
