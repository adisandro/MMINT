...
public class RepositorySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RepositoryPackage.DIAGRAM: {
			...
			case RepositoryPackage.ESTRING_TO_METAMODEL_MAP: {
				@SuppressWarnings("unchecked") Map.Entry<String, Metamodel> eStringToMetamodelMap = (Map.Entry<String, Metamodel>)theEObject;
				T result = caseEStringToMetamodelMap(eStringToMetamodelMap);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RepositoryPackage.ESTRING_TO_EDITOR_MAP: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EString To Metamodel Map</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EString To Metamodel Map</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEStringToMetamodelMap(Map.Entry<String, Metamodel> object) {
		return null;
	}
