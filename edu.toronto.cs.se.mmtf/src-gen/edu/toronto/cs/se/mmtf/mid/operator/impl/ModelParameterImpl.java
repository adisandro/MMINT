 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.operator.impl.ModelParameterImpl#getModelUri <em>Model Uri</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.operator.impl.ModelParameterImpl#getModel <em>Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelParameterImpl extends ParameterImpl implements ModelParameter {
	...
	protected EClass eStaticClass() {
		return OperatorPackage.Literals.MODEL_PARAMETER;
	}
	...
	public void setModelUri(String newModelUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperatorPackage.MODEL_PARAMETER__MODEL_URI, oldModelUri, modelUri));
	}
	...
	public Model getModel() {
		if (model != null && model.eIsProxy()) {
			...
			if (model != oldModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OperatorPackage.MODEL_PARAMETER__MODEL, oldModel, model));
			}
		}
		return model;
	}
	...
	public void setModel(Model newModel) {
		...
		model = newModel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperatorPackage.MODEL_PARAMETER__MODEL, oldModel, model));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperatorPackage.MODEL_PARAMETER__MODEL_URI:
				return getModelUri();
			case OperatorPackage.MODEL_PARAMETER__MODEL:
