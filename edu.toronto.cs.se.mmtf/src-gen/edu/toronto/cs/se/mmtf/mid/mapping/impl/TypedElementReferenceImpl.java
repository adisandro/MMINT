 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.mapping.impl.TypedElementReferenceImpl#getReferencedObject <em>Referenced Object</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.mapping.impl.TypedElementReferenceImpl#getContainedObject <em>Contained Object</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.mapping.impl.TypedElementReferenceImpl#getObject <em>Object</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.mapping.impl.TypedElementReferenceImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.mapping.impl.TypedElementReferenceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TypedElementReferenceImpl extends EObjectImpl implements TypedElementReference {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate OBJECT__ESETTING_DELEGATE = ((EStructuralFeature.Internal)MappingPackage.Literals.TYPED_ELEMENT_REFERENCE__OBJECT).getSettingDelegate();
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate NAME__ESETTING_DELEGATE = ((EStructuralFeature.Internal)MappingPackage.Literals.TYPED_ELEMENT_REFERENCE__NAME).getSettingDelegate();
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate TYPE__ESETTING_DELEGATE = ((EStructuralFeature.Internal)MappingPackage.Literals.TYPED_ELEMENT_REFERENCE__TYPE).getSettingDelegate();
	...
	protected EClass eStaticClass() {
		return MappingPackage.Literals.TYPED_ELEMENT_REFERENCE;
	}
		...
		if (referencedObject != null && referencedObject.eIsProxy()) {
			...
			if (referencedObject != oldReferencedObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MappingPackage.TYPED_ELEMENT_REFERENCE__REFERENCED_OBJECT, oldReferencedObject, referencedObject));
			}
		}
	...
	public void setReferencedObject(TypedElement newReferencedObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.TYPED_ELEMENT_REFERENCE__REFERENCED_OBJECT, oldReferencedObject, referencedObject));
	}
	...
	public NotificationChain basicSetContainedObject(TypedElement newContainedObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MappingPackage.TYPED_ELEMENT_REFERENCE__CONTAINED_OBJECT, oldContainedObject, newContainedObject);
	...
	public void setContainedObject(TypedElement newContainedObject) {
		if (newContainedObject != containedObject) {
			...
			if (containedObject != null)
				msgs = ((InternalEObject)containedObject).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MappingPackage.TYPED_ELEMENT_REFERENCE__CONTAINED_OBJECT, null, msgs);
			if (newContainedObject != null)
				msgs = ((InternalEObject)newContainedObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MappingPackage.TYPED_ELEMENT_REFERENCE__CONTAINED_OBJECT, null, msgs);
			msgs = basicSetContainedObject(newContainedObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.TYPED_ELEMENT_REFERENCE__CONTAINED_OBJECT, newContainedObject, newContainedObject));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MappingPackage.TYPED_ELEMENT_REFERENCE__CONTAINED_OBJECT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MappingPackage.TYPED_ELEMENT_REFERENCE__REFERENCED_OBJECT:
				if (resolve) return getReferencedObject();
				return basicGetReferencedObject();
			case MappingPackage.TYPED_ELEMENT_REFERENCE__CONTAINED_OBJECT:
				return getContainedObject();
			case MappingPackage.TYPED_ELEMENT_REFERENCE__OBJECT:
				if (resolve) return getObject();
				return basicGetObject();
			case MappingPackage.TYPED_ELEMENT_REFERENCE__NAME:
				return getName();
			case MappingPackage.TYPED_ELEMENT_REFERENCE__TYPE:
				return getType();
		}
