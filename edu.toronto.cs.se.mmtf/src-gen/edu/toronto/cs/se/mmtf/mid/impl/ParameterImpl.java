 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.impl.ParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.impl.ParameterImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.impl.ParameterImpl#isVararg <em>Vararg</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends EObjectImpl implements Parameter {
	...
	protected EClass eStaticClass() {
		return MidPackage.Literals.PARAMETER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MidPackage.PARAMETER__NAME, oldName, name));
	}
	...
	public void setType(ParameterType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MidPackage.PARAMETER__TYPE, oldType, type));
	}
	...
	public void setVararg(boolean newVararg) {
		...
		vararg = newVararg;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MidPackage.PARAMETER__VARARG, oldVararg, vararg));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MidPackage.PARAMETER__NAME:
				return getName();
			case MidPackage.PARAMETER__TYPE:
				return getType();
			case MidPackage.PARAMETER__VARARG:
				return isVararg();
		}
