 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.impl.LinkImpl#getElementRefs <em>Element Refs</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.impl.LinkImpl#isUnbounded <em>Unbounded</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkImpl extends ExtendibleElementImpl implements Link {
	...
	public EList<ModelElementReference> getElementRefs() {
		if (elementRefs == null) {
			elementRefs = new EObjectWithInverseResolvingEList.ManyInverse<ModelElementReference>(ModelElementReference.class, this, RelationshipPackage.LINK__ELEMENT_REFS, RelationshipPackage.MODEL_ELEMENT_REFERENCE__LINKS);
		}
		return elementRefs;
	}
	...
	public void setUnbounded(boolean newUnbounded) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationshipPackage.LINK__UNBOUNDED, oldUnbounded, unbounded));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RelationshipPackage.LINK__ELEMENT_REFS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RelationshipPackage.LINK__UNBOUNDED:
				return isUnbounded();
		}
