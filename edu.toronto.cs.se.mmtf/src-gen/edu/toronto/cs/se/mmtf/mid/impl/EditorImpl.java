 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.impl.EditorImpl#getModelUri <em>Model Uri</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.impl.EditorImpl#getId <em>Id</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.impl.EditorImpl#getWizardId <em>Wizard Id</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.impl.EditorImpl#getFileExtensions <em>File Extensions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EditorImpl extends ExtendibleElementImpl implements Editor {
	...
	protected EClass eStaticClass() {
		return MidPackage.Literals.EDITOR;
	}
	...
	public void setModelUri(String newModelUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MidPackage.EDITOR__MODEL_URI, oldModelUri, modelUri));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MidPackage.EDITOR__ID, oldId, id));
	}
	...
	public void setWizardId(String newWizardId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MidPackage.EDITOR__WIZARD_ID, oldWizardId, wizardId));
	}
	...
	public EList<String> getFileExtensions() {
		if (fileExtensions == null) {
			fileExtensions = new EDataTypeUniqueEList<String>(String.class, this, MidPackage.EDITOR__FILE_EXTENSIONS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MidPackage.EDITOR__MODEL_URI:
				return getModelUri();
			case MidPackage.EDITOR__ID:
				return getId();
			case MidPackage.EDITOR__WIZARD_ID:
				return getWizardId();
			case MidPackage.EDITOR__FILE_EXTENSIONS:
