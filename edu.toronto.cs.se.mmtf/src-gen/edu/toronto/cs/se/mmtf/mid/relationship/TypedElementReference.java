 ...
 * <ul>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.TypedElementReference#getReferencedObject <em>Referenced Object</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.TypedElementReference#getContainedObject <em>Contained Object</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.TypedElementReference#getObject <em>Object</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.TypedElementReference#getName <em>Name</em>}</li>
 *   <li>{@link edu.toronto.cs.se.mmtf.mid.relationship.TypedElementReference#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getTypedElementReference()
 * @model abstract="true"
...
public interface TypedElementReference extends EObject {
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getTypedElementReference_ReferencedObject()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.toronto.cs.se.mmtf.mid.relationship.TypedElementReference#getReferencedObject <em>Referenced Object</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getTypedElementReference_ContainedObject()
	...
	/**
	 * Sets the value of the '{@link edu.toronto.cs.se.mmtf.mid.relationship.TypedElementReference#getContainedObject <em>Contained Object</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getTypedElementReference_Object()
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getTypedElementReference_Name()
	 * @model required="true" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see edu.toronto.cs.se.mmtf.mid.relationship.RelationshipPackage#getTypedElementReference_Type()
	 * @model required="true" transient="true" changeable="false" volatile="true" derived="true"
