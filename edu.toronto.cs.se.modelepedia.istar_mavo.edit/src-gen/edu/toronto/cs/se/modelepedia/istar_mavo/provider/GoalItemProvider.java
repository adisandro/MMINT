...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.modelepedia.istar_mavo.Goal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Goal_means_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Goal_means_feature", "_UI_Goal_type"),
				 IStar_MAVOPackage.Literals.GOAL__MEANS,
				 true,
				 false,
				 true,
				 null,
